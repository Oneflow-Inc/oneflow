...
def deprecated_current_scope(*args, **kwargs):
    print('WARNING:', 'oneflow.compatible.single_client.scope.current_scope', 'will be removed in the future, use {} instead.'.format('oneflow.compatible.single_client.current_scope'))
