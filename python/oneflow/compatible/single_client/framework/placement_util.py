...
def deprecated_placement(*args, **kwargs):
    print('WARNING:', 'oneflow.compatible.single_client.device_prior_placement/oneflow.compatible.single_client.fixed_placement', 'will be removed in the future, use {} instead.'.format('oneflow.compatible.single_client.scope.placement'))
