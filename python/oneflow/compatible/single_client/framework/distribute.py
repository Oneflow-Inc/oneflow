...
from oneflow.compatible.single_client.python.framework import distribute_context as distribute_ctx
...
def deprecated_mirrored_strategy():
    print('WARNING:', 'oneflow.compatible.single_client.distribute.mirrored_strategy', 'will be removed in the future, use {} instead.'.format('oneflow.compatible.single_client.scope.mirrored_view'))
...
def deprecated_mirrored_strategy_enabled():
    print('WARNING:', 'oneflow.compatible.single_client.distribute.mirrored_strategy_enabled', 'will be removed in the future, use {} instead.'.format('oneflow.compatible.single_client.scope.mirrored_view_enabled'))
    print(traceback.format_stack()[-2])
...
def deprecated_consistent_strategy():
    print('WARNING:', 'oneflow.compatible.single_client.distribute.consistent_strategy', 'will be removed in the future, use {} instead.'.format('oneflow.compatible.single_client.scope.consistent_view'))
    print(traceback.format_stack()[-2])
...
def deprecated_consistent_strategy_enabled():
    print('WARNING:', 'oneflow.compatible.single_client.distribute.consistent_strategy_enabled', 'will be removed in the future, use {} instead.'.format('oneflow.compatible.single_client.scope.consistent_view_enabled'))
    print(traceback.format_stack()[-2])
