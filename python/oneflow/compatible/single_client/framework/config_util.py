...
def api_gpu_device_num(val: int) -> None:
    ...
    if oneflow._oneflow_internal.flags.with_cuda():
        ...
        print('INFO: for CPU-only OneFlow, oneflow.compatible.single_client.config.gpu_device_num is equivalent to oneflow.compatible.single_client.config.cpu_device_num')
...
def api_numa_aware_cuda_malloc_host(val: bool=True) -> None:
    ...
    """
    print("'enable_numa_aware_cuda_malloc_host' has been deprecated, has no effect and will be removed in the future.")
