...
_dtypes = [flow.char, flow.float, flow.float32, flow.double, flow.float64, flow.float16, flow.int8, flow.int32, flow.int64, flow.uint8, flow.record, flow.tensor_buffer]
...
_ONEFLOW_DTYPE_TO_NUMPY_DTYPE = {flow.char: np.byte, flow.float: np.float32, flow.float16: np.float16, flow.float32: np.float32, flow.float64: np.double, flow.double: np.double, flow.int8: np.int8, flow.int32: np.int32, flow.int64: np.int64, flow.uint8: np.uint8}
