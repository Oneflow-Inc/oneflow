...
oneflow._oneflow_internal.RegisterForeignCallbackOnlyOnce(python_callback.global_python_callback)
del python_callback
...
oneflow._oneflow_internal.deprecated.RegisterBoxingUtilOnlyOnce(boxing_util._global_boxing_util)
del boxing_util
from oneflow.compatible.single_client.python.ops.util import custom_op_module
oneflow._oneflow_internal.RegisterPyKernels(custom_op_module._python_kernel_reg.kernels_)
...
import atexit
from oneflow.compatible.single_client.python.framework.session_context import TryCloseAllSession
...
from oneflow.compatible.single_client.ops.categorical_ordinal_encode_op import categorical_ordinal_encode
...
from oneflow.compatible.single_client.ops.combined_margin_loss import combined_margin_loss
...
from oneflow.compatible.single_client.ops.initializer_util import random_uniform_initializer
from oneflow.compatible.single_client.ops.initializer_util import random_normal_initializer
from oneflow.compatible.single_client.ops.initializer_util import truncated_normal_initializer
from oneflow.compatible.single_client.ops.initializer_util import glorot_uniform_initializer as xavier_uniform_initializer
from oneflow.compatible.single_client.ops.initializer_util import glorot_uniform_initializer
from oneflow.compatible.single_client.ops.initializer_util import glorot_normal_initializer as xavier_normal_initializer
from oneflow.compatible.single_client.ops.initializer_util import glorot_normal_initializer
from oneflow.compatible.single_client.ops.initializer_util import variance_scaling_initializer
from oneflow.compatible.single_client.ops.initializer_util import kaiming_initializer
from oneflow.compatible.single_client.ops.math_ops import unsorted_segment_sum as unsorted_segment_sum
from oneflow.compatible.single_client.ops.math_ops import unsorted_segment_sum_like as unsorted_segment_sum_like
from oneflow.compatible.single_client.ops.math_ops import unsorted_batch_segment_sum as unsorted_batch_segment_sum
from oneflow.compatible.single_client.ops.math_ops import cast
from oneflow.compatible.single_client.ops.math_ops import broadcast_to_compatible_with as broadcast_to_compatible_with
from oneflow.compatible.single_client.ops.math_ops import clip_by_value as clip_by_value
from oneflow.compatible.single_client.ops.math_ops import clip_by_value as clip_by_scalar
...
from oneflow.compatible.single_client.ops.user_data_ops import api_image_resize as image_resize
from oneflow.compatible.single_client.ops.user_data_ops import api_image_target_resize as image_target_resize
from oneflow.compatible.single_client.ops.user_data_ops import api_image_random_crop as image_random_crop
from oneflow.compatible.single_client.ops.user_data_ops import image_decode as image_decode
from oneflow.compatible.single_client.ops.user_data_ops import image_batch_align as image_batch_align
from oneflow.compatible.single_client.ops.user_data_ops import image_normalize as image_normalize
from oneflow.compatible.single_client.ops.user_data_ops import image_flip as image_flip
from oneflow.compatible.single_client.ops.user_data_ops import object_bbox_flip as object_bbox_flip
from oneflow.compatible.single_client.ops.user_data_ops import object_bbox_scale as object_bbox_scale
from oneflow.compatible.single_client.ops.user_data_ops import object_segm_poly_flip as object_segmentation_polygon_flip
from oneflow.compatible.single_client.ops.user_data_ops import object_segm_poly_scale as object_segmentation_polygon_scale
from oneflow.compatible.single_client.ops.user_data_ops import object_segm_poly_to_mask as object_segmentation_polygon_to_mask
...
from oneflow.compatible.single_client.ops.user_op_builder import api_consistent_user_op_builder
from oneflow.compatible.single_client.ops.user_op_builder import api_user_op_module_builder
from oneflow.compatible.single_client.ops.user_op_builder import api_consistent_user_op_module_builder
...
from oneflow.compatible.single_client.ops.partial_fc_sample import distributed_partial_fc_sample
from oneflow.compatible.single_client.ops.tensor_buffer_ops import tensor_buffer_to_tensor
from oneflow.compatible.single_client.ops.tensor_buffer_ops import tensor_to_tensor_buffer
from oneflow.compatible.single_client.ops.tensor_buffer_ops import gen_tensor_buffer
from oneflow.compatible.single_client.ops.tensor_buffer_ops import tensor_buffer_to_list_of_tensors
...
from oneflow.compatible.single_client.deprecated.initializer_util import truncated_normal_initializer
from oneflow.compatible.single_client.advanced.distribute_ops import cast_to_current_logical_view
from oneflow.compatible.single_client.experimental.name_scope import deprecated_name_scope
from oneflow.compatible.single_client.framework.session_util import api_find_or_create_module
from oneflow.compatible.single_client.framework.session_util import api_eager_execution_enabled
from oneflow.compatible.single_client.framework.session_util import api_clear_default_session
from oneflow.compatible.single_client.framework.session_util import api_sync_default_session
from oneflow.compatible.single_client.framework.session_util import TmpInitEagerGlobalSession
...
from oneflow.compatible.single_client.framework.function_util import FunctionConfig as function_config
from oneflow.compatible.single_client.framework.function_util import FunctionConfig as ExecutionConfig
from oneflow.compatible.single_client.framework.function_util import FunctionConfig
from oneflow.compatible.single_client.framework.function_util import api_oneflow_function
from oneflow.compatible.single_client.framework.job_set_util import inter_job_reuse_mem_strategy
from oneflow.compatible.single_client.framework.function_desc import api_current_global_function_desc
...
from oneflow.compatible.single_client.framework.ops import api_hierarchical_parallel_cast
from oneflow.compatible.single_client.framework.env_util import api_enable_eager_execution
from oneflow.compatible.single_client.framework.env_util import api_get_current_resource as current_resource
from oneflow.compatible.single_client.framework.env_util import api_get_current_machine_id
from oneflow.compatible.single_client.framework.placement_util import deprecated_placement as fixed_placement
from oneflow.compatible.single_client.framework.placement_util import deprecated_placement
from oneflow.compatible.single_client.framework.dtype import dtypes
from oneflow.compatible.single_client.framework.dtype import convert_oneflow_dtype_to_numpy_dtype
from oneflow.compatible.single_client.framework.input_blob_def import DeprecatedFixedTensorDef
from oneflow.compatible.single_client.framework.input_blob_def import DeprecatedMirroredTensorDef