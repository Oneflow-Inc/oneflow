...
def _compare_softsign_with_np(input_shape, device_type, machine_ids, device_counts):
    ...
    _np_grad = _np_softsign_grad(input_1)
    ...
    assert np.allclose(of_out_softsign, np_out_softsign)
