...
def _model(sparse_indices, dense, batch_tril_indices):
    ...
    return dense_features, sparse_embedding1
...
def DlrmTrain(
    ...
    with flow.scope.placement("gpu", "0:0"):
        logits, sparse_embedding1 = _model(sparse_indices, dense, batch_tril_indices)
        ...
        return loss, logits, sparse_embedding1
...
def main():
    ...
    for i in range(max_iter):
        stime=time.time()
        of_out, logits, sparse_embedding1 = DlrmTrain(batch_tril_indices).get()
