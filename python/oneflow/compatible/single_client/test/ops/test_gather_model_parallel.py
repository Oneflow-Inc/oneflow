...
def _test_gather_model_parallel_fw(test_case, device_type, params_shape, indices_shape, axis, split_axis):
    ...
    def gather_model_parallel_fw_job(params: oft.Numpy.Placeholder(params_shape, dtype=flow.float), indices: oft.Numpy.Placeholder(indices_shape, dtype=flow.int32)):
