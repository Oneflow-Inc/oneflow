...
def _make_op_function(test_case, input, padding, grad, device_type, value_type, machine_ids, device_counts):
...
def _compare_op_function_with_samples(test_case, device_type, sample, value_type, machine_ids, device_count):
    op_function = _make_op_function(test_case, sample['input'].astype(value_type[0]), sample['padding'], sample['grad'].astype(value_type[0]), device_type, value_type[1], machine_ids, device_count)
