...
def GenerateTest(test_case, a_shape, b_shape):
    ...
    def ModJob(a: oft.Numpy.Placeholder(a_shape, dtype=flow.int32), b: oft.Numpy.Placeholder(b_shape, dtype=flow.int32)):
        return a % b
...
class TestModInt(flow.unittest.TestCase):
    ...
    def test_naive(test_case):
        ...
        @flow.global_function(function_config=func_config)
        def ModJob(a: oft.Numpy.Placeholder((5, 2), dtype=flow.int32), b: oft.Numpy.Placeholder((5, 2), dtype=flow.int32)):
            return a % b
    ...
    def test_broadcast(test_case):
        ...
        @flow.global_function(function_config=func_config)
        def ModJob(a: oft.Numpy.Placeholder((5, 2), dtype=flow.int32), b: oft.Numpy.Placeholder((1, 2), dtype=flow.int32)):
            return a % b
        x = (np.random.rand(5, 2) * 1000).astype(np.int32) + 1
