...
def download_mnist_file(out_path, url):
    ...
    with open(out_path, 'wb') as f:
        for data in tqdm(iterable=resp.iter_content(1024), total=size, unit='k', desc=out_path):
            f.write(data)
        print('Done!')
...
def load_mnist(train_batch_size=100, test_batch_size=100, data_format='NCHW', url='https://oneflow-public.oss-cn-beijing.aliyuncs.com/datasets/mnist.npz', hash_check='63d4344077849053dc3036b247fa012b2b381de53fd055a66b539dffd76cf08e', out_dir='.'):
