...
from oneflow.compatible.single_client.python.framework import session_context as session_context
...
def deprecated_name_scope(*args, **kwargs):
    print('WARNING:', 'oneflow.compatible.single_client.name_scope/oneflow.compatible.single_client.experimental.name_scope/deprecated.variable_scope', 'will be removed in the future, use {} instead.'.format('oneflow.compatible.single_client.scope.namespace'))
