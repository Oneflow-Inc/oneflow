...
def manual_seed_all(seed) -> None:
    ...
    https://pytorch.org/docs/1.10/generated/torch.cuda.manual_seed_all.html?highlight=manual_seed_all
...
def manual_seed(seed: int) -> None:
    r"""The documentation is referenced from:
    https://pytorch.org/docs/1.10/generated/torch.cuda.manual_seed.html?highlight=manual_seed
