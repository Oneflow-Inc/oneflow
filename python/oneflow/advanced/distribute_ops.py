...
def cast_to_current_logical_view(x: oneflow._oneflow_internal.BlobDesc) -> oneflow._oneflow_internal.BlobDesc:
    if isinstance(x, oneflow._oneflow_internal.ConsistentBlob) and oneflow.scope.mirrored_view_enabled() or (isinstance(x, oneflow._oneflow_internal.MirroredBlob) and oneflow.scope.consistent_view_enabled()):
