...
import oneflow
from oneflow.fx.experimental.graph_manipulation import get_size_of_all_nodes
from oneflow.fx.experimental.partitioner_utils import (
    Partition,
    Device,
    PartitionerConfig,
...
from oneflow.fx.node import Node, map_arg
from oneflow.fx.passes.split_module import split_module
...
class Partitioner:
    ...
    def partition_graph(
        ...
        torch_module: oneflow.nn.Module,
        partitioner_config: PartitionerConfig,
    ) -> PartitionResult:
        """Given the fx module, oneflow module and partitioner_config,
