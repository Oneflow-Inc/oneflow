...
from oneflow.fx.graph import map_arg
...
class Component:
    ...
    getattr_maps: Dict[oneflow.fx.Node, oneflow.fx.Node] = field(default_factory=dict)
    constructor_args: List[str] = field(default_factory=list)
    gm: Optional[oneflow.fx.GraphModule] = None
...
def split_by_tags(gm: oneflow.fx.GraphModule, tags: List[str]) -> oneflow.fx.GraphModule:
    ...
    def flatten(x: oneflow.fx.node.Argument) -> NodeList:
        """
    ...
    node_remapping: Dict[oneflow.fx.Node, oneflow.fx.Node] = {}

    # Mapping from node in original module or created submodules to
    # corresponding component.
    node_to_component: Dict[oneflow.fx.Node, Component] = {}
    ...
    for comp in all_components:
        ...
        comp.gm = oneflow.fx.GraphModule(root, comp.graph)
        ...
        if len(outs) == 1:
            ...
            for i, o in enumerate(comp.orig_outputs):
                ...
                main_remapping[o] = oneflow.fx.Proxy(main_node)[i].node  # type: ignore[index]
    ...
    return oneflow.fx.GraphModule(main_root, main_g)
