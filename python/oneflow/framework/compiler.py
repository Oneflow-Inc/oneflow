...
def _CloneArgBlobDef(args):
    ...
    raise NotImplementedError('oneflow.global_function only accepts nested input blob defs')
...
def _RecursiveMakeInputBlobs(input_blob_def):
    ...
    raise NotImplementedError('oneflow.global_function accepts ' + 'ArgBlobDefs or list/tuple/dict nested ArgBlobDefs as argument')
...
def _RecursiveMakeRetRemoteBlobs(remote_blobs, **kwarg):
    ...
    raise NotImplementedError('oneflow.global_function returns ' + 'RemoteBlob or list/tuple/dict nested RemoteBlob only')