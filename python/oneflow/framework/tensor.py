...
def RegisterMethods():
    ...
    Tensor.numpy = _numpy  # 不会
    Tensor.size = _size  # 不会
    Tensor.backward = _backward  # 不会
    Tensor.__setitem__ = _setitem  # 不会
    Tensor.__str__ = _str
    Tensor.__repr__ = _repr
    Tensor.__bool__ = is_nonzero
    Tensor.__iadd__ = _iadd
    Tensor.addmm = _addmm  # 代码太复杂
    Tensor.__format__ = _format  # 不会 numpy
    Tensor.__index__ = _index  # buhui numpy
    Tensor.__float__ = _scalar_float  # numpy
    Tensor.__int__ = _scalar_int  # numpy
    Tensor.__array__ = _numpy  # numpy
    Tensor.uniform_ = _uniform  # init
    Tensor.trunc_normal_ = _trunc_normal_  # init
    Tensor.kaiming_uniform_ = _kaiming_uniform  # init
    Tensor.kaiming_normal_ = _kaiming_normal  # init
    Tensor.xavier_normal_ = _xavier_normal  # init
    Tensor.xavier_uniform_ = _xavier_uniform  # init
    Tensor.orthogonal_ = _orthogonal  # fuza
    Tensor.normal_ = _normal  # init
    Tensor.fill_ = _fill  # init
    Tensor.copy_ = _copy  # fuza
    Tensor._meta_repr = _meta_repr  # 没有接口
