...
add_docstr(
    ...
    https://pytorch.org/docs/1.10/generated/torch.movedim.html#torch.movedim.
...
add_docstr(
    ...
    The documentation is referenced from:
    https://pytorch.org/docs/1.10/generated/torch.as_strided.html#torch.as_strided.
...
add_docstr(
    ...
    The documentation is referenced from:
    https://pytorch.org/docs/1.10/generated/torch.tensor_split.html#torch.tensor_split
...
add_docstr(
    ...
    The documentation is referenced from:
    https://pytorch.org/docs/1.10/generated/torch.hsplit.html#torch.hsplit
...
add_docstr(
    ...
    The documentation is referenced from:
    https://pytorch.org/docs/1.10/generated/torch.vsplit.html#torch.vsplit
