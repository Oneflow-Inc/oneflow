...
add_docstr(
    oneflow.read_onerec,
    r"""
    read_onerec(files:List[str], batch_size:int, random_shuffle:bool, shuffle_mode:str, shuffle_buffer_size=1024, shuffle_after_epoch=False, verify_example=True) -> Tensor 
