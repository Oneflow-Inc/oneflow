...
def build_graph_input_arg(op_name, arg):
    ...
    input_conf = oneflow._oneflow_internal.oneflow.core.operator.op_conf.FeedInputOpConf()
    input_op = oneflow._oneflow_internal.one.FeedInputOpExpr(op_name, input_conf, ['in_0'], ['out_0'])
...
def build_graph_output(op_name, out):
    ...
    output_op = oneflow._oneflow_internal.one.FetchOutputOpExpr(op_name, output_conf, ['in_0'], ['out_0'])
    attrs = oneflow._oneflow_internal.MutableCfgAttrMap()
