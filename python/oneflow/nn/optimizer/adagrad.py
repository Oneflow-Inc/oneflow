...
class Adagrad(Optimizer):
    ...
    def __init__(
        ...
        assert initial_accumulator_value >= 0.0, f"Invalid initial_accumulator_value value: {initial_accumulator_value}"
        ...
        for param_group in self.param_groups:
            for param in param_group.parameters:
                ...
                self._state[param]["sum"] = flow.zeros_like(param).fill_(initial_accumulator_value)
