...
class Conv1d(Module):
    ...
    The documentation is referenced from: https://pytorch.org/docs/1.10/generated/torch.nn.Conv1d.html#conv1d
...
class Conv2d(Module):
    """The interface is consistent with PyTorch.    
    The documentation is referenced from: https://pytorch.org/docs/1.10/generated/torch.nn.Conv2d.html#conv2d
...
class Conv3d(Module):
    ...
    The documentation is referenced from: https://pytorch.org/docs/1.10/generated/torch.nn.Conv3d.html#conv3d
