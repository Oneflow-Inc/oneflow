...
class KLDivLoss(_Loss):
    ...
    https://pytorch.org/docs/1.10/generated/torch.nn.KLDivLoss.html?highlight=kldivloss#torch.nn.KLDivLoss
...
class MSELoss(_Loss):
    """The interface is consistent with PyTorch.
    The documentation is referenced from:
    https://pytorch.org/docs/1.10/generated/torch.nn.MSELoss.html?highlight=mseloss#torch.nn.MSELoss
...
class CTCLoss(_Loss):
    ...
    The interface is consistent with PyTorch.
    The documentation is referenced from:
    https://pytorch.org/docs/1.10/generated/torch.nn.CTCLoss.html#torch.nn.CTCLoss
