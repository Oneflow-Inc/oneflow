...
def grad(
    ...
    https://pytorch.org/docs/1.10/generated/torch.autograd.grad.html#torch.autograd.grad
...
def backward(
    ...
    r"""
    The documentation is referenced from:
    https://pytorch.org/docs/1.10/generated/torch.autograd.backward.html#torch.autograd.backward
