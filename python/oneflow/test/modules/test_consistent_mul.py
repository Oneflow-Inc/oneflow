...
def _test_mul(test_case, placement):
    x_sbp = random_sbp(placement, max_dim=3)
    x = random_tensor(ndim=3, dim0=16, dim1=8, dim2=24).to_global(placement, x_sbp)
