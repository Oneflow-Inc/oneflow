...
class TestAvgPoolingFunctional(flow.unittest.TestCase):
    ...
    def profile_avgpool2d(test_case):
        torch.nn.functional.avg_pool2d(torch.ones(1, 32, 64, 64), kernel_size=3, padding=1)
        torch.nn.functional.avg_pool2d(torch.ones(1, 32, 64, 64), kernel_size=3, stride=2, padding=1)
