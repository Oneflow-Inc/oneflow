...
def _test_einsum_matrix_transpose(test_case, placement, sbp):
    x = random_tensor(ndim=2, dim0=random(1, 3) * 2, dim1=random(1, 3) * 2)
...
def _test_einsum_vector_outer_product(test_case, placement, sbp):
    x = random_tensor(ndim=1, dim0=random(1, 3) * 2,)
    y = random_tensor(ndim=1, dim0=random(1, 3) * 2,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_batch_matmul(test_case, placement, sbp):
    dim0 = random(1, 3) * 2
    dim1 = random(1, 3) * 2
    x = random_tensor(ndim=3, dim0=dim0, dim1=random(1, 3) * 2, dim2=dim1,)
    y = random_tensor(ndim=3, dim0=dim0, dim1=dim1, dim2=random(1, 3) * 2,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_tensor_contraction(test_case, placement, sbp):
    ...
    dim1 = random(1, 3) * 2
    x = random_tensor(
        ndim=4, dim0=random(1, 3) * 2, dim1=dim0, dim2=dim1, dim3=random(1, 3) * 2,
    )
    y = random_tensor(
        ndim=5,
        dim0=random(1, 3) * 2,
...
def _test_einsum_bilinear_transformation(test_case, placement, sbp):
    ...
    dim2 = random(1, 3) * 2
    x = random_tensor(ndim=2, dim0=dim0, dim1=dim1,)
    y = random_tensor(ndim=3, dim0=random(1, 3) * 2, dim1=dim1, dim2=dim2,)
...
def _test_einsum_tensor_contraction2(test_case, placement, sbp):
    ...
    y = random_tensor(ndim=2, dim0=dim0, dim1=random(1, 3) * 2,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_matmul2(test_case, placement, sbp):
    dim0 = random(1, 3) * 2
    x = random_tensor(ndim=2, dim0=random(1, 3) * 2, dim1=dim0,)
    y = random_tensor(ndim=2, dim0=random(1, 3) * 2, dim1=dim0,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_attention(test_case, placement, sbp):
    ...
    dim1 = random(1, 3) * 2
    dim2 = random(1, 3) * 2
    x = random_tensor(ndim=4, dim0=dim0, dim1=dim1, dim2=random(1, 3) * 2, dim3=dim2,)
    y = random_tensor(ndim=4, dim0=dim0, dim1=dim1, dim2=random(1, 3) * 2, dim3=dim2,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_batch_matmul2(test_case, placement, sbp):
    ...
    dim2 = random(1, 3) * 2
    x = random_tensor(ndim=4, dim0=dim0, dim1=dim1, dim2=random(1, 3) * 2, dim3=dim2)
    y = random_tensor(ndim=4, dim0=dim0, dim1=dim1, dim2=dim2, dim3=random(1, 3) * 2)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_batch_matmul3(test_case, placement, sbp):
    ...
    dim1 = random(1, 3) * 2
    x = random_tensor(
        ndim=4, dim0=dim0, dim1=random(1, 3) * 2, dim2=random(1, 3) * 2, dim3=dim1,
    )
    y = random_tensor(ndim=3, dim0=dim0, dim1=random(1, 3) * 2, dim2=dim1,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_alphaflod_usecase1(test_case, placement, sbp):
    dim0 = random(1, 3) * 2
    dim1 = random(1, 3) * 2
    x = random_tensor(ndim=3, dim0=random(1, 3) * 2, dim1=dim0, dim2=dim1,)
    y = random_tensor(ndim=3, dim0=dim0, dim1=dim1, dim2=random(1, 3) * 2,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_alphaflod_usecase2(test_case, placement, sbp):
    dim0 = random(1, 3) * 2
    dim1 = random(1, 3) * 2
    x = random_tensor(ndim=3, dim0=dim0, dim1=dim1, dim2=random(1, 3) * 2,)
    y = random_tensor(ndim=3, dim0=dim0, dim1=dim1, dim2=random(1, 3) * 2,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_alphaflod_usecase4(test_case, placement, sbp):
    ...
    dim1 = random(1, 3) * 2
    x = random_tensor(ndim=3, dim0=random(1, 3) * 2, dim1=dim0, dim2=dim1,)
    y = random_tensor(ndim=3, dim0=random(1, 3) * 2, dim1=dim0, dim2=dim1,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_alphaflod_usecase5(test_case, placement, sbp):
    dim0 = random(1, 3) * 2
    x = random_tensor(ndim=2, dim0=random(1, 3) * 2, dim1=dim0,)
    y = random_tensor(ndim=3, dim0=dim0, dim1=random(1, 3) * 2, dim2=random(1, 3) * 2,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_alphaflod_usecase8(test_case, placement, sbp):
    dim0 = random(1, 3) * 2
    x = random_tensor(ndim=3, dim0=dim0, dim1=random(1, 3) * 2, dim2=random(1, 3) * 2,)
    y = random_tensor(ndim=3, dim0=dim0, dim1=random(1, 3) * 2, dim2=random(1, 3) * 2,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_alphaflod_usecase9(test_case, placement, sbp):
    dim0 = random(1, 3) * 2
    x = random_tensor(ndim=3, dim0=random(1, 3) * 2, dim1=random(1, 3) * 2, dim2=dim0,)
    y = random_tensor(ndim=2, dim0=dim0, dim1=random(1, 3) * 2,)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
...
def _test_einsum_alphaflod_usecase10(test_case, placement, sbp):
    ...
    dim2 = random(1, 3) * 2
    x = random_tensor(ndim=4, dim0=dim0, dim1=dim1, dim2=random(1, 3) * 2, dim3=dim2,)
    y = random_tensor(ndim=4, dim0=dim0, dim1=dim2, dim2=dim1, dim3=random(1, 3) * 2)
    g_x = x.to_global(placement=placement, sbp=sbp)
    g_y = y.to_global(placement=placement, sbp=sbp)
