...
def _test_softplus(test_case, placement, sbp):
    dims = [random(1, 3) * 8 for i in range(4)]
    x = random_tensor(4, *dims).to_global(placement=placement, sbp=sbp)
    # TODO: test beta and threshold:
    # issue: https://github.com/Oneflow-Inc/oneflow/issues/7817
    ...
    def test_softplus(test_case):
        for placement in all_placement():
            for sbp in all_sbp(placement, max_dim=4):
                _test_softplus(test_case, placement, sbp)
