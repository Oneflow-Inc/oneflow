...
class TestConv1d(flow.unittest.TestCase):
    ...
    def profile_conv1d(test_case):
        ...
        torch.nn.functional.conv1d(inputs, weight_16c, bias=torch.ones(20), padding=1)
        torch.nn.functional.conv1d(inputs, weight_16c, bias=torch.ones(20), padding=1, stride=2)
        ...
        torch.nn.functional.conv1d(inputs, weight_3k_16c, bias=torch.ones(20), padding=1)
        torch.nn.functional.conv1d(inputs, weight_3k_16c, bias=torch.ones(20), padding=1, stride=2)
        torch.nn.functional.conv1d(inputs, weight_1k_16c)
        torch.nn.functional.conv1d(inputs, weight_1k_16c, bias=torch.ones(20))
        torch.nn.functional.conv1d(inputs, weight_1k_16c, bias=torch.ones(20), padding=1)
        torch.nn.functional.conv1d(inputs, weight_1k_16c, bias=torch.ones(20), padding=1, stride=2)
