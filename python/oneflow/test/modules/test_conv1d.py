...
class TestConv1d(flow.unittest.TestCase):
    ...
    def profile_conv1d(test_case):
        ...
        filter_16c  = torch.ones(20, 16, 5)
        filter_4c  = torch.ones(20, 4, 5)
        filter_3k  = torch.ones(20, 16, 3)
        filter_1k  = torch.ones(20, 16, 1)
        torch.nn.functional.conv1d(inputs, filter_16c)
        torch.nn.functional.conv1d(inputs, filter_16c, bias=torch.ones(20))
        torch.nn.functional.conv1d(inputs, filter_16c, bias=torch.ones(20), padding=1)
        torch.nn.functional.conv1d(inputs, filter_16c, bias=torch.ones(20), padding=1, stride=2)
        torch.nn.functional.conv1d(inputs, filter_4c, groups=4)
        torch.nn.functional.conv1d(inputs, filter_4c, bias=torch.ones(20), groups=4)
        torch.nn.functional.conv1d(inputs, filter_4c, bias=torch.ones(20),groups=4,stride=4)
        torch.nn.functional.conv1d(inputs, filter_4c, bias=torch.ones(20),groups=4,padding=1)
        torch.nn.functional.conv1d(inputs, filter_3k)
        torch.nn.functional.conv1d(inputs, filter_3k, bias=torch.ones(20))
        torch.nn.functional.conv1d(inputs, filter_3k, bias=torch.ones(20), padding=1)
        torch.nn.functional.conv1d(inputs, filter_3k, bias=torch.ones(20), padding=1, stride=2)
        torch.nn.functional.conv1d(inputs, filter_1k)
        torch.nn.functional.conv1d(inputs, filter_1k, bias=torch.ones(20))
        torch.nn.functional.conv1d(inputs, filter_1k, bias=torch.ones(20), padding=1)
        torch.nn.functional.conv1d(inputs, filter_1k, bias=torch.ones(20), padding=1, stride=2)
