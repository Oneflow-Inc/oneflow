...
class TestConv1d(flow.unittest.TestCase):
    ...
    def profile_conv1d(test_case):
        ...
        weight_3k  = torch.ones(20, 16, 3)
        weight_1k  = torch.ones(20, 16, 1)
        ...
        torch.nn.functional.conv1d(inputs, weight_16c_4g, bias=torch.ones(20),groups=4,stride=4)
        torch.nn.functional.conv1d(inputs, weight_16c_4g, bias=torch.ones(20),groups=4,padding=1)
