...
class TestImageBatchAlign(flow.unittest.TestCase):
    def test_image_batch_align(test_case):
        image_files = [
            oneflow.unittest.dataset_dir("mscoco_2017/val2017/000000000139.jpg"),
            oneflow.unittest.dataset_dir("mscoco_2017/val2017/000000000632.jpg"),
            oneflow.unittest.dataset_dir("mscoco_2017/val2017/000000000785.jpg"),
            oneflow.unittest.dataset_dir("mscoco_2017/val2017/000000001000.jpg"),
        ]
        alignment = 16
