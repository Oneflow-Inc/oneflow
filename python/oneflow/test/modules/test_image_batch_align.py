...
class TestImageBatchAlign(flow.unittest.TestCase):
    ...
    def test_image_batch_align(test_case):
        image_files = ['/dataset/mscoco_2017/val2017/000000000139.jpg', '/dataset/mscoco_2017/val2017/000000000632.jpg', '/dataset/mscoco_2017/val2017/000000000785.jpg', '/dataset/mscoco_2017/val2017/000000001000.jpg']
        alignment = 16
        ...
        image_batch_aligner = flow.nn.image.batch_align(shape=aligned_image_shape[1:], dtype=flow.float, alignment=alignment)
        ...
        input = flow.Tensor(images_np_arr_static, dtype=flow.float, device=flow.device('cpu'))
        images_buffer = flow.tensor_to_tensor_buffer(input, instance_dims=3)
        of_aligned_image = image_batch_aligner(images_buffer).numpy()
        test_case.assertTrue(np.array_equal(aligned_image_shape, of_aligned_image.shape))
