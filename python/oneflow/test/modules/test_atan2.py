...
class TestAtan2(flow.unittest.TestCase):
    ...
    def test_flow_atan2_with_random_data(test_case):
        for device in ['cpu', 'cuda']:
            test_flow_against_pytorch(test_case, 'atan2', extra_annotations={'other': flow.Tensor}, extra_generators={'input': random_tensor(ndim=1, dim1=1), 'other': random_tensor(ndim=1, dim1=1)}, device=device)
