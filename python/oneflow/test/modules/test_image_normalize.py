...
def _compare_image_normalize(test_case, image_files, std, mean):
    ...
    for (image, norm_image) in zip(images, norm_images):
        ...
        norm_image = norm_image[:np_norm_image.shape[0], :np_norm_image.shape[1], :np_norm_image.shape[2]]
...
class TestImageNormalize(flow.unittest.TestCase):
    ...
    def test_image_normalize(test_case):
        _compare_image_normalize(test_case, ['/dataset/mscoco_2017/val2017/000000000139.jpg', '/dataset/mscoco_2017/val2017/000000000632.jpg'], (102.9801, 115.9465, 122.7717), (1.0, 1.0, 1.0))
