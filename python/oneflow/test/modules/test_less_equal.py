...
class TestLessEqual(flow.unittest.TestCase):
    ...
    def test_less_equal(test_case):
        ...
        arg_dict['test_fun'] = [_test_less_equal_normal, _test_less_equal_symbol, _test_less_equal_int_scalar, _test_less_equal_int_tensor_int_scalr, _test_less_equal_float_scalar]
