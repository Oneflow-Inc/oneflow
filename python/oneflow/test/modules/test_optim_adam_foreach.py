...
def compare_with_adam_foreach(
    ...
    a = _train_with_adam(False)
    b = _train_with_adam(True)
...
class TestOptimizers(flow.unittest.TestCase):
    def test_adam_foreach(test_case):
        ...
        for arg in GenArgDict(arg_dict):
            compare_with_adam_foreach(test_case, **arg)
