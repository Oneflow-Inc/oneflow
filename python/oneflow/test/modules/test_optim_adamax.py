...
def compare_with_numpy_adamax(
    ...
    for i in range(tensor_num):
        # print("oneflow reuslt: ", oneflow_res[i].numpy().flatten())
        # print("torch reuslt: ", torch_res[i].detach().cpu().numpy().flatten())
        # print("numpy reuslt: ", numpy_res[i].flatten())
