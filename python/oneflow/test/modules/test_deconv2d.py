...
class TestDeconv2d(flow.unittest.TestCase):
    ...
    def profile_conv_transpose2d(test_case):
        ...
        torch.nn.functional.conv_transpose2d(inputs, weights_4x4_64c, stride=2, padding=1)
        torch.nn.functional.conv_transpose2d(inputs, weights_4x4_64c, stride=2, padding=1, bias=torch.ones(64))
