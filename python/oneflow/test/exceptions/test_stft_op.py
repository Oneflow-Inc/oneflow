...
class TestModule(flow.unittest.TestCase):
    ...
    def test_stft_illegal_win_length(test_case):
        ...
        test_case.assertTrue("Expected 0 < win_length <=n_fft ,but got" in str(ctx.exception))
    ...
    def test_stft_illegal_window(test_case):
        ...
        test_case.assertTrue("Expected a 1D window tensor of size equal to win_length=" in str(ctx.exception))
