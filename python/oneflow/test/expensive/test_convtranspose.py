...
class TestConvTranspose(flow.unittest.TestCase):
    ...
    def test_ConvTranspose1d_(test_case):
        ...
        m.to(device)
        x = random_tensor(ndim=3, dim1=channels, dim2=random(5, 10)).to(device)
        y = m(x)
        return y
    ...
    def test_ConvTranspose3d_(test_case):
        ...
        device = random_device()
        m.to(device)
        x = random_tensor(ndim=5, dim1=channels, dim2=random(5, 10), dim3=random(5, 10), dim4=random(5, 10)).to(device)
        y = m(x)
        return y
    ...
    def test_deconv3d_group_with_random_data(test_case):
        ...
        m.to(device)
        m.pytorch.to("cuda")
        x = random_tensor(ndim=5, dim1=channels, dim2=random(5, 10), dim3=random(5, 10)).to(device)
        x.pytorch = x.pytorch.to("cuda")
        y = m(x)
        return y
