...
class TestTensor(flow.unittest.TestCase):
    ...
    def test_flow_tensor_view_with_random_data(test_case):
        ...
        x = random_pytorch_tensor(ndim=5, dim0=dim0_, dim1=dim1_, dim2=dim2_, dim3=dim3_, dim4=dim4_)
        other = random_pytorch_tensor(ndim=5, dim0=dim4_, dim1=dim3_, dim2=dim2_, dim3=dim1_, dim4=dim0_)
