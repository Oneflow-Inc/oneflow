    ...
    def test_block_scope(test_case):
        ...
        class SubModule1(flow.nn.Module):
            ...
            def forward(self):
                ...
                x = self.dummy_buff
                dummy_buff_scope_proto = graph_build_util.scope_to_proto(self._buffers['dummy_buff'].scope)
                test_case.assertEqual(dummy_buff_scope_proto.parent_scope_symbol_id, scope.symbol_id)
