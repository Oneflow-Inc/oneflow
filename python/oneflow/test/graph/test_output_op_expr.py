...
class TestFetchOutputTensor(unittest.TestCase):
    ...
    def test_fetch_output_tensor(test_case):
        ...
        with oneflow._oneflow_internal.lazy_mode.gard(True):
            oneflow._oneflow_internal.JobBuildAndInferCtx_Open('cc_test_output_op_expr_job')
            ...
            input_op = oneflow._oneflow_internal.one.FeedInputOpExpr('cc_Input_0', input_conf, ['in_0'], ['out_0'])
