...
class TestScalarGraph(oneflow.unittest.TestCase):
    ...
    def test_slice_scalar_graph_gpu(test_case):
        _test_slice_scalar_graph(test_case, flow.device("cuda"))

    def test_slice_scalar_graph_cpu(test_case):
        _test_slice_scalar_graph(test_case, flow.device("cpu"))

    def test_slice_scalar_train_graph_gpu(test_case):
        _test_slice_scalar_train_graph(test_case, flow.device("cuda"))

    def test_slice_scalar_train_graph_cpu(test_case):
        _test_slice_scalar_train_graph(test_case, flow.device("cpu"))
