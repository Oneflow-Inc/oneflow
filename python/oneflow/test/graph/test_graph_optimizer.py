...
class TestGraphOptimizer(flow.unittest.TestCase):
    def test_optimizer(test_case):
        ...
        cosine_lr = flow.optim.lr_scheduler.CosineDecayLR(sgd0, steps=100, alpha=0.1)
    ...
    def test_multi_optimizer_conf(test_case):
        ...
        cosine_lr0 = flow.optim.lr_scheduler.CosineDecayLR(sgd0, steps=10, alpha=0.01)
        ...
        cosine_lr1 = flow.optim.lr_scheduler.CosineDecayLR(sgd1, steps=100, alpha=0.1)
