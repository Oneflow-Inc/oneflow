...
class TestGraphOptimizer(flow.unittest.TestCase):
    ...
    def test_optimizer(test_case):
        ...
        momentum = 0.2
        scale = 0.3
        sgd0 = flow.optim.SGD([{'params': [m.para0, m.para1, m.para2], 'lr': learning_rate, 'momentum': momentum, 'scale': scale}])
        sgd1 = flow.optim.SGD([{'params': [m.para3], 'lr': learning_rate, 'momentum': momentum, 'scale': scale}, {'params': [m.para4], 'lr': learning_rate, 'momentum': momentum, 'scale': scale}])
