...
def _data_load_layer(data_dir):
    ...
    ofrecord = flow.data.ofrecord_reader(data_dir, batch_size=12, data_part_num=8, name='decode')
...
def _conv2d_layer(name, input, filters, kernel_size=3, strides=1, padding='SAME', data_format='NCHW', dilation_rate=1, activation='Relu', use_bias=False, weight_initializer=flow.random_uniform_initializer(), bias_initializer=None):
...
def alexnet(images, labels):
    ...
    fc1 = flow.layers.dense(inputs=pool5, units=4096, activation=flow.math.relu, use_bias=False, kernel_initializer=flow.random_uniform_initializer(), bias_initializer=False, trainable=True, name='fc1')
    dropout1 = flow.nn.dropout(fc1, rate=0.5)
    fc2 = flow.layers.dense(inputs=dropout1, units=4096, activation=flow.math.relu, use_bias=False, kernel_initializer=flow.random_uniform_initializer(), bias_initializer=False, trainable=True, name='fc2')
    dropout2 = flow.nn.dropout(fc2, rate=0.5)
    fc3 = flow.layers.dense(inputs=dropout2, units=1001, activation=None, use_bias=False, kernel_initializer=flow.random_uniform_initializer(), bias_initializer=False, trainable=True, name='fc3')
