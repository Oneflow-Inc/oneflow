...
from oneflow.ao.nn.sparse.quantized import linear
from oneflow.ao.nn.sparse.quantized.utils import LinearBlockSparsePattern

import oneflow
import oneflow.nn.intrinsic as nni
...
class Linear(oneflow.nn.Module):
    ...
    def forward(self, x: oneflow.Tensor) -> oneflow.Tensor:
        return oneflow.ops.sparse.qlinear_dynamic(x, self._packed_params._packed_params)
    ...
    def from_float(cls, mod):
        ...
        if mod.qconfig is not None and mod.qconfig.weight is not None:
            ...
            # https://github.com/pyoneflow/pyoneflow/pull/24231. The current workaround is to postpone the
            # import until we need it.
            from oneflow.quantization.qconfig import default_dynamic_qconfig
