...
def draw_from_files_and_draw(get_y, pic_name):
    ...
    draw_from_file(ax, rf"{model_name}-meg-eq-\d+.json", get_threshold_from_json_file, get_y, 'eq')
    draw_from_file(ax, rf"{model_name}-meg-div-\d+.json", get_threshold_from_json_file, get_y, 'div')
    draw_from_file(ax, rf"{model_name}-meg-mul-\d+.json", get_threshold_from_json_file, get_y, 'mul')
