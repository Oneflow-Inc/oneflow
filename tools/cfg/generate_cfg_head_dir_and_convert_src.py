...
def get_build_oneflow_proto_java():
    return os.path.join(SCRIPT_DIR, "build_oneflow_proto_java.py")
...
if __name__ == "__main__":
    ...
    elif message_type == "build_oneflow_proto_java":
        print(get_build_oneflow_proto_java(), end="")
    else:
