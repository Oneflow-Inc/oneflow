...
class Generator:
    ...
    def generate_pybind_for_python(self, pybind_header_fmt, pybind_source_fmt, target_pybind_header_file, target_pybind_source_file):
        schema_fmt = ""
        module_fmt = ""
        header_fmt = ""
        for name, blocks in self._blocks.items():
