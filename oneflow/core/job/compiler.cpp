...
std::map<TaskType, std::string> task_type2color = {
    {kInvalid, "0"},        {kNormalForward, "2"},  {kRecurrentForward, "2"},
    {kGatherForward, "2"},  {kNormalBackward, "3"}, {kRecurrentBackward, "3"},
    {kGatherBackward, "3"}, {kSource, "1"},         {kLoss, "4"},
    {kLossAcc, "5"},        {kLossPrint, "1"},      {kMdUpdt, "6"},
