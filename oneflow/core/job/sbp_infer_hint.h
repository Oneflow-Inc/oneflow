...
public:
  SbpInferHint(const ParallelDesc *parallel_desc,
               const BlobDesc *logical_blob_desc,
               const SbpParallel *sbp_parallel, const OptInt64 *batch_axis)
      : parallel_desc_(parallel_desc), logical_blob_desc_(logical_blob_desc),
        sbp_parallel_(sbp_parallel), batch_axis_(batch_axis) {}
