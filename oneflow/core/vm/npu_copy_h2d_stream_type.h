...
*/
#ifndef ONEFLOW_CORE_VM_NPU_COPY_H2D_STREAM_TYPE_H_
#define ONEFLOW_CORE_VM_NPU_COPY_H2D_STREAM_TYPE_H_
...
class NpuCopyH2DStreamType final : public StreamType {
 public:
  NpuCopyH2DStreamType() = default;
  ~NpuCopyH2DStreamType() = default;

  const char* stream_tag() const override { return "npu_h2d"; }
...
#endif  // ONEFLOW_CORE_VM_NPU_COPY_H2D_STREAM_TYPE_H_
