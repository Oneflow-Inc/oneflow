...
class VirtualMachine final {
 public:
  ...
  intrusive::shared_ptr<vm::LocalObject> FindOrCreateTransportLocalDepObject();
 ...
 private:
  ...
  intrusive::shared_ptr<vm::LocalObject> FindOrCreateScheduleLocalDepObject(Symbol<Device> device,
  ...
  HashMap<std::pair<Symbol<Device>, StreamRole>, intrusive::shared_ptr<vm::LocalObject>>
      device_stream_role2local_dep_object_;
  intrusive::shared_ptr<vm::LocalObject> transport_local_dep_object_;
