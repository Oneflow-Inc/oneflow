...
void CudaCopyD2HStreamType::InitDeviceCtx(
...
void CudaCopyD2HStreamType::InitInstructionStatus(
...
void CudaCopyD2HStreamType::DeleteInstructionStatus(
    const Stream &stream, InstructionStatusBuffer *status_buffer) const {
  // do nothing
}
...
CudaCopyD2HStreamType::MakeStreamDesc(const Resource &resource,
  ...
  ret->mutable_stream_type_id()->__Init__(
      LookupStreamType4TypeIndex<CudaCopyD2HStreamType>());
