...
#ifndef ONEFLOW_CORE_VM_ASYNC_NPU_STREAM_TYPE_H_
#define ONEFLOW_CORE_VM_ASYNC_NPU_STREAM_TYPE_H_
...
class AsyncNpuStreamType final : public StreamType {
 public:
  AsyncNpuStreamType() = default;
  ~AsyncNpuStreamType() override = default;

  const char* stream_tag() const override { return "async_launched_hccl"; }
