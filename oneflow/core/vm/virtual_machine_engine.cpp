...
void VirtualMachineEngine::InsertSchedulerProbe(
    const std::function<void(VirtualMachineEngine*)>& ProbeFunction) {
  scheduler_probe_list_.EmplaceBack(intrusive::make_shared<SchedulerProbe>(ProbeFunction));
}
