...
Maybe<void> VirtualMachine::Prob(const std::function<bool(vm::VirtualMachineEngine*)>& prob_func) {
...
Maybe<void> VirtualMachine::MemShrinkAll() {
  auto shrink_men = [](vm::VirtualMachineEngine* engine) {
