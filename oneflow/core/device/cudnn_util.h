...
class CudnnTensorDesc final {
 public:
  ...
  CudnnTensorDesc(DataType data_type, const DenseShapeView& shape, const std::string& data_format);
...
class CudnnFilterDesc final {
 public:
  ...
  CudnnFilterDesc(DataType data_type, const DenseShapeView& shape, const std::string& data_format);
