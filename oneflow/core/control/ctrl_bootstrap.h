...
class CtrlBootstrap {
 ...
 protected:
  ...
  virtual Maybe<void> InitProcessDistributionInfoInCluster(ProcessCtx* process_ctx) const = 0;
...
class HostListCtrlBootstrap final : public CtrlBootstrap {
 ...
 private:
  ...
  Maybe<void> InitProcessDistributionInfoInCluster(ProcessCtx* process_ctx) const override;
