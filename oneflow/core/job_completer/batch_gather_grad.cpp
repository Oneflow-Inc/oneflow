...
void GenerateBackwardOpConf(
  ...
  if (DiffLbi4BnInOp("in") != nullptr) {
    OperatorConf unsorted_segment_sum;
    unsorted_segment_sum.set_name("System-AutoGrad-" + op.op_name());
    UnsortedSegmentSumOpConf* conf = unsorted_segment_sum.mutable_unsorted_segment_sum_conf();
    ...
    op_confs->push_back(unsorted_segment_sum);
    DiffLbi4BnInOp("in")->set_op_name(unsorted_segment_sum.name());
