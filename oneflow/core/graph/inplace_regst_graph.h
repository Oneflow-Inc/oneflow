...
public:
  ...
  explicit InplaceRegstNode(const RegstDescProto *regst_desc)
...
class InplaceRegstGraph final
    : public Graph<const InplaceRegstNode, const InplaceRegstEdge> {
public:
  OF_DISALLOW_COPY_AND_MOVE(InplaceRegstGraph);
  explicit InplaceRegstGraph(
