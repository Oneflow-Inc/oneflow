...
void BoxingUnpackCompTaskNode::BuildExecGphAndRegst() {
  ...
  *op_conf.mutable_boxing_unpack_conf()->mutable_lbi() = lbi_;
  logical_shape_.ToProto(op_conf.mutable_boxing_unpack_conf()->mutable_logical_shape());
  ...
  op_conf.mutable_boxing_unpack_conf()->set_parallel_num(parallel_ctx()->parallel_num());
