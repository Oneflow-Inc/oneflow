...
void EmbeddingLookupBackwardCompTaskNode::
...
void EmbeddingLookupBackwardCompTaskNode::VirtualBuildActivationDiffRegst() {
...
void EmbeddingLookupBackwardCompTaskNode::VirtualBuildInDiffRegst() {
...
void EmbeddingLookupBackwardCompTaskNode::VirtualProduceInDiffAndBindEdge(
    TaskEdge* edge) {
  edge->AddRegst("in_diff", ProduceRegst("in_diff"));
}

void EmbeddingLookupBackwardCompTaskNode::VirtualProduceActivationDiff() {
  ProduceRegst("activation_diff", 1, 1);
}

void EmbeddingLookupBackwardCompTaskNode::VirtualConsumeActivation(
    TaskEdge* edge) {
...
void EmbeddingLookupBackwardCompTaskNode::VirtualConsumeInRegst() {
