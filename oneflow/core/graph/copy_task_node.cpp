...
void CopyTaskNode::InferProducedDataRegstTimeShape() {
  NaiveInferProducedDataRegstTimeShape();
}

void CopyHdTaskNode::Init(CopyHdOpConf::Type copy_type, int64_t machine_id,
                          int64_t dev_phy_id) {
...
int64_t CopyCommNetTaskNode::AllocateLocalWorkStreamId() {
  ...
  int64_t local_work_stream_id =
      GetLocalStreamId4Connection(this_machine_id, peer_machine_id_);
