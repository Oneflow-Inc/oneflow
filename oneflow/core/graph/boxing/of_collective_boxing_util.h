...
*/
#ifndef ONEFLOW_CORE_JOB_OF_COLLECTIVE_BOXING_UTIL_H_
#define ONEFLOW_CORE_JOB_OF_COLLECTIVE_BOXING_UTIL_H_
...
template<>
struct hash<oneflow::boxing::of_collective::DeviceDesc> {
  size_t operator()(const oneflow::boxing::of_collective::DeviceDesc& device_desc) const {
...
template<>
struct hash<oneflow::boxing::of_collective::DeviceSet> {
  size_t operator()(const oneflow::boxing::of_collective::DeviceSet& device_set) const {
    size_t hash = 0;
...
#endif  // ONEFLOW_CORE_JOB_OF_COLLECTIVE_BOXING_UTIL_H_
