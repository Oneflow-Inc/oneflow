...
class SubTskGphBuilderCtx final {
 public:
  ...
  TaskNode* GetProxyNode(TaskNode* src_node, MemZoneId src_mem_zone_id, ProcessId dst_process_id,
 ...
 private:
  ...
  HashMap<TaskNode*, HashMap<std::pair<ProcessId, MemZoneId>, TaskNode*>> node2proxies_;
};
