...
class EmbeddingLookupMdUpdtCompTaskNode final : public MdUpdtCompTaskNode {
 public:
  ...
  TaskType GetTaskType() const override { return TaskType::kEmbeddingLookupMdUpdt; }

 private:
  std::shared_ptr<const Operator> ConstructModelUpdateOp(int32_t in_num) override;
