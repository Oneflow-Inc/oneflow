...
std::shared_ptr<const Operator> EmbeddingLookupMdUpdtCompTaskNode::ConstructModelUpdateOp(int32_t in_num) {
...
void EmbeddingLookupMdUpdtCompTaskNode::BindInRegst() {
  size_t ibn_idx = 0;
  const ExecNode* node = mut_exec_gph().SoleNode();
