...
NVTX_DECLSPEC void NVTX_API nvtxNameCategoryA(uint32_t category, const char* name) {
  ...
  if (local != 0) (*local)(category, name);
#endif /*NVTX_DISABLE*/
}
...
NVTX_DECLSPEC void NVTX_API nvtxNameOsThreadA(uint32_t threadId, const char* name) {
  ...
  if (local != 0) (*local)(threadId, name);
#endif /*NVTX_DISABLE*/
}
...
NVTX_DECLSPEC void NVTX_API nvtxDomainMarkEx(nvtxDomainHandle_t domain,
  ...
  if (local != 0) (*local)(domain, eventAttrib);
#endif /*NVTX_DISABLE*/
}
...
NVTX_DECLSPEC void NVTX_API nvtxDomainResourceDestroy(nvtxResourceHandle_t resource) {
  ...
  if (local != 0) (*local)(resource);
#endif /*NVTX_DISABLE*/
}

NVTX_DECLSPEC void NVTX_API nvtxDomainNameCategoryA(nvtxDomainHandle_t domain, uint32_t category,
                                                    const char* name) {
#ifndef NVTX_DISABLE
  nvtxDomainNameCategoryA_impl_fntype local =
      NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxDomainNameCategoryA_impl_fnptr;
  if (local != 0) (*local)(domain, category, name);
#endif /*NVTX_DISABLE*/
}

NVTX_DECLSPEC void NVTX_API nvtxDomainNameCategoryW(nvtxDomainHandle_t domain, uint32_t category,
                                                    const wchar_t* name) {
#ifndef NVTX_DISABLE
