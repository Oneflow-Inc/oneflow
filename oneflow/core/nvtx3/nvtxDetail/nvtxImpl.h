...
NVTX_LINKONCE_FWDDECL_FUNCTION int NVTX_API NVTX_VERSIONED_IDENTIFIER(
    nvtxEtiGetModuleFunctionTable)(NvtxCallbackModule module, NvtxFunctionTable* out_table,
...
NVTX_LINKONCE_DEFINE_GLOBAL nvtxGlobals_t NVTX_VERSIONED_IDENTIFIER(nvtxGlobals) = {
    ...
    {sizeof(NvtxExportTableVersionInfo), NVTX_VERSION, 0,
    ...
    {0, (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxMarkEx_impl_fnptr,
     ...
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameOsThreadW_impl_fnptr, 0},
    {0, (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameCuDeviceA_impl_fnptr,
     ...
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameCuEventW_impl_fnptr, 0},
    {0, (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClDeviceA_impl_fnptr,
     ...
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals)
     ...
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxNameClEventW_impl_fnptr, 0},
    {0,
     ...
     0},
    {0, (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxDomainMarkEx_impl_fnptr,
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals)
     ...
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals)
         .nvtxDomainResourceCreate_impl_fnptr,
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals)
         .nvtxDomainResourceDestroy_impl_fnptr,
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals)
         .nvtxDomainNameCategoryA_impl_fnptr,
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals)
         .nvtxDomainNameCategoryW_impl_fnptr,
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals)
         .nvtxDomainRegisterStringA_impl_fnptr,
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals)
     ...
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals).nvtxInitialize_impl_fnptr, 0},
    {0,
     (NvtxFunctionPointer*)&NVTX_VERSIONED_IDENTIFIER(nvtxGlobals)
...
NVTX_LINKONCE_DEFINE_FUNCTION int NVTX_API NVTX_VERSIONED_IDENTIFIER(nvtxEtiGetModuleFunctionTable)(
  ...
  if (out_size) *out_size = (bytes / (unsigned int)sizeof(NvtxFunctionPointer*)) - 1;
