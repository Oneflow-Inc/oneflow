...
#define NVTX_RESOURCE_CLASS_SYNC_PTHREAD \
  3 /**< Synchronization objects that are from the POSIX Threads API (pthread)*/
/** \endcond */
...
typedef enum nvtxResourceSyncPosixThreadType_t {
  NVTX_RESOURCE_TYPE_SYNC_PTHREAD_MUTEX =
      NVTX_RESOURCE_MAKE_TYPE(SYNC_PTHREAD, 1), /* pthread_mutex_t  */
  NVTX_RESOURCE_TYPE_SYNC_PTHREAD_CONDITION =
      NVTX_RESOURCE_MAKE_TYPE(SYNC_PTHREAD, 2), /* pthread_cond_t  */
  NVTX_RESOURCE_TYPE_SYNC_PTHREAD_RWLOCK =
      NVTX_RESOURCE_MAKE_TYPE(SYNC_PTHREAD, 3), /* pthread_rwlock_t  */
  NVTX_RESOURCE_TYPE_SYNC_PTHREAD_BARRIER =
      NVTX_RESOURCE_MAKE_TYPE(SYNC_PTHREAD, 4), /* pthread_barrier_t  */
  NVTX_RESOURCE_TYPE_SYNC_PTHREAD_SPINLOCK =
      NVTX_RESOURCE_MAKE_TYPE(SYNC_PTHREAD, 5), /* pthread_spinlock_t  */
  NVTX_RESOURCE_TYPE_SYNC_PTHREAD_ONCE =
      NVTX_RESOURCE_MAKE_TYPE(SYNC_PTHREAD, 6) /* pthread_once_t  */
 ...
 * a user defined syncrhonization object.  The tools will return a pointer through the API for the
 * application to hold on it's behalf to reference the string in the future.
 *
 */
...
nvtxDomainSyncUserAcquireFailed(nvtxSyncUser_t handle);
...
* \version \NVTX_VERSION_2
*/ NVTX_DECLSPEC void NVTX_API
nvtxDomainSyncUserAcquireSuccess(nvtxSyncUser_t handle);
