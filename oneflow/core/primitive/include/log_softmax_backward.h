...
*/
#ifndef ONEFLOW_CORE_PRIMITIVE_LOG_SOFTMAX_BACKWARD_H_
#define ONEFLOW_CORE_PRIMITIVE_LOG_SOFTMAX_BACKWARD_H_
...
#endif  // ONEFLOW_CORE_PRIMITIVE_LOG_SOFTMAX_BACKWARD_H_
