...
*/
#ifndef ONEFLOW_CORE_PRIMITIVE_COMMON_PERMUTE_IMPL_H_
#define ONEFLOW_CORE_PRIMITIVE_COMMON_PERMUTE_IMPL_H_
...
#endif  // ONEFLOW_CORE_PRIMITIVE_COMMON_PERMUTE_IMPL_H_
