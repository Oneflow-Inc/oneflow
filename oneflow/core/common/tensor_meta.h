...
class LocalTensorMeta : public ConstTensorMeta {
 public:
  ...
  LocalTensorMeta(Symbol<Shape> shape, Symbol<Stride> stride, DataType dtype, MemoryFormat memory_format, Symbol<Device> device,
                  bool is_view);
  LocalTensorMeta(const Shape& shape, DataType dtype, MemoryFormat memory_format, Symbol<Device> device)
      : LocalTensorMeta(SymbolOf(shape), dtype, memory_format, device) {}
  LocalTensorMeta(const Shape& shape, const Stride& stride, DataType dtype, MemoryFormat memory_format, Symbol<Device> device)
