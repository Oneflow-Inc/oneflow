...
struct ClampHelper<
  ...
  OF_DEVICE_FUNC static T Call(U value) {
...
struct ClampHelper<T, U, std::enable_if_t<!NeedsClamp<U, T>::value, void>> {
  OF_DEVICE_FUNC static T Call(U value) { return value; }
};

OF_DEVICE_FUNC int32_t Clamp(uint32_t value) {
  return value & 0x80000000u ? 0x7fffffff : value;
}

OF_DEVICE_FUNC uint32_t Clamp(int32_t value) { return value < 0 ? 0u : value; }

OF_DEVICE_FUNC int32_t Clamp(int64_t value) {
...
struct ClampHelper<int32_t, uint64_t> {
  OF_DEVICE_FUNC static int32_t Call(uint64_t value) {
...
struct ClampHelper<uint32_t, int64_t> {
  OF_DEVICE_FUNC static uint32_t Call(int64_t value) {
    return value < 0
               ? 0
...
struct ClampHelper<uint32_t, uint64_t> {
  OF_DEVICE_FUNC static uint32_t Call(uint64_t value) {
...
struct ClampHelper<bool, T> {
  OF_DEVICE_FUNC static bool Call(T value) { return static_cast<bool>(value); }
};

template<typename T>
struct ClampHelper<float16, T> {
  static float16 Call(T value) {
...
struct ClampHelper<T, float16> {
  static T Call(float16 value) {
    return ClampHelper<T, float>::Call(static_cast<float>(value));
  }
};

float16 Clamp(float16 value) { return value; }

template<typename T, typename U>
OF_DEVICE_FUNC T Clamp(U value) {
