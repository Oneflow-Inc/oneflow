...
template <typename DimT> class ShapeViewBase {
public:
  using DimType = DimT;
  ShapeViewBase(DimType *ptr, int64_t num_axes)
      : ptr_(ptr), num_axes_(num_axes) {}
...
public:
  ...
  ShapeView(const int64_t *ptr, int64_t num_axes)
      : ShapeViewBase<const int64_t>(ptr, num_axes) {}
...
public:
  ...
  MutShapeView(int64_t *ptr, int64_t num_axes)
      : ShapeViewBase<int64_t>(ptr, num_axes) {}
