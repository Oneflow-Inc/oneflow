...
#define TFPB_DATA_TYPE_SEQ OF_PP_MAKE_TUPLE_SEQ(tensorflow::Example, DataType::kTFRecord)
#define ALL_DATA_TYPE_SEQ POD_DATA_TYPE_SEQ PB_DATA_TYPE_SEQ TFPB_DATA_TYPE_SEQ
