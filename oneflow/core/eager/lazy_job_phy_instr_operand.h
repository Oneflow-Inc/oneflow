...
class LaunchLazyJobPhyInstrOperand final : public PhyInstrOperand {
 public:
  ...
  LaunchLazyJobPhyInstrOperand(
      ...
      : inputs_critical_section_(inputs_critical_section), outputs_critical_section_(outputs_critical_section), params_critical_section_(params_critical_section), nn_graph_(nn_graph) {}
