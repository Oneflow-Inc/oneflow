...
#ifdef WITH_CUDA
COMMAND(
    vm::RegisterInstructionType<ReleaseTensorInstructionType<CudaStreamType>>("gpu.ReleaseTensor"));
COMMAND(vm::RegisterInstructionType<ReleaseTensorInstructionType<CudaStreamType>>(
    "cuda.ReleaseTensor"));
COMMAND(vm::RegisterInstructionType<ReleaseTensorInstructionType<CudaCopyH2DStreamType>>(
    "cuda_h2d.ReleaseTensor"));
COMMAND(vm::RegisterInstructionType<ReleaseTensorInstructionType<CudaCopyD2HStreamType>>(
    "cuda_d2h.ReleaseTensor"));
COMMAND(vm::RegisterInstructionType<ReleaseTensorInstructionType<CudaStreamType>>(
    "sync_launched_nccl.ReleaseTensor"));
COMMAND(vm::RegisterInstructionType<ReleaseTensorInstructionType<AsyncCudaStreamType>>(
