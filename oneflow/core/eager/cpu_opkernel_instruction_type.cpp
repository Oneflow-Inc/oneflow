...
class CpuCallOpKernelInstructionType final
...
COMMAND(vm::RegisterInstructionType<CpuCallOpKernelInstructionType>(
    "cpu.CallOpKernel"));
...
COMMAND(
    vm::RegisterInstructionType<CpuUserStatelessCallOpKernelInstructionType>(
...
COMMAND(
    vm::RegisterInstructionType<CpuSystemStatelessCallOpKernelInstructionType>(
        "cpu.compute.SystemStatelessCallOpKernel"));

class CpuFetchBlobHeaderInstructionType final
...
COMMAND(vm::RegisterInstructionType<CpuFetchBlobHeaderInstructionType>(
    "cpu.FetchBlobHeader"));

class CpuFetchBlobBodyInstructionType final
...
COMMAND(vm::RegisterInstructionType<CpuFetchBlobBodyInstructionType>(
    "cpu.FetchBlobBody"));
...
COMMAND(
    vm::RegisterInstructionType<CpuFeedBlobInstructionType>("cpu.FeedBlob"));
