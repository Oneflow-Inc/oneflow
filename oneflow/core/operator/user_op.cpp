...
class UserOpKernelRegContext final : virtual public user_op::UserOpConfOpInfoProvider, virtual public user_op::UserOpConfAttrProvider, public user_op::KernelRegContext {
 public:
  ...
  explicit UserOpKernelRegContext(const UserOp* user_op,
      ...
      : user_op::UserOpConfOpInfoProvider(user_op->op_conf()), user_op::UserOpConfAttrProvider(user_op->op_conf()) {
