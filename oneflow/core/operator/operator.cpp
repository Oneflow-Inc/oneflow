...
Maybe<void> Operator::GreedilyFindMinCopyCostNdSbp(
  ...
  if (nd_sbp_sig_list.size() == 1) {
    ...
    if (GlobalProcessCtx::Rank() == 0
        && op_name().find("model.t5_model.embedding.word_embeddings.weight") != std::string::npos) {
