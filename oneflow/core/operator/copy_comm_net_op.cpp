...
LogicalBlobId CopyCommNetOp::obn2lbi(const std::string& output_bn) const { return GenPackedLbi(); }

LogicalBlobId CopyCommNetOp::ibn2lbi(const std::string& input_bn) const { return GenPackedLbi(); }
