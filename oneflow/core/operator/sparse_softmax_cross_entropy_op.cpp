#include "oneflow/core/operator/sparse_softmax_cross_entropy_op.h"
#include "oneflow/core/job/sbp_signature_builder.h"
#include "oneflow/core/register/runtime_blob_desc.h"

namespace oneflow {

void SparseSoftmaxCrossEntropyOp::InitFromOpConf() {
...
const PbMessage& SparseSoftmaxCrossEntropyOp::GetCustomizedConf() const {
  return op_conf().sparse_softmax_cross_entropy_conf();
}

Maybe<void> SparseSoftmaxCrossEntropyOp::InferBlobDescs(
...
Maybe<void> SparseSoftmaxCrossEntropyOp::InferBatchAxis(
...
Maybe<void> SparseSoftmaxCrossEntropyOp::GetSbpSignatures(SbpSignatureList* sbp_sig_list) const {
  SbpSignatureBuilder()
      .Split(input_bns(), 0)
      .Split(output_bns(), 0)
