...
const PbMessage &RepeatOp::GetCustomizedConf() const {
  return op_conf().repeat_conf();
}
...
LogicalNode *RepeatOp::NewProperLogicalNode() const {
  return new RepeatForwardLogicalNode();
}
