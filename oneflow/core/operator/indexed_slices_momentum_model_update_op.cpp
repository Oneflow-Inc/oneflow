...
void IndexedSlicesMomentumMdUpdateOp::VirtualGenKernelConf(
  ...
  IndexedSlicesMomentumModelUpdateKernelConf
      *indexed_slices_momentum_model_update_conf =
          kernel_conf->mutable_indexed_slices_momentum_model_update_conf();
  indexed_slices_momentum_model_update_conf->set_indices_data_type(
...
REGISTER_OP(OperatorConf::kIndexedSlicesMomentumModelUpdateConf,
            IndexedSlicesMomentumMdUpdateOp);
