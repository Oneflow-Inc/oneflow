...
int64_t GetInDim(const ShapeView &shape, const std::string &data_format,
                 int32_t dim, int32_t NDim);
...
void Get3DOutputSize(const DimVector &in, const std::vector<int32_t> &pool_size,
                     ...
                     const std::string &padding_type, DimVector *out,
...
void Get3DOutputSize(const DimVector &in, const std::vector<int32_t> &pool_size,
                     const std::vector<int32_t> &strides,
                     const std::string &padding_type, const bool ceil_mode,
                     std::vector<int32_t> *dilation_rate, DimVector *out,
                     std::vector<int32_t> *padding_before,
                     std::vector<int32_t> *padding_after);

void GetConvOutAndPad(const ShapeView &in_blob_shape,
                      const PbMessage &conv_conf, DimVector *out,
