...
void SetTestConvolutionOpConf(OperatorConf* op_conf) {
...
void TestDataParallelConvolutionOp() {
  // create conv_op
  OperatorConf op_conf;
  SetTestConvolutionOpConf(&op_conf);
...
void TestModelParallelConvolutionOp() {
  // create conv_op
  OperatorConf op_conf;
  SetTestConvolutionOpConf(&op_conf);
  auto convolution_op = ConstructOp(op_conf);
...
TEST(ConvolutionOp, dataparallel_convolution) {
  TestDataParallelConvolutionOp();
}

TEST(ConvolutionOp, modelparallel_convolution) {
  TestModelParallelConvolutionOp();
}
