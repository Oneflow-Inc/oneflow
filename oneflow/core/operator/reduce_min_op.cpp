...
class ReduceMinOp final : public Operator {
 public:
  OF_DISALLOW_COPY_AND_MOVE(ReduceMinOp);
  ReduceMinOp() = default;
  ~ReduceMinOp() = default;
  ...
  const PbMessage& GetCustomizedConf() const override { return op_conf().reduce_min_conf(); }
