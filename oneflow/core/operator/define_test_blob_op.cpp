...
void DefineTestBlobOp::InferBlobDescs(
  ...
  out_blob_desc->set_has_varying_instance_num_field(conf.has_varying_instance_num_field());
  out_blob_desc->set_has_instance_varying_elem_cnt_field(
      conf.has_instance_varying_elem_cnt_field());
