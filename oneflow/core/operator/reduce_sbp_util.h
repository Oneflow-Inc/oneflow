...
struct ReduceSbpUtil final {
  ...
  static std::function<bool(int32_t)>
  MakePredicatorIsReducedAxis(const HashSet<int32_t> &axes, int32_t num_axes);
  static std::function<bool(int32_t)>
  MakePredicatorIsReducedAxis(const PbRf<int32_t> &axes, int32_t num_axes);
};
