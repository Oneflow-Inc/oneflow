...
class MutDecodeRandomOpConTickInputHelper final
    : public MutOpConTickInputHelper {
public:
...
REGISTER_AUTO_TICK(OperatorConf::kDecodeRandomConf,
                   MutDecodeRandomOpConTickInputHelper);
