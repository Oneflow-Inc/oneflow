...
void GenerateOptimizerOpConfWrapperStruct::Call(const VariableOp& var_op,
  ...
  (*func_)(var_op, parallel_conf, job_builder, ctx, diff_lbi_of_var_out);
}
...
void GenerateOptimizerOpConfIf(const VariableOp& var_op, const ParallelConf& parallel_conf,
  ...
  obj->Call(var_op, parallel_conf, job_builder, ctx, diff_lbi_of_var_out);
}
...
void AddOptimizerOpConf(const OpGraph& op_graph, JobBuilder* job_builder, JobPassCtx* ctx,
  ...
  op_graph.ForEachNode([&](OpNode* op_node) {
    ...
    GenerateOptimizerOpConfIf(*var_op, parallel_desc.parallel_conf(), job_builder, ctx,
                              diff_lbi_of_var_out);
  });
}
