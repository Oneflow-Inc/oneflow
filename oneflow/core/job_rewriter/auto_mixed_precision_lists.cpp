...
const AMPList& AutoMixedPrecisionLists::GrayList() {
  static AMPList gray_list = {
      ...
      "sigmoid_grad", "tanh", "tanh_grad", "sqrt", "sqrt_grad", "scalar_mul",
      "scalar_mul_by_tensor", "scalar_add", "scalar_div", "scalar_pow", "broadcast_add",
      ...
      "log_softmax_grad", "gelu", "gelu_grad", "normalization", "normalization_grad",
      "normalization_add_relu", "normalization_add_relu_grad", "sparse_softmax_cross_entropy",
