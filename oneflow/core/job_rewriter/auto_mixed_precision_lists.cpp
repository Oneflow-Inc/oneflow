...
const AMPList& AutoMixedPrecisionLists::GrayList() {
  static AMPList gray_list = {
      "add_n", "tf_avg_pool_1d", "tf_avg_pool_1d_grad", "tf_avg_pool_2d", "tf_avg_pool_2d_grad",
      "tf_avg_pool_3d", "tf_avg_pool_3d_grad", "bias_add", "reduce_sum", "reduce_sum_like",
      // "sigmoid_v2_grad",
      "tanh", "tanh_grad", "sqrt", "sqrt_grad", "scalar_mul", "scalar_mul_by_tensor", "scalar_add",
      "scalar_div", "scalar_pow", "broadcast_add", "broadcast_sub", "broadcast_mul",
      "broadcast_div", "layer_norm",
      // "layer_norm_param_grad",
      "layer_norm_grad", "dropout", "dropout_grad", "softmax", "softmax_grad", "log_softmax",
      "log_softmax_grad", "gelu", "gelu_grad",
      // "wkv_grad",
      "normalization", "normalization_grad", "normalization_add_relu",
      "normalization_add_relu_grad", "sparse_softmax_cross_entropy",
      "sparse_softmax_cross_entropy_grad",
      // "nll",
      // "nll_grad",
      "fused_tril_scale_softmax_mask_scale", "fused_tril_scale_softmax_mask_scale_grad",
      "fused_scale_mask_softmax_dropout", "fused_scale_mask_softmax_dropout_grad",
      "fused_scale_mask_softmax", "fused_scale_mask_softmax_grad", "fused_bias_add_gelu",
      "fused_bias_add_gelu_grad", "fused_bias_add_mask_scale", "acc", "reciprocal",
      "reciprocal_no_nan"};
  return gray_list;
}
