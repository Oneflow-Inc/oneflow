...
void GenerateBackwardOpConf(
  ...
  if (DiffLbi4BnInOp("prediction") != nullptr) {
    ...
    sigmoid_cross_entropy_grad_op_conf->set_label(
    ...
    sigmoid_cross_entropy_grad_op_conf->set_loss_diff(
    ...
    DiffLbi4BnInOp("prediction")
        ->set_op_name(sigmoid_cross_entropy_grad_op.name());
...
REGISTER_OP_GRAD(OperatorConf::kSigmoidCrossEntropyConf,
