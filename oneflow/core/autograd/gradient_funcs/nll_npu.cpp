...
class NllNpu : public OpExprGradFunction<NllNpuCaptureState> {
 public:
  ...
  Maybe<void> Capture(NllNpuCaptureState* ctx, const TensorTuple& inputs, const TensorTuple& outputs,
                      const AttrMap& attrs) const override;
  Maybe<void> Apply(const NllNpuCaptureState* ctx, const TensorTuple& out_grads,
...
Maybe<void> NllNpu::Apply(const NllNpuCaptureState* ctx, const TensorTuple& out_grads,
