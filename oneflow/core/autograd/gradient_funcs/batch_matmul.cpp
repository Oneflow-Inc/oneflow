...
struct BatchMatmulInterpState : public OpExprInterpState {
  bool transpose_a;
  bool transpose_b;
  double alpha;
...
class BatchMatmul : public OpExprGradFunction<BatchMatmulInterpState> {
 public:
  Maybe<void> Init(const OpExpr& op) override;
  Maybe<void> Capture(BatchMatmulInterpState* ctx, const TensorTuple& inputs,
                      const TensorTuple& outputs, const AttrMap& attrs) const override;
  Maybe<void> Apply(const BatchMatmulInterpState* ctx, const TensorTuple& out_grads,
...
Maybe<void> BatchMatmul::Capture(BatchMatmulInterpState* ctx, const TensorTuple& inputs,
...
Maybe<void> BatchMatmul::Apply(const BatchMatmulInterpState* ctx, const TensorTuple& out_grads,
