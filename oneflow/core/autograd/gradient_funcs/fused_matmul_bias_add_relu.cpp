...
Maybe<void> FusedMatmulBiasAddRelu::Capture(FusedMatmulBiasAddReluCaptureState* ctx, const TensorTuple& inputs,
    ...
    if (!ctx->requires_grad_a && !ctx->requires_grad_b && !ctx->requires_grad_bias) { return Maybe<void>::Ok(); }
...
Maybe<void> FusedMatmulBiasAddRelu::Apply(const FusedMatmulBiasAddReluCaptureState* ctx, const TensorTuple& out_grads,
