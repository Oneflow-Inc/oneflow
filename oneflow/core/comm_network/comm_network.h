...
public:
  ...
  void Read(void *actor_read_id, int64_t src_machine_id, void *src_token,
            void *dst_token);
...
private:
  ...
  void AddWorkToStream(void *actor_read_id, const std::function<void()> &cb,
                       bool is_read);
...
template <typename MemDescType> class CommNetIf : public CommNet {
public:
