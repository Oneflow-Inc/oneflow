...
private:
  int32_t GetColNumOfFeature(const Feature &, int64_t) const override {
    return 1;
  }
  ...
  void SetDim1ValidNum(const Feature &feature, Blob *out_blob,
                       int64_t dim0_idx) const override;
  void SetDim2ValidNum(const Feature &feature, Blob *out_blob,
                       int64_t dim0_idx) const override;
};
