...
public:
  ...
  virtual void
  DoPreprocess(cv::Mat *image, const ImagePreprocess &preprocess_conf,
...
template <PreprocessCase preprocess_case> class ImagePreprocessImpl;
...
template <>
class ImagePreprocessImpl<PreprocessCase::kCenterCrop> final
    : public ImagePreprocessIf {
public:
private:
  void DoPreprocess(cv::Mat *image, const ImagePreprocess &preprocess_conf,
...
template <>
class ImagePreprocessImpl<PreprocessCase::kCropWithRandomSize> final
    : public ImagePreprocessIf {
public:
private:
  void DoPreprocess(cv::Mat *image, const ImagePreprocess &preprocess_conf,
...
template <>
class ImagePreprocessImpl<PreprocessCase::kBgr2Rgb> final
    : public ImagePreprocessIf {
public:
private:
  void DoPreprocess(cv::Mat *image, const ImagePreprocess &preprocess_conf,
