...
inline const TensorData (&EnumValuesTensorData())[9] {
  static const TensorData values[] = {
    TensorData_NONE,
    TensorData_Int8List,
    TensorData_Int16List,
    TensorData_Int32List,
    TensorData_Int64List,
    TensorData_Float32List,
    TensorData_Float64List,
    TensorData_StringList,
    TensorData_BinaryList
  };
  return values;
}
...
bool VerifyTensorDataVector(flatbuffers::Verifier &verifier, const flatbuffers::Vector<flatbuffers::Offset<void>> *values, const flatbuffers::Vector<uint8_t> *types);
...
struct Int8ListBuilder {
  ...
  explicit Int8ListBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
...
inline flatbuffers::Offset<Int8List> CreateInt8ListDirect(
  ...
  return onerec::example::CreateInt8List(
      _fbb,
      values__);
}
...
struct Int16ListBuilder {
  ...
  explicit Int16ListBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<Int16List> CreateInt16ListDirect(
  ...
  return onerec::example::CreateInt16List(
      _fbb,
      values__);
}
...
inline flatbuffers::Offset<Int32List> CreateInt32ListDirect(
  ...
  return onerec::example::CreateInt32List(
      _fbb,
      values__);
}
...
struct Int64ListBuilder {
  ...
  explicit Int64ListBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<Int64List> CreateInt64ListDirect(
  ...
  return onerec::example::CreateInt64List(
      _fbb,
      values__);
}
...
struct Float32ListBuilder {
  ...
  explicit Float32ListBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<Float32List> CreateFloat32ListDirect(
  ...
  return onerec::example::CreateFloat32List(
      _fbb,
      values__);
}
...
struct Float64ListBuilder {
  ...
  explicit Float64ListBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<Float64List> CreateFloat64ListDirect(
  ...
  return onerec::example::CreateFloat64List(
      _fbb,
      values__);
}
...
inline flatbuffers::Offset<StringList> CreateStringListDirect(
  ...
  return onerec::example::CreateStringList(
      _fbb,
      values__);
}
...
inline flatbuffers::Offset<Binary> CreateBinaryDirect(
  ...
  return onerec::example::CreateBinary(
      _fbb,
      buffer__);
}
...
struct BinaryList FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<Binary>> *values() const {
    return GetPointer<const flatbuffers::Vector<flatbuffers::Offset<Binary>> *>(VT_VALUES);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyOffset(verifier, VT_VALUES) &&
...
struct BinaryListBuilder {
  flatbuffers::FlatBufferBuilder &fbb_;
  flatbuffers::uoffset_t start_;
  void add_values(flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Binary>>> values) {
    fbb_.AddOffset(BinaryList::VT_VALUES, values);
  }
  explicit BinaryListBuilder(flatbuffers::FlatBufferBuilder &_fbb)
        : fbb_(_fbb) {
    start_ = fbb_.StartTable();
  }
...
inline flatbuffers::Offset<BinaryList> CreateBinaryList(
    flatbuffers::FlatBufferBuilder &_fbb,
    flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Binary>>> values = 0) {
...
inline flatbuffers::Offset<BinaryList> CreateBinaryListDirect(
    flatbuffers::FlatBufferBuilder &_fbb,
    const std::vector<flatbuffers::Offset<Binary>> *values = nullptr) {
  auto values__ = values ? _fbb.CreateVector<flatbuffers::Offset<Binary>>(*values) : 0;
  return onerec::example::CreateBinaryList(
      _fbb,
      values__);
}
...
struct Tensor FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  TensorData data_type() const {
    return static_cast<TensorData>(GetField<uint8_t>(VT_DATA_TYPE, 0));
  }
  const void *data() const {
    return GetPointer<const void *>(VT_DATA);
  }
  template<typename T> const T *data_as() const;
  const Int8List *data_as_Int8List() const {
    return data_type() == TensorData_Int8List ? static_cast<const Int8List *>(data()) : nullptr;
  }
  const Int16List *data_as_Int16List() const {
    return data_type() == TensorData_Int16List ? static_cast<const Int16List *>(data()) : nullptr;
  }
  const Int32List *data_as_Int32List() const {
    return data_type() == TensorData_Int32List ? static_cast<const Int32List *>(data()) : nullptr;
  }
  const Int64List *data_as_Int64List() const {
    return data_type() == TensorData_Int64List ? static_cast<const Int64List *>(data()) : nullptr;
  }
  const Float32List *data_as_Float32List() const {
    return data_type() == TensorData_Float32List ? static_cast<const Float32List *>(data()) : nullptr;
  }
  const Float64List *data_as_Float64List() const {
    return data_type() == TensorData_Float64List ? static_cast<const Float64List *>(data()) : nullptr;
  }
  const StringList *data_as_StringList() const {
    return data_type() == TensorData_StringList ? static_cast<const StringList *>(data()) : nullptr;
  }
  const BinaryList *data_as_BinaryList() const {
    return data_type() == TensorData_BinaryList ? static_cast<const BinaryList *>(data()) : nullptr;
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyTensorData(verifier, data(), data_type()) &&
           verifier.EndTable();
  }
};

template<> inline const Int8List *Tensor::data_as<Int8List>() const {
  return data_as_Int8List();
}

template<> inline const Int16List *Tensor::data_as<Int16List>() const {
  return data_as_Int16List();
}

template<> inline const Int32List *Tensor::data_as<Int32List>() const {
  return data_as_Int32List();
}

template<> inline const Int64List *Tensor::data_as<Int64List>() const {
  return data_as_Int64List();
}

template<> inline const Float32List *Tensor::data_as<Float32List>() const {
  return data_as_Float32List();
}

template<> inline const Float64List *Tensor::data_as<Float64List>() const {
  return data_as_Float64List();
}

template<> inline const StringList *Tensor::data_as<StringList>() const {
  return data_as_StringList();
}

template<> inline const BinaryList *Tensor::data_as<BinaryList>() const {
...
struct TensorBuilder {
  ...
  void add_data_type(TensorData data_type) {
...
inline flatbuffers::Offset<Tensor> CreateTensor(
    ...
    TensorData data_type = TensorData_NONE,
...
inline flatbuffers::Offset<Tensor> CreateTensorDirect(
  ...
  return onerec::example::CreateTensor(
      _fbb,
      shape__,
      data_type,
      data);
...
struct Feature FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const Tensor *tensor() const {
    return GetPointer<const Tensor *>(VT_TENSOR);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
inline flatbuffers::Offset<Feature> CreateFeatureDirect(
  ...
  return onerec::example::CreateFeature(
      _fbb,
      name__,
      tensor);
}
...
inline flatbuffers::Offset<Example> CreateExampleDirect(
  ...
  return onerec::example::CreateExample(
      _fbb,
      features__);
}
...
inline bool VerifyTensorData(flatbuffers::Verifier &verifier, const void *obj, TensorData type) {
  switch (type) {
    ...
    case TensorData_Int8List: {
      auto ptr = reinterpret_cast<const Int8List *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case TensorData_Int16List: {
      auto ptr = reinterpret_cast<const Int16List *>(obj);
      return verifier.VerifyTable(ptr);
    }
    ...
    case TensorData_Int64List: {
      auto ptr = reinterpret_cast<const Int64List *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case TensorData_Float32List: {
      auto ptr = reinterpret_cast<const Float32List *>(obj);
      return verifier.VerifyTable(ptr);
    }
    case TensorData_Float64List: {
      auto ptr = reinterpret_cast<const Float64List *>(obj);
      return verifier.VerifyTable(ptr);
    }
    ...
    case TensorData_BinaryList: {
      auto ptr = reinterpret_cast<const BinaryList *>(obj);
      return verifier.VerifyTable(ptr);
    }
...
inline bool VerifyTensorDataVector(flatbuffers::Verifier &verifier, const flatbuffers::Vector<flatbuffers::Offset<void>> *values, const flatbuffers::Vector<uint8_t> *types) {
  if (!values || !types) return !values && !types;
  if (values->size() != types->size()) return false;
  for (flatbuffers::uoffset_t i = 0; i < values->size(); ++i) {
    if (!VerifyTensorData(
        verifier,  values->Get(i), types->GetEnum<TensorData>(i))) {
      return false;
    }
  }
  return true;
