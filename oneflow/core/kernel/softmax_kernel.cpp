...
//  KernelUtil<device_type, FloatingPointType>::BlasCopy(ctx, n * w, out_diff,
//  1,
//                                                       in_diff, 1);
//  // dot product | get dot product tmp[i] from out[i] * out_diff[i]
//  SoftmaxKernelUtil<device_type, FloatingPointType>::BackwardDot(ctx, n, w,
//  out,
//                                                                 out_diff,
//                                                                 tmp);
...
//
//  static void ForwardMax(const KernelCtx& ctx, const int64_t n, const int64_t
//  w,
//                         const FloatingPointType* out, FloatingPointType* tmp)
//                         {
//    for (int64_t i = 0; i < n; ++i) {
//      KernelUtil<DeviceType::kCPU, FloatingPointType>::Max(ctx, w, out + i *
//      w,
//                                                           tmp + i);
//    }
//  }
//
//  static void ForwardSum(const KernelCtx& ctx, const int64_t n, const int64_t
//  w,
//                         const FloatingPointType* out, FloatingPointType* tmp)
//                         {
//    for (int64_t i = 0; i < n; ++i) {
//      KernelUtil<DeviceType::kCPU, FloatingPointType>::Sum(ctx, w, out + i *
//      w,
//                                                           tmp + i);
//    }
//  }
