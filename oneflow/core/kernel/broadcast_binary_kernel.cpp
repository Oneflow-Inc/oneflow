...
struct BroadcastBinaryKernelHelper<DeviceType::kCPU, T, NDIMS, binary_func> final {
...
#define INSTANTIATE_BROADCAST_BINARY_FUNC(dtype_pair, NDIMS, binary_func)                     \
  template struct BroadcastBinaryKernelHelper<DeviceType::kCPU, OF_PP_PAIR_FIRST(dtype_pair), \
                                              NDIMS, binary_func>;
