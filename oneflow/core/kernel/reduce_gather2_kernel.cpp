#include "oneflow/core/kernel/reduce_gather2_kernel.h"

namespace oneflow {

template<DeviceType device_type>
void ReduceGather2Kernel<device_type>::ForwardDataContent(
  ...
  dst_cur_dptr += this->kernel_conf().reduce_gather2_conf().data_offset().Get(in_bn_id);
...
ADD_DEVICE_TYPE_KERNEL_CREATOR(OperatorConf::kReduceGather2Conf, ReduceGather2Kernel);
