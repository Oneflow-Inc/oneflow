...
template<typename T>
void Gemm(DeviceCtx* ctx, const bool is_tf32, const enum CBLAS_ORDER order, enum CBLAS_TRANSPOSE trans_a,
...
template<typename T>
void BlobGemmImpl(DeviceCtx* ctx, const bool is_tf32, enum CBLAS_TRANSPOSE trans_a, enum CBLAS_TRANSPOSE trans_b,
...
void BlasIf<DeviceType::kGPU>::BlobGemm(DeviceCtx* ctx, const bool is_tf32, enum CBLAS_TRANSPOSE trans_a,
...
void BlasIf<DeviceType::kGPU>::OFGemm(DeviceCtx* ctx, const bool is_tf32, enum CBLAS_TRANSPOSE trans_a,
...
void BlasIf<DeviceType::kGPU>::OFGemm(DeviceCtx* ctx, const bool is_tf32, enum CBLAS_TRANSPOSE trans_a,
  ...
  Gemm<half>(ctx, is_tf32, CblasRowMajor, trans_a, trans_b, m, n, k, reinterpret_cast<const half*>(&alpha),
