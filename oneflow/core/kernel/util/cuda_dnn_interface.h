...
template <> struct DnnIf<DeviceType::kGPU> {
  ...
  static void Relu(DeviceCtx *ctx, const int64_t n, const float16 *x,
                   float16 *y);
  static void ReluBackward(DeviceCtx *ctx, const int64_t n, const float *x,
                           const float *y, const float *dy, float *dx);
  static void ReluBackward(DeviceCtx *ctx, const int64_t n, const double *x,
                           const double *y, const double *dy, double *dx);
  static void ReluBackward(DeviceCtx *ctx, const int64_t n, const float16 *x,
  ...
  static void SigmoidBackward(DeviceCtx *ctx, const int64_t n, const float *x,
                              const float *y, const float *dy, float *dx);
  static void SigmoidBackward(DeviceCtx *ctx, const int64_t n, const double *x,
                              const double *y, const double *dy, double *dx);
  static void SigmoidBackward(DeviceCtx *ctx, const int64_t n, const float16 *x,
                              const float16 *y, const float16 *dy, float16 *dx);
  ...
  static void TanHBackward(DeviceCtx *ctx, const int64_t n, const float *x,
                           const float *y, const float *dy, float *dx);
  static void TanHBackward(DeviceCtx *ctx, const int64_t n, const double *x,
                           const double *y, const double *dy, double *dx);
  static void TanHBackward(DeviceCtx *ctx, const int64_t n, const float16 *x,
                           const float16 *y, const float16 *dy, float16 *dx);
};
