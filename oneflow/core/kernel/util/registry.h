...
/**
 * ONEFLOW_DECLARE_TYPED_REGISTRY is a macro that expands to a function
 * declaration, as well as creating a convenient typename for its corresponding
 * registerer.
 */
// Note on ONEFLOW_IMPORT and ONEFLOW_EXPORT below: we need to explicitly mark DECLARE
...
#define ONEFLOW_REGISTER_TYPED_CREATOR(RegistryName, key, ...)                  \
...
#define ONEFLOW_REGISTER_CREATOR(RegistryName, key, ...) \
