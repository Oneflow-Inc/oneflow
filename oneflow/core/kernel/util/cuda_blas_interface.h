...
struct BlasIf<DeviceType::kGPU> {
  static void BlobGemm(DeviceCtx* ctx, const bool is_tf32, enum CBLAS_TRANSPOSE trans_a,
                       enum CBLAS_TRANSPOSE trans_b, float alpha, float beta, const Blob* a,
                       const Blob* b, Blob* c);
  static void BlobGemm(DeviceCtx* ctx, const bool is_tf32, enum CBLAS_TRANSPOSE trans_a,
                       enum CBLAS_TRANSPOSE trans_b, double alpha, double beta, const Blob* a,
                       const Blob* b, Blob* c);
  static void BlobGemm(DeviceCtx* ctx, const bool is_tf32, enum CBLAS_TRANSPOSE trans_a,
                       enum CBLAS_TRANSPOSE trans_b, float16 alpha, float16 beta, const Blob* a,
                       const Blob* b, Blob* c);
