...
template <> struct BlasIf<DeviceType::kGPU> {
  ...
  static void BlobGemm(DeviceCtx *ctx, enum CBLAS_TRANSPOSE trans_a,
                       ...
                       const Blob *a, const Blob *b, Blob *c);
  static void BlobGemm(DeviceCtx *ctx, enum CBLAS_TRANSPOSE trans_a,
                       enum CBLAS_TRANSPOSE trans_b, float16 alpha,
                       float16 beta, const Blob *a, const Blob *b, Blob *c);
  ...
  static void OFBatchedGemm(DeviceCtx *ctx, enum CBLAS_TRANSPOSE trans_a,
                            ...
                            float16 **buf);
  static void
  OFBatchedHGemmWithFloat(DeviceCtx *ctx, enum CBLAS_TRANSPOSE trans_a,
                          enum CBLAS_TRANSPOSE trans_b, const int batch_size,
                          const int m, const int n, const int k,
                          const float alpha, const float16 *a, const float16 *b,
                          const float beta, float16 *c, float16 **buf);
  ...
  static void Axpy(DeviceCtx *ctx, const int n, const float16 alpha,
                   const float16 *x, const int incx, float16 *y,
                   const int incy);
};
