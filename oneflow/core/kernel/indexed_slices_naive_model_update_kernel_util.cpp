...
void IndexedSlicesNaiveMdUpdateKernelUtil<DeviceType::kCPU, T, K>::Update(
    DeviceCtx *ctx, const K *indices, const T *values,
    const float *learning_rate, int64_t num_indices, int64_t num_features,
    int64_t feature_size, int64_t feature_id_offset, T *model) {
