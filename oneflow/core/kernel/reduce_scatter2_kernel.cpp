#include "oneflow/core/kernel/reduce_scatter2_kernel.h"

namespace oneflow {

template<DeviceType device_type>
void ReduceScatter2Kernel<device_type>::ForwardDataContent(
...
ADD_DEVICE_TYPE_KERNEL_CREATOR(OperatorConf::kReduceScatter2Conf, ReduceScatter2Kernel);
