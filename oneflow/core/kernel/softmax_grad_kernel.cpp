...
REGISTER_KERNEL_HELPER_GPU_FLOATING(OperatorConf::kSoftmaxGradConf, SoftmaxGradKernel);
REGISTER_KERNEL_HELPER_GPU_HALF(OperatorConf::kSoftmaxGradConf, SoftmaxGradKernel);
