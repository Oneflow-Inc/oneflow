...
//  // forward
//  SoftmaxComputeProb<device_type, FloatingPointType>(ctx, n, w, in, tmp,
//  prob); SoftmaxLossKernelUtil<device_type, FloatingPointType>::ComputeLoss(
...
//                          const FloatingPointType* prob, FloatingPointType*
//                          tmp, FloatingPointType* loss) {
