...
//                               FloatingPointType* out_dptr, uint32_t*
//                               mask_dptr, const int64_t channels, const
//                               int64_t height, const int64_t width, const
//                               int64_t pooled_height, const int64_t
//                               pooled_width, const int64_t kernel_h, const
//                               int64_t kernel_w, const int64_t stride_h, const
//                               int64_t stride_w, const int64_t pad_h, const
//                               int64_t pad_w) {
...
//                               const int64_t width, const int64_t
//                               pooled_height, const int64_t pooled_width,
...
//    const int64_t pooled_width, const int64_t kernel_h, const int64_t
//    kernel_w, const int64_t stride_h, const int64_t stride_w, const int64_t
//    pad_h, const int64_t pad_w) {
//  CUDA_1D_KERNEL_LOOP(index, nthreads) {
...
//    const int64_t phend =
//        (h / stride_h + 1 < pooled_height) ? (h / stride_h + 1) :
//        pooled_height;
//    const int64_t pwend =
...
//                           ? (hstart + kernel_h)
//                           : (height + pad_h);
//        int64_t wend = (wstart + kernel_w < width + pad_w) ? (wstart +
//        kernel_w)
//                                                           : (width + pad_w);
