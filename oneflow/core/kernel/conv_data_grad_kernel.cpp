...
REGISTER_KERNEL_HELPER_GPU_FLOATING(OperatorConf::kConvDataGradConf, ConvDataGradKernel);
REGISTER_KERNEL_HELPER_GPU_HALF(OperatorConf::kConvDataGradConf, ConvDataGradKernel);
