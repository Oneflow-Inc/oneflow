#include "oneflow/core/kernel/broadcast_less_kernel.h"
...
void BroadcastLessKernel<device_type, T>::ForwardDataContent(
  ...
  NdarrayUtil<device_type, T>::template BroadcastApply<BinaryFuncLess>(
...
ADD_DEFAULT_KERNEL_CREATOR(OperatorConf::kBroadcastLessConf, BroadcastLessKernel,
