...
class IndexedSlicesLazyAdamMdUpdateKernel final : public KernelIf<device_type> {
 ...
 private:
  ...
  using AdamMdUpdateUtilT = IndexedSlicesLazyAdamMdUpdateKernelUtil<device_type, T, K, int32_t>;
...
void IndexedSlicesLazyAdamMdUpdateKernel<device_type, T, K>::ForwardDataContent(
  ...
  AdamMdUpdateUtilT::ComputeLocalLearningRate(ctx.device_ctx, beta1, beta2, train_step_ptr,
                                              learning_rate_ptr, local_learning_rate_ptr);
  AdamMdUpdateUtilT::Update(ctx.device_ctx, beta1, beta2, epsilon, num_indices, feature_size,
