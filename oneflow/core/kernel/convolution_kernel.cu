...
//    const int width, const int channels, const int kernel_h, const int
//    kernel_w, const int pad_h, const int pad_w, const int stride_h, const int
//    stride_w, const int dilation_h, const int dilation_w, const int
//    height_col, const int width_col, FloatingPointType* data_im) {
//  CUDA_1D_KERNEL_LOOP(index, n) {
...
//            dilation_w, height_col, width_col, data_im);
//  }
//};
//
