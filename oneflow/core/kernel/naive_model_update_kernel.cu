...
template <typename T>
__global__ void UpdateModelGpu(const int64_t n, const float *learning_rate,
...
template <typename T> class NaiveMdUpdateKernelUtil<DeviceType::kGPU, T> final {
public:
  static void UpdateModel(DeviceCtx *ctx, const int64_t n,
