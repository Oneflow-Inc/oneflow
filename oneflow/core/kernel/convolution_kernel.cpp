...
//        weight->dptr<FloatingPointType>(), weight->shape().At(1),
...
//          static_cast<FloatingPointType>(1.0),
//          bias->dptr<FloatingPointType>(), 1,
//          bias_multiplier->dptr<FloatingPointType>(),
...
//        weight_diff->mut_dptr<FloatingPointType>(),
...
//        weight->shape().At(1), static_cast<FloatingPointType>(0.0),
//        col_buf->mut_dptr<FloatingPointType>() + i *
//        col_buf->shape().Count(1), col_buf->shape().At(2));
//  }
//
...
//        ctx, col_buf->dptr<FloatingPointType>() + i *
//        col_buf->shape().Count(1), in_diff_shape.At(1), in_diff_shape.At(2),
//        in_diff_shape.At(3), conv_conf.kernel_size_h(),
//        conv_conf.kernel_size_w(), conv_conf.pad_h(), conv_conf.pad_w(),
//        conv_conf.stride_h(), conv_conf.stride_w(), conv_conf.dilation_h(),
//        conv_conf.dilation_w(), in_diff->mut_dptr<FloatingPointType>() + i *
//        in_diff_shape.Count(1));
//  }
//}
//
// template<DeviceType device_type, typename FloatingPointType>
