...
class ReentrantLockStatus final {
 public:
  ...
  size_t queued_request_lock_num() const { return queued_request_lock_num_; }
  size_t acquired_lock_num() const { return acquired_lock_num_; }
 ...
 private:
  ...
  size_t queued_request_lock_num_;
  size_t acquired_lock_num_;
