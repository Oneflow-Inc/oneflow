...
*/
#ifndef ONEFLOW_CORE_KERNEL_CUDA_CHECK_NUMBERICS_KERNEL_OBSERVER_H_
#define ONEFLOW_CORE_KERNEL_CUDA_CHECK_NUMBERICS_KERNEL_OBSERVER_H_
...
#endif  // ONEFLOW_CORE_KERNEL_CUDA_CHECK_NUMBERICS_KERNEL_OBSERVER_H_
