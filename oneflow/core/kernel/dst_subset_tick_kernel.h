...
*/
#ifndef ONEFLOW_CORE_KERNEL_DST_SOURCE_TICK_KERNEL_H_
#define ONEFLOW_CORE_KERNEL_DST_SOURCE_TICK_KERNEL_H_
...
#endif  // ONEFLOW_CORE_KERNEL_DST_SOURCE_TICK_KERNEL_H_
