...
private:
  ...
  void ForwardDataContent(
    ...
    const auto GetSnapshotReader =
        [&](const std::string &path) -> SnapshotReader * {
    ...
    const auto InitializeWithSnapshot = [&](
        const std::string &snapshot_path, const std::string &key, Blob *blob) {
