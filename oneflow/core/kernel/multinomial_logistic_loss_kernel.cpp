...
//    MultinomialLogisticLossKernelUtil<device_type,
//    FloatingPointType>::Backward(
//        ctx, prediction->shape().At(0), prediction->shape().At(1),
...
//                      const FloatingPointType* labels, FloatingPointType*
//                      loss, FloatingPointType* loss_buff) {
