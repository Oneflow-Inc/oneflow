#include "oneflow/core/kernel/broadcast_not_equal_kernel.h"
...
void BroadcastNotEqualKernel<device_type, T>::ForwardDataContent(
  ...
  NdarrayUtil<device_type, T>::template BroadcastApply<BinaryFuncNotEqual>(
...
ADD_DEFAULT_KERNEL_CREATOR(OperatorConf::kBroadcastNotEqualConf, BroadcastNotEqualKernel,
