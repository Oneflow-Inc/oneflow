...
std::function<Blob*(const std::string&)> BuildBnInOp2BlobPtr() {
  ...
  // FloatingPointType expected_in_diff_mat[8] = {-8.0, 0, 0, 5.0, 0, 3.0, 0,
  // 1.0};  auto bn2blob_ptr = new HashMap<std::string, Blob*>;
...
void TestPoolingKernel() {
  ...
  // auto BnInOp2BlobPtr = BuildBnInOp2BlobPtr<device_type,
  // FloatingPointType>();  auto relu_kernel = BuildReluKernel<device_type,
  // FloatingPointType>();  relu_kernel->Forward(ctx, BnInOp2BlobPtr);
