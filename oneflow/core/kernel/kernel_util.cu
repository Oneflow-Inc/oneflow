...
template<typename T>
__global__ void gpu_add1(const int64_t n, T* out, const T* in_0) {
  CUDA_1D_KERNEL_LOOP(i, n) { out[i] = in_0[i]; }
}
template<typename T>
__global__ void gpu_add2(const int64_t n, T* out, const T* in_0, const T* in_1) {
  CUDA_1D_KERNEL_LOOP(i, n) { out[i] = in_0[i] + in_1[i]; }
}

template<typename T>
__global__ void gpu_add3(const int64_t n, T* out, const T* in_0, const T* in_1, const T* in_2) {
  CUDA_1D_KERNEL_LOOP(i, n) { out[i] = in_0[i] + in_1[i] + in_2[i]; }
}

template<typename T>
__global__ void gpu_add4(const int64_t n, T* out, const T* in_0, const T* in_1, const T* in_2,
                         const T* in_3) {
  CUDA_1D_KERNEL_LOOP(i, n) { out[i] = in_0[i] + in_1[i] + in_2[i] + in_3[i]; }
}

template<typename T>
__global__ void gpu_add5(const int64_t n, T* out, const T* in_0, const T* in_1, const T* in_2,
                         const T* in_3, const T* in_4) {
  CUDA_1D_KERNEL_LOOP(i, n) { out[i] = in_0[i] + in_1[i] + in_2[i] + in_3[i] + in_4[i]; }
}

template<typename T>
__global__ void gpu_add6(const int64_t n, T* out, const T* in_0, const T* in_1, const T* in_2,
                         const T* in_3, const T* in_4, const T* in_5) {
  CUDA_1D_KERNEL_LOOP(i, n) { out[i] = in_0[i] + in_1[i] + in_2[i] + in_3[i] + in_4[i] + in_5[i]; }
}

template<typename T>
__global__ void gpu_add7(const int64_t n, T* out, const T* in_0, const T* in_1, const T* in_2,
...
template<typename T>
__global__ void gpu_add8(const int64_t n, T* out, const T* in_0, const T* in_1, const T* in_2,
                         const T* in_3, const T* in_4, const T* in_5, const T* in_6,
                         const T* in_7) {
  CUDA_1D_KERNEL_LOOP(i, n) {
...
template<typename T>
__global__ void gpu_add9(const int64_t n, T* out, const T* in_0, const T* in_1, const T* in_2,
...
template<typename T>
__global__ void gpu_add10(const int64_t n, T* out, const T* in_0, const T* in_1, const T* in_2,
                          const T* in_3, const T* in_4, const T* in_5, const T* in_6, const T* in_7,
                          const T* in_8, const T* in_9) {
  CUDA_1D_KERNEL_LOOP(i, n) {
...
KU_FLOATING_METHOD Add2(DeviceCtx* ctx, const int64_t n, T* out, const T* in_0, const T* in_1) {
  gpu_add2<T><<<BlocksNum4ThreadsNum(n), kCudaThreadsNumPerBlock, 0, ctx->cuda_stream()>>>(
      n, out, in_0, in_1);
}

KU_FLOATING_METHOD Add3(DeviceCtx* ctx, const int64_t n, T* out, const T* in_0, const T* in_1,
                        const T* in_2) {
  gpu_add3<T><<<BlocksNum4ThreadsNum(n), kCudaThreadsNumPerBlock, 0, ctx->cuda_stream()>>>(
...
KU_FLOATING_METHOD Add4(DeviceCtx* ctx, const int64_t n, T* out, const T* in_0, const T* in_1,
  ...
  gpu_add4<T><<<BlocksNum4ThreadsNum(n), kCudaThreadsNumPerBlock, 0, ctx->cuda_stream()>>>(
...
KU_FLOATING_METHOD Add5(DeviceCtx* ctx, const int64_t n, T* out, const T* in_0, const T* in_1,
  ...
  gpu_add5<T><<<BlocksNum4ThreadsNum(n), kCudaThreadsNumPerBlock, 0, ctx->cuda_stream()>>>(
...
KU_FLOATING_METHOD Add6(DeviceCtx* ctx, const int64_t n, T* out, const T* in_0, const T* in_1,
  ...
  gpu_add6<T><<<BlocksNum4ThreadsNum(n), kCudaThreadsNumPerBlock, 0, ctx->cuda_stream()>>>(
...
KU_FLOATING_METHOD Add7(DeviceCtx* ctx, const int64_t n, T* out, const T* in_0, const T* in_1,
  ...
  gpu_add7<T><<<BlocksNum4ThreadsNum(n), kCudaThreadsNumPerBlock, 0, ctx->cuda_stream()>>>(
...
KU_FLOATING_METHOD Add8(DeviceCtx* ctx, const int64_t n, T* out, const T* in_0, const T* in_1,
                        const T* in_2, const T* in_3, const T* in_4, const T* in_5, const T* in_6,
                        const T* in_7) {
  gpu_add8<T><<<BlocksNum4ThreadsNum(n), kCudaThreadsNumPerBlock, 0, ctx->cuda_stream()>>>(
...
KU_FLOATING_METHOD Add9(DeviceCtx* ctx, const int64_t n, T* out, const T* in_0, const T* in_1,
  ...
  gpu_add9<T><<<BlocksNum4ThreadsNum(n), kCudaThreadsNumPerBlock, 0, ctx->cuda_stream()>>>(
...
KU_FLOATING_METHOD Add10(DeviceCtx* ctx, const int64_t n, T* out, const T* in_0, const T* in_1,
  ...
  gpu_add10<T><<<BlocksNum4ThreadsNum(n), kCudaThreadsNumPerBlock, 0, ctx->cuda_stream()>>>(
