...
std::function<Blob*(const std::string&)> BuildBnInOp2BlobPtr() {
  ...
  FloatingPointType in_mat[8] = {1.0, -1.0, -2.0, 2.0, 0.0, 0.5, -10.0, 100.0};
  FloatingPointType out_diff_mat[8] = {-8.0, 7.0, -6.0, 5.0,
                                       -4.0, 3.0, -2.0, 1.0};
  ...
  FloatingPointType expected_in_diff_mat[8] = {-8.0, 0, 0, 5.0, 0, 3.0, 0, 1.0};
