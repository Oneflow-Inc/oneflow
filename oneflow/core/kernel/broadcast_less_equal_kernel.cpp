#include "oneflow/core/kernel/broadcast_less_equal_kernel.h"
...
void BroadcastLessEqualKernel<device_type, T>::ForwardDataContent(
  ...
  NdarrayUtil<device_type, T>::template BroadcastApply<BinaryFuncLessEqual>(
...
ADD_DEFAULT_KERNEL_CREATOR(OperatorConf::kBroadcastLessEqualConf, BroadcastLessEqualKernel,
