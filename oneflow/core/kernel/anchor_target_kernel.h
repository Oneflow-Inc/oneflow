...
public:
  ...
  AnchorLabelsAndMaxOverlapsInfo(int32_t* anchor_labels_ptr, float* max_overlaps_ptr, 
                                int32_t* max_overlap_gt_boxes_index_ptr, 
  ...
  void 0(int32_t anchor_idx, int32_t gt_box_idx, float overlap) {
  ...
  float* GetNearstGtBoxes() { return max_overlap_gt_boxes_idx_ptr_; }
private:
