...
template<DeviceType device_type, typename T>
void ConvTestCase2(OpKernelTestCase* conv_test_case,
                   const std::string& job_type,
                   const std::string& forward_or_backward) {
  conv_test_case->InitJobConf([](JobConf* job_conf) {
    job_conf->set_default_data_type(GetDataType<T>::value);
...
template<DeviceType device_type, typename T>
void ConvTestCase3(OpKernelTestCase* conv_test_case,
                   const std::string& job_type,
                   const std::string& forward_or_backward) {
  conv_test_case->InitJobConf([](JobConf* job_conf) {
    job_conf->set_default_data_type(GetDataType<T>::value);
...
template<DeviceType device_type, typename T>
void ConvTestCase4(OpKernelTestCase* conv_test_case,
                   const std::string& job_type,
                   const std::string& forward_or_backward) {
  conv_test_case->InitJobConf([](JobConf* job_conf) {
    job_conf->set_default_data_type(GetDataType<T>::value);
...
template<DeviceType device_type, typename T>
void ConvTestCase5(OpKernelTestCase* conv_test_case,
                   const std::string& job_type,
                   const std::string& forward_or_backward) {
  conv_test_case->InitJobConf([](JobConf* job_conf) {
    job_conf->set_default_data_type(GetDataType<T>::value);
...
template<DeviceType device_type, typename T>
void ConvTestCase6(OpKernelTestCase* conv_test_case,
                   const std::string& job_type,
                   const std::string& forward_or_backward) {
  conv_test_case->InitJobConf([](JobConf* job_conf) {
    job_conf->set_default_data_type(GetDataType<T>::value);
...
TEST_CPU_ONLY_OPKERNEL(ConvTestCase6, FLOATING_DATA_TYPE_SEQ, (train),
                       (forward)(backward));
