...
template<typename T>
void AveragePoolingKernel<DeviceType::kCPU, T>::NCDHWProcess(const T& lhs,
                                                             T& rhs) const {
  rhs += lhs;
}
...
template<typename T>
void AveragePoolingKernel<DeviceType::kCPU, T>::NCDHWFinalize(
...
template<typename T>
void AveragePoolingKernel<DeviceType::kCPU, T>::NCDHWProcessGrad(
