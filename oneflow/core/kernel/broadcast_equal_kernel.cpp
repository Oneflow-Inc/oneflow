#include "oneflow/core/kernel/broadcast_equal_kernel.h"
...
void BroadcastEqualKernel<device_type, T>::ForwardDataContent(
  ...
  NdarrayUtil<device_type, T>::template BroadcastApply<BinaryFuncEqual>(
...
ADD_DEFAULT_KERNEL_CREATOR(OperatorConf::kBroadcastEqualConf, BroadcastEqualKernel,
