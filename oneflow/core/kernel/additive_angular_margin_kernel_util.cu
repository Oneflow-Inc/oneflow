...
__global__ void AdditiveAngularMarginForwardGpu(const int64_t batch_num, const T* in,
                                                const K* label, const int64_t labels_num,
...
template<typename T, typename K>
__global__ void AdditiveAngularMarginBackwardGpu(const int64_t batch_num, const T* out_diff,
                                                 const K* label, const int64_t labels_num,
                                                 const int64_t lower_bound, const T cos_m,
