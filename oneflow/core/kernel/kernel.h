...
class Kernel {
 ...
 protected:
  ...
  ActivationType GetActivationType() const { return kernel_conf().activation(); }
  ...
  virtual void BackwardActivation(const KernelCtx& ctx, const Blob* in_blob,
...
class KernelIf : public Kernel {
 ...
 protected:
  ...
  void BackwardActivation(const KernelCtx& ctx, const Blob* in_blob,
