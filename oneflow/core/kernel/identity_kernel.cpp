...
void IdentityKernel<device_type>::ForwardDataContent(
  ...
  BnInOp2Blob("out")->CopyValidDataContentFrom(ctx.device_ctx,
                                               BnInOp2Blob("in"));
}
...
ADD_DEVICE_TYPE_KERNEL_CREATOR(OperatorConf::kCastToMirroredConf,
                               IdentityKernel);
ADD_DEVICE_TYPE_KERNEL_CREATOR(OperatorConf::kCastFromMirroredConf,
                               IdentityKernel);
ADD_DEVICE_TYPE_KERNEL_CREATOR(OperatorConf::kBoxingIdentityConf,
                               IdentityKernel);
