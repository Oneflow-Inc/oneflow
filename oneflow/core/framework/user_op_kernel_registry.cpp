...
// HashMap<std::string, std::vector<OpKernelRegistryResult>>* MutKernelRegistry() {
//   static HashMap<std::string, std::vector<OpKernelRegistryResult>> registry;
//   return &registry;
// }
...
OpKernelRegistry::OpKernelRegistry(const std::string& op_type_name) {
...
KernelRegistryWrapper OpKernelRegistry::Build() {
