...
Maybe<T> GetItemInScalarTensor(const std::shared_ptr<Tensor>& scalar_tensor) {
  ...
  if (std::is_same<T, int64_t>::value) {
    if (scalar_tensor->dtype()->data_type() == DataType::kInt8
      ...
      scalar = static_cast<int64_t>(int8_integer);
      ...
      scalar = static_cast<int64_t>(int16_integer);
      ...
      scalar = static_cast<int64_t>(int32_integer);
      ...
      scalar = static_cast<int64_t>(int64_integer);
    }
  } else {
