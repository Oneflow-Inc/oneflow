...
class Tensor {
 public:
  ...
  virtual Maybe<Symbol<cfg::NdSbp>> parallel_distribution() const = 0;
...
class StaticZerosTensor final : public Tensor {
 public:
  ...
  Maybe<Symbol<cfg::NdSbp>> parallel_distribution() const { OF_UNIMPLEMENTED(); }
  ...
  Maybe<void> set_consumer_parallel_distribution_constraint(Symbol<cfg::NdSbp> val) {
    OF_UNIMPLEMENTED();
  }
...
class Parameter final : public TensorIf<Parameter> {
 public:
  ...
  Maybe<Symbol<cfg::NdSbp>> parallel_distribution() const override {
