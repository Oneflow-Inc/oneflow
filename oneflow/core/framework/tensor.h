...
class Tensor {
 public:
  ...
  // Getters
  virtual Maybe<const Shape> shape() const = 0;
  virtual Maybe<const DType> dtype() const = 0;
  ...
  virtual Maybe<bool> is_leaf() const = 0;
  virtual Maybe<bool> retain_grad() const = 0;
...
class FascadeTensor final : public Tensor {
 public:
  ...
  Maybe<const DType> dtype() const override { return tensor_->dtype(); }
  Maybe<const ParallelDesc> parallel_desc() const override { return tensor_->parallel_desc(); }
  Maybe<const Device> device() const override { return tensor_->device(); }
  Maybe<bool> is_consistent() const override { return tensor_->is_consistent(); }
  Maybe<bool> is_lazy() const override { return tensor_->is_lazy(); }
...
class UndeterminedTensor final : public Tensor {
 public:
  ...
  Maybe<const DType> dtype() const override { return dtype_; }
  ...
  // Getters for autograd
  Maybe<bool> is_leaf() const override { return is_leaf_; }
  Maybe<bool> requires_grad() const override { return requires_grad_; }
  Maybe<bool> retain_grad() const override { return retain_grad_; }
...
class DeterminedTensor : public Tensor, public std::enable_shared_from_this<DeterminedTensor> {
 public:
  ...
  // Getters
  virtual Maybe<int64_t> ndim() const = 0;
  ...
  Maybe<const FunctionNode> grad_fn_node() const { return grad_fn_node_; }
  ...
  virtual Maybe<compatible_py::BlobObject> blob_object() const = 0;
...
class MirroredTensor final : public DeterminedTensor {
 public:
  ...
  // Getters
  Maybe<const Shape> shape() const override { return impl_->shape(); }
  Maybe<const DType> dtype() const override { return impl_->dtype(); }
  ...
  Maybe<bool> is_lazy() const override { return impl_->is_lazy(); }
  Maybe<bool> is_consistent() const override { return false; }
  Maybe<int64_t> ndim() const override;
  Maybe<bool> is_cuda() const override;
  Maybe<int64_t> dim(int64_t index) const override;
  Maybe<int64_t> nelement() const override;
  ...
  Maybe<bool> requires_grad() const override { return impl_->requires_grad(); }
  Maybe<bool> is_leaf() const override { return impl_->is_leaf(); }
  Maybe<bool> retain_grad() const override { return impl_->retain_grad(); }
  ...
  // Getters to be deprecated
  Maybe<compatible_py::BlobObject> blob_object() const override { return impl_->blob_object(); }
...
class ConsistentTensor final : public DeterminedTensor {
 public:
  ...
  Maybe<const compatible_py::Distribute> distribute() const { return impl_->distribute(); }
  Maybe<bool> is_lazy() const override { return impl_->is_lazy(); }
