...
*/
const int DType::priority_order[DataType_MAX + 1] = {0,  /*kInvalid*/
                                                     3,  /*kChar*/
                                                     13, /*kFloat32*/
                                                     14, /*kDouble*/
                                                     4,  /*kInt8*/
...
Symbol<DType> promoteTypes(const Symbol<DType> a, const Symbol<DType> b) {
  ...
  */
  static const Symbol<DType> _promoteTypesLookup[DataType_MAX + 1][DataType_MAX + 1] = {
      /*         iv  c1  f4  f8  i1  i4  i8  u1  re  f2  bu  bf  b1  u2  u4  u8  u16  i2   i16, cp4
         cp8  cp16*/
      /* iv */ {iv, c1, f4, f8, i1, i4,  i8, u1,  re,  f2,  bu,
                bf, b1, u2, u4, u8, u16, i2, i16, cp4, cp8, cp16},
      /* c1 */ {c1, c1, f4, f8, i1, i4,  i8, c1,  iv, f2,  iv,
                bf, c1, u2, u4, u8, u16, i2, i16, iv, cp4, cp16},
      /* f4 */ {f4, f4, f4, f8, f4, f4, f4, f4, iv, f4,  iv,
                bf, f4, f4, f4, f4, f4, f4, f4, iv, cp4, cp16},
      /* f8 */ {f8, f8, f8, f8, f8, f8, f8, f8, iv, f8,  iv,
                bf, f8, f8, f8, f8, f8, f8, f8, iv, cp4, cp16},
      /* i1 */ {i1, i1, f4, f8, i1,  i4, i8, i2,  iv, f2,  iv,
                bf, i1, i4, i8, i16, iv, i2, i16, iv, cp4, cp16},
      /* i4 */ {i4, i4, f4, f8, i4,  i4, i8, i4,  iv, f2,  iv,
                bf, i4, i4, i8, i16, iv, i4, i16, iv, cp4, cp16},
      /* i8 */ {i8, i8, f4, f8, i8,  i8, i8, i8,  iv, f2,  iv,
                bf, i8, i8, i8, i16, iv, i8, i16, iv, cp4, cp16},
      /* u1 */ {c1, c1, f4, f8, i2, i4,  i8, u1,  iv, f2,  iv,
                bf, u1, u2, u4, u8, u16, i2, i16, iv, cp4, cp16},
      /* re */ {iv, iv, iv, iv, iv, iv, iv, iv, iv, iv, iv,
                iv, iv, iv, iv, iv, iv, iv, iv, iv, iv, iv},
      /* f2 */ {f2, f2, f4, f8, f2, f2, f2, f2, iv, f2,  iv,
                bf, f2, f2, f2, f2, iv, f2, f2, iv, cp4, cp16},
      /* bu */ {iv, iv, iv, iv, iv, iv, iv, iv, iv, iv, bu,
                iv, iv, iv, iv, iv, iv, iv, iv, iv, iv, iv},
      /* bf */ {bf, bf, bf, bf, bf, bf, bf, bf, iv, bf,  iv,
                bf, bf, bf, bf, bf, iv, bf, bf, iv, cp4, cp16},
      /* b1 */ {c1, c1, f4, f8, i1, i4,  i8, u1,  iv, f2,  iv,
                bf, b1, u2, u4, u8, u16, i2, i16, iv, cp4, cp16},
      /* u2 */ {u2, u2, f4, f8, i4, i4,  i8, u2,  iv, f2,  iv,
                bf, u2, u2, u4, u8, u16, i4, i16, iv, cp4, cp16},
      /* u4 */ {u4, u4, f4, f8, i8, i8,  i8, u4,  iv, f2,  iv,
                bf, u4, u4, u4, u8, u16, i8, i16, iv, cp4, cp16},
      /* u8 */ {u8, u8, f4, f8, i16, i16, i16, u8,  iv, f2,  iv,
                bf, u8, u8, u8, u8,  u16, i16, i16, iv, cp4, cp16},
      /* u16 */ {u16, u16, f4,  f8,  iv,  iv,  iv, u16, iv, f2,  iv,
                 bf,  u16, u16, u16, u16, u16, iv, iv,  iv, cp4, cp16},
      /* i2 */ {i2, i2, f4, f8, i2,  i4, i8, i2,  iv, f2,  iv,
                bf, i2, i4, i8, i16, iv, i2, i16, iv, cp4, cp16},
      /* i16 */ {i16, i16, f4,  f8,  i16, i16, i16, i16, iv, f2,  iv,
                 bf,  i16, i16, i16, i16, iv,  i16, i16, iv, cp4, cp16},
      /* cp4 */ {iv, iv, iv, iv, iv, iv, iv, iv, iv,  iv,  iv,
                 iv, iv, iv, iv, iv, iv, iv, iv, cp4, cp8, cp16},
      /* cp8 */ {cp8, cp8, cp8, cp8, cp8, cp8, cp8, cp8, iv,  cp8, iv,
                 cp8, cp8, cp8, cp8, cp8, cp8, cp8, cp8, cp8, cp8, cp16},
      /* cp16 */ {cp16, cp16, cp16, cp16, cp16, cp16, cp16, cp16, iv,   cp16, iv,
                  cp16, cp16, cp16, cp16, cp16, cp16, cp16, cp16, cp16, cp16, cp16}};
