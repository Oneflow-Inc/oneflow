...
DEFINE_OPEXPR_OP_TYPE_NAME(InputOpConf, "input");
...
DEFINE_OPEXPR_IS_GRAD_DISABLED_DEFAULT_VALUE(InputOpConf, true);
...
template<>
Maybe<OpExprGradClosure> BuiltinOpExprImpl<InputOpConf>::GetOrCreateOpGradClosure() const {
