...
PersistenceThreadPool::PersistenceThreadPool(const Plan& plan) { TODO(); }

int32_t PersistenceThreadPool::CalcThreadNum(const Plan& plan) {
  ...
  return std::min(persistence_task_num, 64);
}
