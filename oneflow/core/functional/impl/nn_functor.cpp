...
class SpmmCooFunctor {
 public:
  ...
  Maybe<Tensor> operator()(const std::shared_ptr<one::Tensor>& a_coo_row,
                           ...
                           const std::shared_ptr<one::Tensor>& a_coo_val, const int64_t& a_num_rows,
    ...
    return OpInterpUtil::Dispatch<Tensor>(*spmm_coo_op_, {a_coo_row, a_coo_col, a_coo_val, b},
                                          attrs);
  }
