...
class TransposeAllDimFunctor {
 public:
  TransposeAllDimFunctor() {}
...
ONEFLOW_FUNCTION_LIBRARY(m) {
  ...
  m.add_functor<impl::TransposeAllDimFunctor>("TransposeAllDimProperty");
  m.add_functor<impl::TransposeAllDimFunctor>("TransposeAllDimFunction");
};
