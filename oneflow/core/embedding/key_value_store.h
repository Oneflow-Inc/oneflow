...
class KeyValueStore {
 public:
  ...
  virtual void Get(ep::Stream* stream, uint32_t num_keys, const int64_t padding_idx, const void* keys, void* values,
  ...
  virtual void Put(ep::Stream* stream, uint32_t num_keys, const int64_t padding_idx, const void* keys, const void* values) = 0;
