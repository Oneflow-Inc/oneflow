...
*/
#ifndef ONEFLOW_EMBEDDING_ROCKS_KEY_VALUE_STORE_H_
#define ONEFLOW_EMBEDDING_ROCKS_KEY_VALUE_STORE_H_
...
struct RocksKeyValueStoreOptions {
...
#endif  // ONEFLOW_EMBEDDING_ROCKS_KEY_VALUE_STORE_H_
