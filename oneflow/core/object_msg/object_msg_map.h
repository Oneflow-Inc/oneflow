...
#define OBJECT_MSG_DEFINE_MAP_KEY(T, field_name)                               \
  OBJECT_MSG_DEFINE_SKIPLIST_KEY(20, T, field_name)
...
#define OBJECT_MSG_MAP(elem_type, elem_field_name)                             \
  OBJECT_MSG_SKIPLIST(elem_type, elem_field_name)

#define OBJECT_MSG_MAP_FOR_EACH(skiplist_ptr, elem)                            \
  OBJECT_MSG_SKIPLIST_FOR_EACH(skiplist_ptr, elem)
