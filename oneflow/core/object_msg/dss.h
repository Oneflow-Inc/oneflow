...
#define DSS_END(field_counter, dss_type, type)                                 \
  _DSS_END(field_counter, dss_type, type)
#define DSS_DEFINE_UNION_FIELD_VISITOR(field_counter, field_case,              \
                                       type7field7case_tuple_seq)              \
  _DSS_DEFINE_UNION_FIELD_VISITOR(field_counter, field_case,                   \
                                  type7field7case_tuple_seq)
#define DSS_GET_FIELD_COUNTER() __COUNTER__

// details

#define _DSS_DEFINE_UNION_FIELD_VISITOR(field_counter, field_case,             \
                                        type7field7case_tuple_seq)             \
private:                                                                       \
  template <template <int, class, class> class F, typename WalkCtxType,        \
            typename DssFieldType, typename Enabled>                           \
  struct __DssVisitField__<field_counter, F, WalkCtxType, DssFieldType,        \
                           Enabled> {                                          \
    ...
    static void Call(WalkCtxType *ctx, DssFieldType *field_ptr) {              \
      switch (field_ptr->field_case) {                                         \
        OF_PP_FOR_EACH_TUPLE(_DSS_MAKE_UNION_FIELD_VISITOR_ENTRY,              \
                             type7field7case_tuple_seq)                        \
      default:;                                                                \
      }                                                                        \
    }                                                                          \
  ...
  template <template <int, class, class> class F, typename WalkCtxType,        \
            typename DssFieldType, typename Enabled>                           \
  struct __DssVisitVerboseField__<field_counter, F, WalkCtxType, DssFieldType, \
                                  Enabled> {                                   \
    template <typename __DssFieldType>                                         \
    using PartialF = F<field_counter, WalkCtxType, __DssFieldType>;            \
    static void Call(WalkCtxType *ctx, DssFieldType *field_ptr,                \
                     const char *__field_name__) {                             \
      switch (field_ptr->field_case) {                                         \
  ...
  template <template <class, int, class, class, bool> class F,                 \
            typename WalkCtxType, typename DssFieldType, typename Enabled>     \
  struct __DssVisitStaticVerboseField__<field_counter, F, WalkCtxType,         \
                                        DssFieldType, Enabled> {               \
    template <typename __DssFieldType>                                         \
    using PartialF =                                                           \
        F<__DssSelfType__, field_counter, WalkCtxType, __DssFieldType, true>;  \
  ...
  template <template <int, class, class> class F, typename WalkCtxType,        \
            typename DssFieldType, typename Enabled>                           \
  struct __DssVisitFieldUntil__<field_counter, F, WalkCtxType, DssFieldType,   \
                                Enabled> {                                     \
    template <typename __DssFieldType>                                         \
    using PartialF = F<field_counter, WalkCtxType, __DssFieldType>;            \
...
#define _DSS_MAKE_UNION_FIELD_VISITOR_ENTRY(field_type, field_name,            \
                                            field_case_value)                  \
  case field_case_value: {                                                     \
    return PartialF<field_type>::Call(ctx, &field_ptr->field_name);            \
  }

#define _DSS_MAKE_UNION_FIELD_VISITOR_ENTRY_VERBOSE(field_type, field_name,    \
                                                    field_case_value)          \
  case field_case_value: {                                                     \
...
#define _DSS_MAKE_UNION_FIELD_VISITOR_ENTRY_STATIC_VERBOSE(                    \
    field_type, field_name, field_case_value)                                  \
  {                                                                            \
    const char *case_field_name = OF_PP_STRINGIZE(field_name);                 \
...
public:                                                                        \
  ...
  bool __WalkFieldUntil__(WalkCtxType *ctx) {                                  \
    return __DssFieldIterUntil__<field_counter, F, WalkCtxType>::Call(ctx,     \
                                                                      this);   \
  }                                                                            \
  ...
  struct __DssFieldTypeId__ final {                                            \
    static std::string Call() { return typeid(FieldType).name(); }             \
                                                                               ...
                                                                               \
private:                                                                       \
  template <int tpl_fld_counter, template <int, class, class> class F,         \
            typename WalkCtxType, typename DssFieldType,                       \
  ...
  template <                                                                   \
      int tpl_fld_counter, template <class, int, class, class, bool> class F,  \
  ...
  struct __DssVisitStaticVerboseField__ {                                      \
    static void Call(WalkCtxType *ctx, const char *__field_name__) {           \
      ...
      F<__DssSelfType__, tpl_fld_counter, WalkCtxType, DssFieldType,           \
        false>::Call(ctx, __field_name__, __oneof_name__);                     \
    }                                                                          \
  };                                                                           \
  template <int tpl_fld_counter, template <int, class, class> class F,         \
            typename WalkCtxType, typename DssFieldType,                       \
  ...
  struct __DssVisitFieldUntil__ {                                              \
    static bool Call(WalkCtxType *ctx, DssFieldType *field_ptr) {              \
      return F<tpl_fld_counter, WalkCtxType, DssFieldType>::Call(ctx,          \
                                                                 field_ptr);   \
    }                                                                          \
  };                                                                           \
  template <int tpl_fld_counter, template <int, class, class> class F,         \
  ...
  struct __DssVerboseFieldIter__ {                                             \
    static void Call(WalkCtxType *ctx, __DssSelfType__ *self) {                \
      __DssVerboseFieldIter__<tpl_fld_counter + 1, F, WalkCtxType>::Call(      \
          ctx, self);                                                          \
    }                                                                          \
  };                                                                           \
  template <int tpl_fld_counter,                                               \
            template <class, int, class, class, bool> class F,                 \
            typename WalkCtxType, typename Enabled = void>                     \
  struct __DssStaticVerboseFieldIter__ {                                       \
    static void Call(WalkCtxType *ctx) {                                       \
      __DssStaticVerboseFieldIter__<tpl_fld_counter + 1, F,                    \
                                    WalkCtxType>::Call(ctx);                   \
    }                                                                          \
  };                                                                           \
  template <int tpl_fld_counter, template <int, class, class> class F,         \
            typename WalkCtxType, typename Enabled = void>                     \
  struct __DssFieldIterUntil__ {                                               \
    static bool Call(WalkCtxType *ctx, __DssSelfType__ *self) {                \
      return __DssFieldIterUntil__<tpl_fld_counter + 1, F, WalkCtxType>::Call( \
          ctx, self);                                                          \
    }                                                                          \
  };                                                                           \
  template <int tpl_fld_counter, template <int, class, class> class F,         \
  ...
  struct __DssFieldReverseIter__ {                                             \
    static void Call(WalkCtxType *ctx, __DssSelfType__ *self) {                \
      __DssFieldReverseIter__<tpl_fld_counter - 1, F, WalkCtxType>::Call(      \
          ctx, self);                                                          \
    }                                                                          \
  };                                                                           \
  template <template <int, class, class> class F, typename WalkCtxType,        \
  ...
  struct __DssFieldOffsetByOffsetOf__ {                                        \
    constexpr static int Get() {                                               \
      return __DssFieldOffsetByOffsetOf__<tpl_fld_counter - 1,                 \
                                          Enabled>::Get();                     \
    }                                                                          \
  };                                                                           \
  ...
  struct __DssAccumulatedAlignedSize4Counter__ {                               \
    static const int value = ConstExprRoundUp<                                 \
        __DssAccumulatedAlignedSize4Counter__<tpl_fld_counter - 1>::value +    \
  ...
  struct __DssAccumulatedAlignedSize4Counter__<field_counter, Enabled> {       \
    static const int value = 0;                                                \
                                                                               ...
                                                                               \
public:                                                                        \
  template <int field_index> struct __DssFieldOffset4FieldIndex__ {            \
    static const int value =                                                   \
        __DssAccumulatedAlignedSize4Counter__<field_index>::value;             \
  };
...
#define DSS_ASSERT_VERBOSE(dss_type)                                           \
  "\n\n\n    please check file " __FILE__ " (before line " OF_PP_STRINGIZE(    \
      __LINE__) ") carefully\n"                                                \
                "    non " dss_type                                            \
                " member found before line " OF_PP_STRINGIZE(__LINE__) "\n\n"
...
private:                                                                       \
  ...
  struct __DssFieldIter__<field_counter, F, WalkCtxType, Enabled> {            \
    static void Call(WalkCtxType *ctx, __DssSelfType__ *self) {                \
      __DssVisitField__<field_counter, F, WalkCtxType,                         \
                        decltype(self->field)>::Call(ctx, &self->field);       \
  ...
  struct __DssVerboseFieldIter__<field_counter, F, WalkCtxType, Enabled> {     \
    static void Call(WalkCtxType *ctx, __DssSelfType__ *self) {                \
      ...
      __DssVisitVerboseField__<field_counter, F, WalkCtxType,                  \
                               decltype(self->field)>::Call(ctx, &self->field, \
                                                            __field_name__);   \
      __DssVerboseFieldIter__<field_counter + 1, F, WalkCtxType>::Call(ctx,    \
                                                                       self);  \
    }                                                                          \
  };                                                                           \
  template <template <class, int, class, class, bool> class F,                 \
            typename WalkCtxType, typename Enabled>                            \
  struct __DssStaticVerboseFieldIter__<field_counter, F, WalkCtxType,          \
                                       Enabled> {                              \
    static void Call(WalkCtxType *ctx) {                                       \
      const char *__field_name__ = OF_PP_STRINGIZE(field);                     \
      __DssVisitStaticVerboseField__<                                          \
          ...
          decltype(                                                            \
              ((__DssSelfType__ *)nullptr)->field)>::Call(ctx,                 \
                                                          __field_name__);     \
      __DssStaticVerboseFieldIter__<field_counter + 1, F, WalkCtxType>::Call(  \
          ctx);                                                                \
    }                                                                          \
  };                                                                           \
  template <template <int, class, class> class F, typename WalkCtxType,        \
  ...
  struct __DssFieldIterUntil__<field_counter, F, WalkCtxType, Enabled> {       \
    static bool Call(WalkCtxType *ctx, __DssSelfType__ *self) {                \
      bool end =                                                               \
          __DssVisitFieldUntil__<field_counter, F, WalkCtxType,                \
                                 decltype(self->field)>::Call(ctx,             \
                                                              &self->field);   \
      if (end) {                                                               \
        return true;                                                           \
      }                                                                        \
      return __DssFieldIterUntil__<field_counter + 1, F, WalkCtxType>::Call(   \
          ctx, self);                                                          \
    }                                                                          \
  };                                                                           \
  template <template <int, class, class> class F, typename WalkCtxType,        \
  ...
  struct __DssFieldReverseIter__<field_counter, F, WalkCtxType, Enabled> {     \
    static void Call(WalkCtxType *ctx, __DssSelfType__ *self) {                \
      __DssVisitField__<field_counter, F, WalkCtxType,                         \
                        decltype(self->field)>::Call(ctx, &self->field);       \
      __DssFieldReverseIter__<field_counter - 1, F, WalkCtxType>::Call(ctx,    \
                                                                       self);  \
    }                                                                          \
  };                                                                           \
  template <typename Enabled>                                                  \
  ...
  struct __DssStaticAssertFieldCounter__<field_counter, Enabled> {             \
    static void StaticAssert() {                                               \
      static const int kAccSize =                                              \
          __DssAccumulatedAlignedSize4Counter__<field_counter>::value;         \
      static_assert(kAccSize ==                                                \
                        __DssFieldOffsetByOffsetOf__<field_counter>::Get(),    \
...
private:                                                                       \
  ...
  static void __DssStaticAssertStructSize__() {                                \
    static const int kSize = ConstExprRoundUp<                                 \
        __DssAccumulatedAlignedSize4Counter__<field_counter>::value,           \
        alignof(type)>();                                                      \
    static_assert((kSize == 0 && sizeof(type) == 1) ||                         \
                      (kSize == sizeof(type)),                                 \
                  DSS_ASSERT_VERBOSE(dss_type));                               \
  }

template <int x, int y> constexpr int ConstExprRoundUp() {
  return (x + y - 1) / y * y;
}

template <bool is_pointer, typename Enabled = void> struct GetterTrait {};

template <typename Enabled> struct GetterTrait<false, Enabled> {
  template <typename T> static const T &Call(const T &data) { return data; }
};
template <typename Enabled> struct GetterTrait<true, Enabled> {
  template <typename T> static const T &Call(const T *data) { return *data; }
};

template <bool is_pointer, typename Enabled = void> struct MutableTrait {};

template <typename Enabled> struct MutableTrait<false, Enabled> {
  template <typename T> static T *Call(T *data) { return data; }
};
template <typename Enabled> struct MutableTrait<true, Enabled> {
  template <typename T> static T *Call(T **data) { return *data; }
};
} // namespace oneflow
