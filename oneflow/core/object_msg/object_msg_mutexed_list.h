...
#define OBJECT_MSG_DEFINE_MUTEXED_LIST_HEAD(elem_type, elem_field_name, field_name)               \
  ...
  static_assert(!std::is_same<self_type, elem_type>::value,                                       \
                "self loop list_entry is not supported");                                         \
...
#define OBJECT_MSG_MUTEXED_LIST(obj_msg_type, obj_msg_field)                                  \
  ObjectMsgMutexedList<StructField<OBJECT_MSG_TYPE_CHECK(obj_msg_type), intrusive::ListEntry, \
...
#define _OBJECT_MSG_DEFINE_MUTEXED_LIST_HEAD_FIELD(elem_type, elem_field_name, field_name)   \
 public:                                                                                     \
  using OF_PP_CAT(field_name, _ObjectMsgListType) = TrivialObjectMsgMutexedList<StructField< \
