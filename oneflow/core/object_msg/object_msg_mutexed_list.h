...
#define OBJECT_MSG_DEFINE_MUTEXED_LIST_HEAD(elem_type, elem_field_name,        \
                                            field_name)                        \
  ...
  _OBJECT_MSG_DEFINE_MUTEXED_LIST_HEAD(                                        \
...
#define _OBJECT_MSG_DEFINE_MUTEXED_LIST_HEAD(field_counter, elem_type,         \
                                             elem_field_name, field_name)      \
  _OBJECT_MSG_DEFINE_MUTEXED_LIST_HEAD_FIELD(elem_type, elem_field_name,       \
                                             field_name)                       \
  OBJECT_MSG_DEFINE_MUTEXED_LIST_ELEM_STRUCT(field_counter, elem_type,         \
                                             elem_field_name, field_name);     \
  OBJECT_MSG_DEFINE_MUTEXED_LIST_LINK_EDGES(field_counter, elem_type,          \
                                            elem_field_name, field_name);      \
  OBJECT_MSG_OVERLOAD_INIT(field_counter,                                      \
                           ObjectMsgEmbeddedMutexedListHeadInit);              \
  OBJECT_MSG_OVERLOAD_DELETE(field_counter,                                    \
                             ObjectMsgEmbeddedMutexedListHeadDelete);          \
  DSS_DEFINE_FIELD(field_counter, "object message",                            \
                   OF_PP_CAT(field_name, _ObjectMsgListType),                  \
                   OF_PP_CAT(field_name, _));

#define _OBJECT_MSG_DEFINE_MUTEXED_LIST_HEAD_FIELD(elem_type, elem_field_name, \
                                                   field_name)                 \
public:                                                                        \
  using OF_PP_CAT(field_name, _ObjectMsgListType) =                            \
      TrivialObjectMsgMutexedList<                                             \
...
#define OBJECT_MSG_DEFINE_MUTEXED_LIST_ELEM_STRUCT(                            \
...
#define OBJECT_MSG_DEFINE_MUTEXED_LIST_LINK_EDGES(field_counter, elem_type,    \
                                                  elem_field_name, field_name) \
public:                                                                        \
...
template <typename LinkField> class TrivialObjectMsgMutexedList {
public:
