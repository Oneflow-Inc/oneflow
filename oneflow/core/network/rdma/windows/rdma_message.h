#ifndef ONEFLOW_NETWORK_RDMA_WINDOWS_RDMA_MESSAGE_H_
#define ONEFLOW_NETWORK_RDMA_WINDOWS_RDMA_MESSAGE_H_
...
#endif  // ONEFLOW_NETWORK_RDMA_WINDOWS_RDMA_MESSAGE_H_
