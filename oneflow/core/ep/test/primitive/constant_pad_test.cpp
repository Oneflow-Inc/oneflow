...
void TestConstantPad(DeviceManagerRegistry* registry, const std::set<DeviceType>& device_types,
...
TEST_F(PrimitiveTest, TestConstantPad2d) {
  ...
  TestConstantPad<float, DataType::kFloat, 2>(&device_manager_registry_, available_device_types_,
                                              dims1, padding_before1, padding_after1);
  TestConstantPad<double, DataType::kDouble, 2>(&device_manager_registry_, available_device_types_,
                                                dims2, padding_before2, padding_after2);
  TestConstantPad<int32_t, DataType::kInt32, 2>(&device_manager_registry_, available_device_types_,
                                                dims3, padding_before3, padding_after3);
  TestConstantPad<int64_t, DataType::kInt64, 2>(&device_manager_registry_, available_device_types_,
                                                dims4, padding_before4, padding_after4);
  TestConstantPad<Eigen::half, DataType::kFloat16, 2>(
