...
*/
#ifndef ONEFLOW_CORE_EP_NPU_NPU_DEVICE_H_
#define ONEFLOW_CORE_EP_NPU_NPU_DEVICE_H_
//#ifdef WITH_NPU
...
class NpuDevice : public Device {
 public:
  OF_DISALLOW_COPY_AND_MOVE(NpuDevice);
  explicit NpuDevice(int device_index, DeviceManager* device_manager);
  ~NpuDevice() override;
