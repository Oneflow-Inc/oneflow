...
//   params.dst_index_helper = NdIndexOffsetHelperCalculator<IndexType, kMaxNumDims>(dst_dims, num_dims);
//   params.src_index_helper = NdIndexOffsetHelperCalculator<IndexType, kMaxNumDims>(src_dims, num_dims);
//   params.dst = dst;
//   params.src = src;
//   size_t elem_cnt = 1;
//   for (int i = 0; i < num_dims; i++) {
