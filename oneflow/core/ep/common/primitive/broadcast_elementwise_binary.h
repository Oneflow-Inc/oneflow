...
#define BINARY_BACKWARD_OP_SEQ                                    \
  ...
  OF_PP_MAKE_TUPLE_SEQ(BinaryOp::kCeilBackwardWithDyX)            \
  ...
  OF_PP_MAKE_TUPLE_SEQ(BinaryOp::kFloorBackwardWithDyX)           \
  ...
  OF_PP_MAKE_TUPLE_SEQ(BinaryOp::kNotEqualZeroBackwardWithDyX)
