...
void CopyNdWithStrideKernel(CopyNdWithStrideKernelParams<num_dims, IndexType> params) {
...
void LaunchKernel(Stream* stream, CopyNdWithStrideKernelParams<num_dims, IndexType> params) {
  CopyNdWithStrideKernel<num_dims, movement_size, IndexType>(params);
}
...
REGISTER_PRIMITIVE_FACTORY(DeviceType::kCPU, CopyNdWithStrideFactory, CopyNdWithStrideFactoryImpl);
