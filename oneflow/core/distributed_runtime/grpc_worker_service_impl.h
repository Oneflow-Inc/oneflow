#ifndef ONEFLOW_CORE_DISTRIBUTED_RUNTIME_GRPC_SERVICE_IMPL_H_
#define ONEFLOW_CORE_DISTRIBUTED_RUNTIME_GRPC_SERVICE_IMPL_H_
...
#endif  // ONEFLOW_CORE_DISTRIBUTED_RUNTIME_GRPC_WORKER_SERVICE_IMPL_H_
