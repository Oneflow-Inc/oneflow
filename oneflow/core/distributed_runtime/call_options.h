...
#ifndef ONEFLOWT_CORE_DISTRIBUTED_RUNTIME_CALL_OPTIONS_H_
#define ONEFLOW_CORE_DISTRIBUTED_RUNTIME_CALL_OPTIONS_H_
...
class CallOptions {
 ...
 private:
  ...
  int64_t timeout_in_ms_ GUARDED_BY(mu_);
...
#endif  // ONEFLOW_CORE_DISTRIBUTED_RUNTIME_CALL_OPTIONS_H_
