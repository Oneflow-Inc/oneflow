...
namespace {
::tensorflow::mutex* get_server_factory_lock() {
  static ::tensorflow::mutex server_factory_lock;
...
void ServerFactory::Register(const std::string& server_type,
  ...
  ::tensorflow::mutex_lock l(*get_server_factory_lock());
...
/* static */
::tensorflow::Status ServerFactory::GetFactory(
