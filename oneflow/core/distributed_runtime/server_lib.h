...
#ifndef ONEFLOW_CORE_DISTRIBUTED_RUNTIME_SERVER_LIB_H_
#define ONEFLOW_CORE_DISTRIBUTED_RUNTIME_SERVER_LIB_H_
...
class ServerInterface {
 public:
  ...
  // returns an error.
  virtual ::tensorflow::Status Join() = 0;
...
class ServerFactory {
 public:
  ...
  // error.
  virtual ::tensorflow::Status NewServer(
  ...
  virtual bool AcceptsOptions(const ::tensorflow::ServerDef& server_def) = 0;
  ...
  static ::tensorflow::Status GetFactory(
      const ::tensorflow::ServerDef& server_def, ServerFactory** out_factory);
};
...
::tensorflow::Status NewServer(const ::tensorflow::ServerDef& server_def,
                               std::unique_ptr<ServerInterface>* out_server);

}  // namespace oneflow

#endif  // ONEFLOW_CORE_DISTRIBUTED_RUNTIME_SERVER_LIB_H_
