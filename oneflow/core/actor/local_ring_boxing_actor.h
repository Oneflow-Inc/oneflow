#ifndef ONEFLOW_CORE_ACTOR_LOCAL_RING_BOXING_ACTOR_H_
#define ONEFLOW_CORE_ACTOR_LOCAL_RING_BOXING_ACTOR_H_

#include "oneflow/core/actor/compute_actor.h"

namespace oneflow {

class LocalRingBoxingActor : public CompActor {
 public:
  OF_DISALLOW_COPY_AND_MOVE(LocalRingBoxingActor);
  LocalRingBoxingActor() = default;
  ~LocalRingBoxingActor() override = default;
 ...
 private:
  ...
  bool IsCustomizedReadAlwaysUnReadyFromNow() const override {
    return this->remaining_eord_cnt() <= 1 && consumed_rs_.available_regst_desc_cnt() == 0;
  }
...
#endif  // ONEFLOW_CORE_ACTOR_LOCAL_RING_BOXING_ACTOR_H_
