...
protected:
  ...
  int64_t cur_processed_regst_desc_id() const {
    return cur_processed_regst_desc_id_;
  }
  int64_t processed_regst_desc_id_cnt() const {
    return processed_regst_desc_id_cnt_;
  }
