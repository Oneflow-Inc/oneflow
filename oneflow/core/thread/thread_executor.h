...
class MultiThreadExecutorSeq : public MultiThreadExecutorBase<MultiThreadExecutorSeq> {
 public:
  template<typename F>
  void ParallelFor(int64_t begin, int64_t end, const F& func, size_t num_threads,
                   size_t grain_size) {
...
class MultiThreadExecutorTbb : public MultiThreadExecutorBase<MultiThreadExecutorTbb> {
 public:
  template<typename F>
  void ParallelFor(int64_t begin, int64_t end, const F& func, size_t num_threads,
                   size_t grain_size) {
...
class MultiThreadExecutorOmp : public MultiThreadExecutorBase<MultiThreadExecutorOmp> {
 public:
  template<typename F>
  void ParallelFor(int64_t begin, int64_t end, const F& func, size_t num_threads,
                   size_t grain_size) {
...
class MultiThreadExecutorOf : public MultiThreadExecutorBase<MultiThreadExecutorOf> {
 public:
  template<typename F>
  void ParallelFor(int64_t begin, int64_t end, const F& func, size_t num_threads,
                   size_t grain_size) {
