...
public:
  ...
  BlobDesc(const TensorPodDesc &body, bool is_tensor_list,
           bool is_body_disabled, bool is_dynamic)
      : body_(body), is_tensor_list_(is_tensor_list),
        is_body_disabled_(is_body_disabled), is_dynamic_(is_dynamic) {}
