...
TensorSliceView GetRawTenserSliceView(const TensorSliceView &view,
                                      DataType data_type) {
...
TensorSliceCopier::TensorSliceCopier(const TensorSliceView &dst_view,
                                     ...
                                     const TensorSliceView &copy_view,
...
TensorSliceCopier::TensorSliceCopier(const TensorSliceView &dst_view,
                                     const TensorSliceView &src_view,
                                     const DataType data_type)
    : TensorSliceCopier(dst_view, src_view, dst_view.Intersect(src_view),
                        data_type) {}

void TensorSliceCopier::Copy(DeviceCtx *ctx, const MemoryCopier &copier,
