...
class RegstMgr final {
 ...
 private:
  ...
  void InitFromUnsharedRegstProtoList(const std::list<const RegstDescProto*>& regst_protos);
  void InitFromSharedRegstProtoList(const std::list<const RegstDescProto*>& regst_protos);
