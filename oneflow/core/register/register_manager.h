...
class RegstMgr final {
 public:
  ...
  const RegstDescAddr& CtrlRegstDescAddr4RegstDescId(int64_t regst_desc_id) const;
  bool HasCtrlRegstDescAddr4RegstDescId(int64_t regst_desc_id) const;
 ...
 private:
  ...
  HashMap<int64_t, RegstDescAddr> ctrl_regst_desc_id2ctrl_regst_desc_addr_;
  std::mutex mutex_;
};
