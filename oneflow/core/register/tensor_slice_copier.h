...
public:
  ...
  TensorSliceCopier(const TensorSliceView &dst_view,
                    const TensorSliceView &src_view,
                    const TensorSliceView &copy_view, DataType data_type);
  TensorSliceCopier(const TensorSliceView &dst_view,
                    const TensorSliceView &src_view, DataType data_type);
  virtual ~TensorSliceCopier() = default;

  void Copy(DeviceCtx *ctx, const MemoryCopier &copier, void *dst,
            const void *src) const;
  void Copy(DeviceCtx *ctx, const MemoryCopier &copier, Blob *dst_blob,
