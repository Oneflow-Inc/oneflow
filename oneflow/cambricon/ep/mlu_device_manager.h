...
*/
#ifndef ONEFLOW_COMBRICON_EP_MLU_DEVICE_MANAGER_H_
#define ONEFLOW_COMBRICON_EP_MLU_DEVICE_MANAGER_H_
...
class MluDeviceManager : public DeviceManager {
 public:
  OF_DISALLOW_COPY_AND_MOVE(MluDeviceManager);
  MluDeviceManager(DeviceManagerRegistry* registry);
  ~MluDeviceManager() override;
