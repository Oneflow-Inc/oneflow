...
from oneflow.python.multiprocessing import multiprocessing
...
class _MultiProcessingDataLoaderIter(_BaseDataLoaderIter):
    ...
    def __init__(self, loader):
        ...
        for i in range(self._num_workers):
            ...
            # TODO:zhaoluyang aligin target with torch(_utils.worker._worker_loop)
...
# (shell2) ./test_socket.py sock_tmp 1017 send
    ...
    def _get_data(self):
        ...
        if self._timeout > 0:
            ...
            while True:
                print("_MultiProcessingDataLoaderIter >> _get_data >> self._try_get_data()")
                success, data = self._try_get_data()
                if success:
                    return data
    ...
    def _next_data(self):
        ...
        while True:
            ...
            print("_MultiProcessingDataLoaderIter >> idx, data = self._get_data() >> start")
            idx, data = self._get_data()
            print("_MultiProcessingDataLoaderIter >> idx, data = self._get_data() >> finish")
        ...
        if not self._shutdown:
            ...
            try:
                ...
                if self._worker_pids_set:
                    # TODO:zhaoluayng _remove_worker_pids
