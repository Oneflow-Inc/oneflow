...
def api_get_variable(
    ...
    distribute: oneflow_api.sbp_descriptor.SbpDescriptor = oneflow_api.sbp_descriptor.broadcast(),
    reuse: bool = True,
...
def GenerateVariableOpConf(
    ...
    if type(distribute) is oneflow_api.sbp_descriptor.SplitSbpDescriptor:
