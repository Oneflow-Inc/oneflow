...
def broadcast_mod(x, y, name=None):
    op_conf = op_conf_util.OperatorConf()
    setattr(
        op_conf,
        "name",
    ...
    op_conf.broadcast_mod_conf.a = x.logical_blob_name
    op_conf.broadcast_mod_conf.b = y.logical_blob_name
    op_conf.broadcast_mod_conf.out = "out"
    compile_context.CurJobAddOp(op_conf)
    lbi = logical_blob_id_util.LogicalBlobId()
    lbi.op_name = op_conf.name
    lbi.blob_name = "out"
