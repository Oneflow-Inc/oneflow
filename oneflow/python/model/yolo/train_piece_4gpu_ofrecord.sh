...
python train_piece_4gpu_ofrecord.py --train_dir=/dataset/yolov3 --total_batch_num=100 --base_lr=0.0000625 --weight_l2=0.0005 --gpu_num_per_node=4 --batch_size=256 --data_part_num=1 --gt_max_len=256 --raw_data=1 --num_of_batches_in_snapshot=1000 --shuffle=0 --model_load_dir=../yolov/of_model/yolov3_model_python/
