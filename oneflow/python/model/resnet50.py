...
SINGLE_PIC_DATA_DIR = "/dataset/PNGS/PNG228/of_record"
REPEATED_PIC_DATA_DIR = "/dataset/PNGS/PNG228/of_record_repeated"
TRAIN_DIR = REPEATED_PIC_DATA_DIR
EVAL_DIR = REPEATED_PIC_DATA_DIR
IMAGE_SIZE = 228
...
def _batch_norm(inputs, name=None):
    # print("batch_norm input shape: ", inputs.shape)
...
def _truncated_normal_initializer(std=0.816496580927726):
    kernel_initializer = op_conf_util.InitializerConf()
    kernel_initializer.truncated_normal_conf.std = std
...
def conv2d_affine(
    ...
    output = _conv2d(name, input, filters, kernel_size, strides)
...
def resnet50(data_dir):
    ...
    with flow.deprecated.variable_scope("Resnet"):
        ...
        fc1001 = flow.layers.dense(
            ...
            units=1001,
            use_bias=True,
            kernel_initializer=_truncated_normal_initializer(),
