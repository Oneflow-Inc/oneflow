...
@oneflow_export("keras.pooling.MaxPool2D")
def MaxPool2D(x, pool_size, strides=None, padding="valid", data_format="channels_last"):
    ...
    if strides == None:
        setattr(op_conf.max_pooling_2d_conf, "strides", pool_size)
    else:
