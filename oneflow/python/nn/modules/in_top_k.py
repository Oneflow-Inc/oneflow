...
def in_top_k_op(targets, predictions, k):
    ...
    .. code-block:: python
        ...
        >>> out1 = flow.experimental.in_top_k(targets1, predictions1, k=1)
        >>> out1
        tensor([1, 0], dtype=oneflow.int8)
        >>> out2 = flow.experimental.in_top_k(targets1, predictions1, k=2)
        >>> out2
        ...
        >>> out3 = flow.experimental.in_top_k(targets2, predictions2, k=1)
        >>> out3
