...
class RememberInstanceCreationInfo:
    ...
    def print_creation_info(self):
        print("object name: ", self.creation_name, ", module: ", self.creation_module, ", function: ", self.creation_function,
                "linenum: ", self.creation_line, ", text: ", self.creation_text)


@oneflow_export("nn.Graph", "nn.graph.Graph")
@experimental_api
class Graph(RememberInstanceCreationInfo):
    def __init__(self):
        super().__init__()
        # TODO(xuxiaoyu): Replace UniqueStr by id generated by MultiClientSession
