...
def test_broadcast_logical(test_case):
    ...
    arg_dict["data_type"] = [flow.int8, flow.int32, flow.int64]
...
def testbroadcast_logical_case_3(test_case):
    ...
    arg_dict["y_shape"] = [(20, 5, 20, 2)]
    arg_dict["data_type"] = [flow.int32, flow.int64, flow.float, flow.double]
    for arg in GenArgList(arg_dict):
        _comparebroadcast_logical_with_tf(test_case, *arg)
...
def testbroadcast_logical_case_4(test_case):
    arg_dict = OrderedDict()
    arg_dict["device_type"] = ["gpu"]
    arg_dict["x_shape"] = [(50, 1, 20)]
    arg_dict["y_shape"] = [(20, 50, 20, 20)]
    arg_dict["data_type"] = [flow.float, flow.double]
    arg_dict["mirrored"] = [True]
    for arg in GenArgList(arg_dict):
        _comparebroadcast_logical_with_tf(test_case, *arg)
...
def testbroadcast_logical_case_5(test_case):
    ...
    arg_dict["y_shape"] = [(10, 1)]
    arg_dict["data_type"] = [flow.int8, flow.int32, flow.int64, flow.double]
    arg_dict["mirrored"] = [True]
    for arg in GenArgList(arg_dict):
        _comparebroadcast_logical_with_tf(test_case, *arg)
