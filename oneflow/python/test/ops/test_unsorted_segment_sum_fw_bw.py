...
def _random_inputs(data_shape, segment_ids_shape, axis, num_segments):
    ...
    segment_ids = np.random.randint(low=0, high=num_segments,
            size=segment_ids_shape, dtype=np.int32)
...
def _compare_unsorted_segment_sum_with_tf(test_case, device_type, data_shape,
    ...
    data, segment_ids = _random_inputs(data_shape, segment_ids_shape, axis,
            num_segments)
