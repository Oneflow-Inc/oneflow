...
def _run_test(test_case, device, out_shape, axis, segment_ids_shape):
    ...
    def unsorted_segment_sum_job(
        ...
        with flow.fixed_placement(device, "0:0"):
            return flow.math.unsorted_segment_sum(data=data, segment_ids=segment_ids, num_segments=out_shape[axis],
                                                  axis=axis)
    ...
    def unsorted_segment_sum_like_job(
        ...
        with flow.fixed_placement(device, "0:0"):
            return flow.math.unsorted_segment_sum_like(data=data, segment_ids=segment_ids, like=like,
                                                       axis=axis)
