...
test_conv2d_stride_output = np.array(
    [
        [
            [
                [-1.0164761543273926, 3.153532028198242, -3.7565059661865234],
                [-1.3517316579818726, 4.690882682800293, 3.0248217582702637],
                [-0.7396122217178345, -2.846742630004883, -0.1308247298002243],
            ]
        ]
    ]
)
...
test_conv2d_kernel_output = np.array(
    [
        [
            [
                [0.20277903974056244, -5.076409816741943, -2.254866361618042],
                [0.1479482650756836, 14.613767623901367, -3.6095173358917236],
                [11.288614273071289, -5.788584232330322, -2.583430290222168],
            ]
        ]
    ]
)
...
test_conv2d_dilation_output = np.array(
    [
        [
            [
                [-12.254250526428223, -1.1300756931304932, 3.9988343715667725],
                [3.999661445617676, -1.560887098312378, 1.8020999431610107],
                [-0.6671416759490967, -13.394196510314941, 2.3012940883636475],
            ]
        ]
    ]
)
...
class TestConv2d(flow.unittest.TestCase):
    ...
    def test_conv2d_padding(test_case):
        conv = flow.nn.Conv2d(1, 1, (3, 3), padding=(1, 1))
        _test_conv2d(
            test_case,
            conv,
    ...
    def test_conv2d_stride(test_case):
        conv = flow.nn.Conv2d(1, 1, (3, 3), padding=(1, 1), stride=(2, 2))
        _test_conv2d(
            test_case,
            conv,
    ...
    def test_conv2d_kernel(test_case):
        conv = flow.nn.Conv2d(1, 1, (5, 5), bias=False)
        _test_conv2d(
            test_case,
            conv,
    ...
    def test_conv2d_dilation(test_case):
        conv = flow.nn.Conv2d(1, 1, (3, 3), bias=False, dilation=(2, 2))
        _test_conv2d(
            test_case,
            conv,
