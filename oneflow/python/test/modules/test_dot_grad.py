...
# y = torch.tensor([3.7, 8.6], requires_grad=False)
...
# print(flow.F.mul_scalar_by_tensor(flow.tensor([1.2, 2.3]), flow.tensor([2.0])))


a = flow.tensor([8.6, 3.7,], requires_grad=False)
...
print(a.grad)
print(b.grad)
print("----->>  end flow cpu  bp")

e = flow.tensor([8.6, 3.7], requires_grad=False, device=flow.device("cuda"))
