...
def _test_instancenorm1d_3d_input(test_case, device):
    input_arr = np.array(
...
def _test_instancenorm2d_4d_input(test_case, device):
    input_arr = np.array(
        [[[[-0.8791, 0.2553, 0.7403, -0.2859],
           [0.8006, -1.7701, -0.9617, 0.1705],
           [0.2842, 1.7825, 0.3365, -0.8525]],
...
def test_instancenorm2d_infer(test_case, device):
    input_arr = np.array(
        [[[[-0.8791, 0.2553, 0.7403, -0.2859],
           [0.8006, -1.7701, -0.9617, 0.1705],
           [0.2842, 1.7825, 0.3365, -0.8525]],
...
def test_instancenorm2d_infer_4d_input(test_case, device):
    input_arr = np.array(
        [[[[-0.8791, 0.2553, 0.7403, -0.2859],
           [0.8006, -1.7701, -0.9617, 0.1705],
           [0.2842, 1.7825, 0.3365, -0.8525]],
...
class TestInstanceNorm(flow.unittest.TestCase):
    def test_instancenorm(test_case):
        ...
        arg_dict["test_fun"] = [
            _test_instancenorm1d_3d_input,
            _test_instancenorm2d,
            _test_instancenorm2d_4d_input,
            test_instancenorm2d_infer,
            test_instancenorm2d_infer_4d_input,
