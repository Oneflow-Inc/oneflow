...
class TestModule(flow.unittest.TestCase):
    def test_layernorm(test_case):
        ...
        test_case.assertTrue(np.allclose(y1.numpy(), torch_o1))
        test_case.assertTrue(np.allclose(y2.numpy(), torch_o2))
        test_case.assertTrue(np.allclose(y3.numpy(), torch_o3))
