...
def api_gpu_device_num(val):
    ...
    """
    return enable_if.unique(gpu_device_num)(val)
...
def api_cpu_device_num(val):
    ...
    """
    return enable_if.unique(cpu_device_num)(val)
...
def api_comm_net_worker_num(val):
    return enable_if.unique(comm_net_worker_num)(val)
...
def api_max_mdsave_worker_num(val):
    return enable_if.unique(max_mdsave_worker_num)(val)
...
def api_compute_thread_pool_size(val):
    return enable_if.unique(compute_thread_pool_size)(val)
...
def api_rdma_mem_block_mbyte(val):
    return enable_if.unique(rdma_mem_block_mbyte)(val)
...
def api_rdma_recv_msg_buf_mbyte(val):
    return enable_if.unique(rdma_recv_msg_buf_mbyte)(val)
...
def api_reserved_host_mem_mbyte(val):
    return enable_if.unique(reserved_host_mem_mbyte)(val)
...
def api_reserved_device_mem_mbyte(val):
    return enable_if.unique(reserved_device_mem_mbyte)(val)
...
def api_use_rdma(val = True):
    return enable_if.unique(use_rdma)(val = True)
...
def api_thread_enable_local_message_queue(val):
    return enable_if.unique(thread_enable_local_message_queue)(val)
...
def api_enable_debug_mode(val):
    return enable_if.unique(enable_debug_mode)(val)
...
def api_save_downloaded_file_to_local_fs(val = True):
    return enable_if.unique(save_downloaded_file_to_local_fs)(val = True)
...
def api_persistence_buf_byte(val):
    return enable_if.unique(persistence_buf_byte)(val)
...
def api_collect_act_event(val = True):
    return enable_if.unique(collect_act_event)(val = True)
