...
def random_pytorch_tensor(
    ndim=None, dim0=1, dim1=None, dim2=None, dim3=None, dim4=None, low=0, high=1, dtype=float, requires_grad=True
):
    ...
    pytorch_tensor = (
        ...
        .value()
        .requires_grad_(requires_grad and dtype != int)  # Only Tensors of floating point dtype can require gradients
    )
