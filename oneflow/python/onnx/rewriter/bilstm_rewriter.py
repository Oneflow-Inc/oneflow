...
"""
oneflow.python.onnx.rewriter.bilstm_rewriter - bilstm support.
This rewriter depends on oneflow.python.onnx.rewriter.lstm_rewriter's results.
"""
...
from oneflow.python.onnx.rewriter import rnn_utils
