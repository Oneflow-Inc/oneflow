...
"""
oneflow.python.onnx.rewriter.unit_rnn_rewriter_base
"""
...
from oneflow.python.onnx.rewriter.rnn_utils import REWRITER_RESULT, get_pattern, \
    get_rnn_scope_name, parse_rnn_loop, seq_len_pattern
from oneflow.python.onnx.utils import is_tf_select_op, is_tf_tensor_array_write_op
from oneflow.python.onnx.graph_matcher import GraphMatcher
