...
*/
#ifndef ONEFLOW_USER_KERNELS_NORMAL_KERNEL_H_
#define ONEFLOW_USER_KERNELS_NORMAL_KERNEL_H_
...
class NormalKernel final : public user_op::OpKernel {
 ...
 private:
  void Compute(user_op::KernelComputeContext* ctx, user_op::OpKernelState* state) const override {
    ...
    auto normal_gen = std::make_shared<NormalGenerator<device_type>>(generator);
    normal_gen->Generate(ctx->device_ctx(), elem_cnt, out_dptr);
  }
