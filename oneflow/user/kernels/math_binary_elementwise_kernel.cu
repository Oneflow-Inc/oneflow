...
#define REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_KERNEL(math_type_pair, data_type_pair)            \
...
#define REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_GRAD_KERNEL(math_type_pair, data_type_pair)       \
...
#define REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_KERNEL_AND_GRAD(math_type_pair, data_type_pair) \
  REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_KERNEL(math_type_pair, data_type_pair)                \
  REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_GRAD_KERNEL(math_type_pair, data_type_pair)
...
OF_PP_SEQ_PRODUCT_FOR_EACH_TUPLE(
    REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_KERNEL, OF_PP_MAKE_TUPLE_SEQ("truncdiv", TruncDiv),
...
#define REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_HALF_KERNEL(math_type_str, math_func_prefix)     \
...
#define REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_GRAD_HALF_KERNEL(math_type_str, math_func_prefix) \
...
#define REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_HALF_KERNEL_AND_GRAD(math_type_str,    \
                                                                   math_func_prefix) \
  REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_HALF_KERNEL(math_type_str, math_func_prefix) \
  REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_GRAD_HALF_KERNEL(math_type_str, math_func_prefix)

OF_PP_FOR_EACH_TUPLE(REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_HALF_KERNEL_AND_GRAD,
                     MATH_BINARY_ELEMENTWISE_FUNC_SEQ)
OF_PP_FOR_EACH_TUPLE(REGISTER_MATH_BINARY_ELEMENTWISE_CUDA_HALF_KERNEL,
