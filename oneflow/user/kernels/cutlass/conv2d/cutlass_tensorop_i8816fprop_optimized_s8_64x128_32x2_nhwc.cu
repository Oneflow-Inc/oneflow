...
using cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc_base =
...
// Derived class
template<int Alignment, int AlignmentC>
struct cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc
    : public cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc_base<Alignment, AlignmentC> {
};

///////////////////////////////////////////////////////////////////////////////////////////////////

template<int Alignment, int AlignmentC>
using Operation_cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc =
    cutlass::conv::device::ImplicitGemmConvolution<
        cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc<Alignment, AlignmentC>>;
...
ONEFLOW_CUTLASS_MANIFEST(manifest) {
  ...
  manifest.append(new cutlass::library::Conv2dOperation<
                  Operation_cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc<2, 2>>(
      "cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc_align2"));
  manifest.append(new cutlass::library::Conv2dOperation<
                  Operation_cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc<4, 4>>(
      "cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc_align4"));
  manifest.append(new cutlass::library::Conv2dOperation<
                  Operation_cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc<8, 4>>(
      "cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc_align8"));
  manifest.append(new cutlass::library::Conv2dOperation<
                  Operation_cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc<16, 4>>(
      "cutlass_tensorop_i8816fprop_optimized_s8_64x128_32x2_nhwc_align16"));
}
