...
// __device__ int64_t GenUniformInt(curandStatePhilox4_32_10_t* state, const int64_t low, const int64_t high) {
...
// template<typename T>
// __global__ void GenerateGpu(curandStatePhilox4_32_10_t* state, const int64_t elem_cnt, T* dptr, const int64_t low,
//                             const int64_t high) {
