...
class TanhNpuKernel final : public user_op::OpKernel {
 public:
  OF_DISALLOW_COPY_AND_MOVE(TanhNpuKernel);
  TanhNpuKernel() = default;
  ~TanhNpuKernel() override = default;
...
REGISTER_USER_KERNEL("tanh").SetCreateFn<TanhNpuKernel>().SetIsMatchedHob(user_op::HobDeviceType() == DeviceType::kNPU);

class TanhGradNpuKernel final : public user_op::OpKernel {
 public:
  OF_DISALLOW_COPY_AND_MOVE(TanhGradNpuKernel);
  TanhGradNpuKernel() = default;
  ~TanhGradNpuKernel() override = default;
...
REGISTER_USER_KERNEL("tanh_grad").SetCreateFn<TanhGradNpuKernel>().SetIsMatchedHob(user_op::HobDeviceType() == DeviceType::kNPU);
