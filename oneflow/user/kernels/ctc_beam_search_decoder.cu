...
template<typename T>
__global__ void CtcBeamSearchDecodeGpuMultiThread(int64_t* decoded_ptr, T* neg_sum_logits_ptr,
...
template<typename T>
__global__ void CtcBeamSearchDecodeGpu(int64_t* decoded_ptr, T* neg_sum_logits_ptr,
