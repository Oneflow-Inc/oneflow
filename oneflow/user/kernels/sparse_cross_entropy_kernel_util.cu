...
__global__ void
ComputeEntropyGpu(const int64_t num_instances, const int64_t num_classes,
...
template <typename K>
__global__ void
ComputeEntropyGpuHalf(const int64_t num_instances, const int64_t num_classes,
...
template <typename T, typename K>
__global__ void ComputeDiffGpu(const int64_t num_instances,
                               const int64_t num_classes, const int64_t depth,
                               const int64_t lower_bound, const T *x,
...
template <typename K>
__global__ void
ComputeDiffGpuHalf(const int64_t num_instances, const int64_t num_classes,
                   const int64_t depth, const int64_t lower_bound,
...
template <typename K>
__global__ void
ComputeDiffWithSoftmaxGpuHalf(const int64_t elem_cnt, const int64_t num_classes,
                              const int64_t depth, const int64_t lower_bound,
...
struct SparseCrossEntropyKernelUtil<DeviceType::kGPU, T, K> {
  ...
  static void ComputeDiff(DeviceCtx *ctx, const int64_t num_instances,
                          const int64_t num_classes, const int64_t depth,
                          const int64_t lower_bound, const T *x,
                          const K *labels, const T *dy, T *dx) {
  ...
  static void ComputeDiffWithSoftmax(DeviceCtx *ctx, const int64_t elem_cnt,
                                     ...
                                     const int64_t depth,
                                     const int64_t lower_bound, const T *prob,
                                     const K *labels, const T *dy, T *dx) {
...
struct SparseCrossEntropyKernelUtil<DeviceType::kGPU, float16, K> {
  static void ComputeEntropy(DeviceCtx *ctx, const int64_t num_instances,
                             const int64_t num_classes, const int64_t depth,
                             const int64_t lower_bound, const float16 *x,
                             const K *labels, float16 *y) {
    ComputeEntropyGpuHalf<
        K><<<BlocksNum4ThreadsNum(num_instances), kCudaThreadsNumPerBlock, 0,
             ctx->cuda_stream()>>>(
        num_instances, num_classes, depth, lower_bound,
        reinterpret_cast<const half *>(x), labels, reinterpret_cast<half *>(y));
  }
  ...
  static void ComputeDiffWithSoftmax(DeviceCtx *ctx, const int64_t elem_cnt,
                                     ...
                                     const float16 *prob, const K *labels,
                                     const float16 *dy, float16 *dx) {
    ComputeDiffWithSoftmaxGpuHalf<
        K><<<BlocksNum4ThreadsNum(elem_cnt), kCudaThreadsNumPerBlock, 0,
