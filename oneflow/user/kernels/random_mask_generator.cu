...
// __device__ int8_t GenMask(curandStatePhilox4_32_10_t* state, const float rate) {
//   return curand_uniform(state) >= rate;
  
// }

// __global__ void GenerateGpu(curandStatePhilox4_32_10_t* state, const int64_t n, const float rate, int8_t* mask) {
