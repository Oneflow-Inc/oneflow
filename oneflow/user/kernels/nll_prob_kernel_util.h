...
*/
#ifndef ONEFLOW_USER_KERNELS_NLL_PROB_KERNEL_UTIL_H_
#define ONEFLOW_USER_KERNELS_NLL_PROB_KERNEL_UTIL_H_
...
#endif  // ONEFLOW_USER_KERNELS_NLL_PROB_KERNEL_UTIL_H_
