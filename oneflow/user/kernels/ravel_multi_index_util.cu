...
// // template<typename T>
// // __global__ void RavelMultiIndexForwardGpuKernel(int32_t n, int32_t in_num, 
// //   const RavelMultiIndexHelper<T> helper, user_op::KernelComputeContext* kernel_ctx, T* out) {
// //   printf("RUN CUDA KERNEL");
// //   DoIndexToOffset<T>(n, in_num, helper, kernel_ctx, out);
// // }

// template<typename T>
// __global__ void RavelMultiIndexForwardGpuKernel(int32_t n, int32_t in_num, 
//   int32_t ndim, const Tensor* dims_tensor, user_op::KernelComputeContext* kernel_ctx, T* out) {
//   printf("RUN CUDA KERNEL");
//   DoIndexToOffset<T>(n, in_num, ndim, dims_tensor->dptr<T>(), kernel_ctx, out);
// }
...
//     // RUN_CUDA_KERNEL((RavelMultiIndexForwardGpuKernel<T>), ctx, in_num, n, in_num, helper, kernel_ctx, out);
//     RUN_CUDA_KERNEL((RavelMultiIndexForwardGpuKernel<T>), ctx, in_num, n, in_num, ndim, dims_tensor, kernel_ctx, out);
