...
class EmptyState final : public OpKernelState {
 public:
  EmptyState(bool is_init) : is_init_(is_init) {}
  ~EmptyState() = default;
...
class EmptyKernel final : public OpKernel {
 ...
 private:
  void Compute(user_op::KernelComputeContext* ctx) const override {
    //auto* empty_state = dynamic_cast<ConstState*>(state);
    //if (empty_state->is_inited()) { return; }
...
OF_PP_SEQ_PRODUCT_FOR_EACH_TUPLE(REGISTER_EMPTY_KERNEL, DEVICE_TYPE_SEQ,
