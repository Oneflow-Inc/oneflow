...
// Note [Passing pointer and offset to cuda::atomic::FastAdd]
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// For its internal bounds checking, cuda::atomic::FastAdd needs to know where the destination
...
#pragma unroll 4
          ...
          for (index_type j = 0; j < 4; ++j) {
            // set input gradient. See Note [Passing pointer and offset to cuda::atomic::FastAdd].
