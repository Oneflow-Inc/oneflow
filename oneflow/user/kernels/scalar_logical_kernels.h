...
struct ScalarLogicalEqualFunctor {
  ...
  OF_DEVICE_FUNC int8_t operator()(T x) const {
    return BinaryFuncEQ<T>::Invoke(x, scalar);
  }
  const T scalar;
};
...
struct ScalarLogicalNotEqualFunctor {
  ...
  OF_DEVICE_FUNC int8_t operator()(T x) const {
    return BinaryFuncNE<T>::Invoke(x, scalar);
  }
  const T scalar;
};
...
struct ScalarLogicalGreaterFunctor {
  ...
  OF_DEVICE_FUNC int8_t operator()(T x) const {
    return BinaryFuncGT<T>::Invoke(x, scalar);
  }
  const T scalar;
};
...
struct ScalarLogicalGreaterEqualFunctor {
  ...
  OF_DEVICE_FUNC int8_t operator()(T x) const {
    return BinaryFuncGE<T>::Invoke(x, scalar);
  }
  const T scalar;
};
...
struct ScalarLogicalLessFunctor {
  ...
  OF_DEVICE_FUNC int8_t operator()(T x) const {
    return BinaryFuncLT<T>::Invoke(x, scalar);
  }
  const T scalar;
};
...
struct ScalarLogicalLessEqualFunctor {
  ...
  OF_DEVICE_FUNC int8_t operator()(T x) const {
    return BinaryFuncLE<T>::Invoke(x, scalar);
  }
  const T scalar;
};
