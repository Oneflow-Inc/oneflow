...
OF_PP_SEQ_PRODUCT_FOR_EACH_TUPLE(REGISTER_REDUCE_SUM_LIKE_KERNEL, OF_PP_MAKE_TUPLE_SEQ(DeviceType::kCUDA), OF_PP_MAKE_TUPLE_SEQ(cuDoubleComplex, DataType::kComplex64));
#endif  // WITH_CUDA
