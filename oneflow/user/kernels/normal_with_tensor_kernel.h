...
struct CustomNormalTransformFunctor {
  // This function takes in a random value and returns the corresponding sample from the normal distribution
  ...
  CustomNormalTransformFunctor(ComputeType mean_val, ComputeType std_val, T mean_tensor, T std_tensor) {
