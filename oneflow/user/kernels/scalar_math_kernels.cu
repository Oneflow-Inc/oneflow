...
//   void operator()(ep::Stream* stream, const int64_t elem_cnt, const T scalar, const T* in, T*
//   out) {
//     OF_CUDA_CHECK(cuda::elementwise::Unary(UnaryByScalarFunctor<BIN_OP, T>(scalar), elem_cnt,
//     out,
...
//   void operator()(ep::Stream* stream, const int64_t elem_cnt, const T scalar, const T* in, T*
//   out) {
//     OF_CUDA_CHECK(cuda::elementwise::Unary(UnaryByScalarReverseFunctor<BIN_OP, T>(scalar),
//     elem_cnt,
//                                            out, in,
//                                            stream->As<ep::CudaStream>()->cuda_stream()));
//   }
...
//                         * (powf(__half2float(x), __half2float(exponent) -
