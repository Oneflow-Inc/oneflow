...
REGISTER_ELU_BACKWARD_KERNEL();
REGISTER_CELU_BACKWARD_KERNEL();
REGISTER_GELU_BACKWARD_KERNEL();
REGISTER_HARDSWISH_BACKWARD_KERNEL();
REGISTER_HARDSIGMOID_BACKWARD_KERNEL();
REGISTER_HARDSHRINK_BACKWARD_KERNEL();
REGISTER_HARDTANH_BACKWARD_KERNEL();
REGISTER_MISH_BACKWARD_KERNEL();
REGISTER_RELU_BACKWARD_KERNEL();
REGISTER_SILU_BACKWARD_KERNEL();
REGISTER_SELU_BACKWARD_KERNEL();
REGISTER_SOFTSHRINK_BACKWARD_KERNEL();
REGISTER_SOFTSIGN_BACKWARD_KERNEL();
REGISTER_SOFTPLUS_BACKWARD_KERNEL();
REGISTER_LEAKYRELU_BACKWARD_KERNEL();
REGISTER_TANH_BACKWARD_KERNEL();
REGISTER_THRESHOLD_BACKWARD_KERNEL();
