 ...
 private:
  ...
  void Compute(user_op::KernelComputeContext* ctx, user_op::OpKernelState* state,
    ...
    UniqueAndPartition<K, U, IDX>(
        cuda_stream, num_ids, hash_capacity, parallel_num, seed,
    ...
    UniqueAndPartition<K, U, IDX>(cuda_stream, received_elem_cnt, hash_capacity, 1, seed,
                                  received_ids, received_column_ids,
