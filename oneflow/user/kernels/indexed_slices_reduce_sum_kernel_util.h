...
*/
#ifndef ONEFLOW_USER_KERNEL_INDEXED_SLICES_REDUCE_SUM_KERNEL_UTIL_H_
#define ONEFLOW_USER_KERNEL_INDEXED_SLICES_REDUCE_SUM_KERNEL_UTIL_H_
...
#endif  // ONEFLOW_USER_KERNEL_INDEXED_SLICES_REDUCE_SUM_KERNEL_UTIL_H_
