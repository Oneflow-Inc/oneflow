...
*/
#ifndef ONEFLOW_USER_KERNELS_CUTLASS_GEMM_ARRAY_TUNER_H_
#define ONEFLOW_USER_KERNELS_CUTLASS_GEMM_ARRAY_TUNER_H_
...
class CutlassGemmArrayTuner {
 public:
  CutlassGemmArrayTuner() = default;
  ...
  const cutlass::library::Operation* FindOperation(
    ...
    return GetCutlassGemmArrayTunerImpl<Configuration, Arguments>()->Find(
  ...
  const cutlass::library::Operation* GetOperation(
    ...
    return GetCutlassGemmArrayTunerImpl<Configuration, Arguments>()->Get(
...
#endif  // ONEFLOW_USER_KERNELS_CUTLASS_GEMM_ARRAY_TUNER_H_
