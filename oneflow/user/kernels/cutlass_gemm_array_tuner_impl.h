...
#ifndef ONEFLOW_USER_KERNELS_CUTLASS_GEMM_ARRAY_TUNER_IMPL_H_
#define ONEFLOW_USER_KERNELS_CUTLASS_GEMM_ARRAY_TUNER_IMPL_H_
...
class CutlassGemmArrayTunerImpl {
 public:
...
#endif  // ONEFLOW_USER_KERNELS_CUTLASS_GEMM_ARRAY_TUNER_IMPL_H_
