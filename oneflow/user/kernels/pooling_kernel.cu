...
__global__ void DoCUDAMaxPool2dForward(const NdIndexOffsetHelper<int64_t, 4> index_helper,
                                       ...
                                       T* indice_ptr, int32_t padding_h, int32_t padding_w,
  ...
  FarwardCompute<T>(index_helper, elem_num, maxval, src, dest, indice_ptr, padding_h, padding_w,
...
__global__ void DoCUDAMaxPool2dBackward(const NdIndexOffsetHelper<int64_t, 4> index_helper,
  ...
  BackwardCompute<T>(index_helper, elem_num, src, dest, indice_ptr, n_batch, n_channel, src_height,
