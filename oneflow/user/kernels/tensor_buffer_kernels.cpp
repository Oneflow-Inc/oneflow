...
private:
  void Compute(user_op::KernelComputeContext *ctx) const override {
    ...
    FOR_RANGE(int64_t, i, in_shape.NumAxes() - instance_dims,
              in_shape.NumAxes()) {
