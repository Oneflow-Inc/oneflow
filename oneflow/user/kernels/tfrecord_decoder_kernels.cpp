...
template<typename T>
class TFRecordRawDecoderKernel final : public user_op::OpKernel {
 public:
  TFRecordRawDecoderKernel() = default;
  ~TFRecordRawDecoderKernel() override = default;
...
class TFRecordImageDecoderRandomCropKernel final : public user_op::OpKernel {
 public:
  TFRecordImageDecoderRandomCropKernel() = default;
  ~TFRecordImageDecoderRandomCropKernel() override = default;
...
class TFRecordImageDecoderKernel final : public user_op::OpKernel {
 public:
  TFRecordImageDecoderKernel() = default;
  ~TFRecordImageDecoderKernel() override = default;
