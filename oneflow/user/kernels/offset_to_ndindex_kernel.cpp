...
class OffsetToNdIndexKernel final : public OpKernel {
 ...
 private:
  void Compute(user_op::KernelComputeContext* ctx) const override {
    ...
    CHECK_LE(dims_num, oneflow::kMaxDims);
...
REGISTER_OFFSET_TO_NDINDEX_KERNEL(DeviceType::kCPU, int32_t);
REGISTER_OFFSET_TO_NDINDEX_KERNEL(DeviceType::kCPU, int64_t);
#ifdef WITH_CUDA
REGISTER_OFFSET_TO_NDINDEX_KERNEL(DeviceType::kGPU, int32_t);
REGISTER_OFFSET_TO_NDINDEX_KERNEL(DeviceType::kGPU, int64_t);
#endif
