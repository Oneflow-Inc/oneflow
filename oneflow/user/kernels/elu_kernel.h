...
//     ElemwiseEluFunctor<device_type, Opt, T>()(ctx->device_ctx(), elem_cnt, alpha, out_ptr,
//     in_ptr);
//   }
...
//     ElemwiseEluGradFunctor<device_type, Opt, T>()(ctx->device_ctx(), elem_cnt, alpha, dx_ptr,
//     x_ptr,
//                                                   dy_ptr);
//   }
//   bool AlwaysComputeWhenAllOutputsEmpty() const override { return false; }
...
//   REGISTER_USER_KERNEL("elu")                                                           \
//     .SetCreateFn([](user_op::KernelCreateContext* ctx){       \
//       return new UnaryElemwiseKernel<EluFunctor<dtype>, dtype>(           \
//         "in", "out" );}) \
//     .SetIsMatchedHob((user_op::HobDeviceTag() == device)        \
//         & (user_op::HobDataType("in", 0) == GetDataType<dtype>::value)); \
