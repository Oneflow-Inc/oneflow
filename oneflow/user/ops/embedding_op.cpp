...
/* static */ auto EmbeddingRenormOp::InferLogicalTensorDesc(user_op::InferContext* ctx)
    -> Maybe<void> {
...
/*static*/ auto EmbeddingRenormOp::InferPhysicalTensorDesc(user_op::InferContext* ctx)
    -> Maybe<void> {
