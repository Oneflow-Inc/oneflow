...
Maybe<Shape>
ReshapeUserOpUtil::GetLogicalOutBlobShape(const Shape &in_shape,
...
Maybe<void>
ReshapeUserOpUtil::Squeeze(const Shape &origin, Shape *shape,
...
Maybe<void> ReshapeUserOpUtil::GetReshapeUserOpSbpSignatures(
    const Shape &in_shape, const Shape &out_shape, user_op::SbpContext *ctx) {
  ...
  HashMap<int, int> out_squeezed_axis2original_axis;
  {
    ...
    ReshapeUserOpUtil::Squeeze(in_shape, &squeezed_in_shape,
                               &in_squeezed_axis2original_axis);
    ReshapeUserOpUtil::Squeeze(out_shape, &squeezed_out_shape,
                               &out_squeezed_axis2original_axis);
    ReshapeUserOpUtil::GetGroupStartInAxis2OutAxis(
        squeezed_in_shape, squeezed_out_shape, ctx->parallel_num(),
