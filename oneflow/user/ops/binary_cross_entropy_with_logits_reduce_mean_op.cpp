...
/* static */ Maybe<void> BinaryCrossEntropyWithLogitsReduceMeanOp::GetSbp(user_op::SbpContext* ctx) {
    ctx->NewBuilder()
...
/* static */ Maybe<void> BinaryCrossEntropyWithLogitsReduceMeanOp::InferDataType(user_op::InferContext* ctx) {
