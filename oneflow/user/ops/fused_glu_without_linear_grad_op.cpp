...
/* static */ auto FusedGluWithoutLinearGradOp::InferLogicalTensorDesc(user_op::InferContext* ctx) -> Maybe<void> {
    // obtain input shape
...
/* static */ auto FusedGluWithoutLinearGradOp::InferPhysicalTensorDesc(user_op::InferContext* ctx) -> Maybe<void> {
    return InferLogicalTensorDesc(ctx);
}

/* static */ auto FusedGluWithoutLinearGradOp::InferDataType(user_op::InferContext* ctx) -> Maybe<void> {
