...
REGISTER_USER_OP("combined_margin_loss")
    ...
    .SetTensorDescInferFn([](user_op::InferContext* ctx) -> Maybe<void> {
      ...
      *ctx->OutputIsDynamic4ArgNameAndIndex("y", 0) = ctx->InputIsDynamic4ArgNameAndIndex("x", 0);
...
REGISTER_USER_OP("combined_margin_loss_grad")
    ...
    .SetTensorDescInferFn([](user_op::InferContext* ctx) -> Maybe<void> {
      ...
      *ctx->OutputIsDynamic4ArgNameAndIndex("dx", 0) = ctx->InputIsDynamic4ArgNameAndIndex("dy", 0);
      return Maybe<void>::Ok();
    })
    .SetDataTypeInferFn([](user_op::InferContext* ctx) -> Maybe<void> {
