...
#define REGISTER_MAXPOOL_FORWARD_OP(name, ndim) \
...
REGISTER_MAXPOOL_BACKWARD_OP("maxpool_1d")
REGISTER_MAXPOOL_BACKWARD_OP("maxpool_2d")
REGISTER_MAXPOOL_BACKWARD_OP("maxpool_3d")
