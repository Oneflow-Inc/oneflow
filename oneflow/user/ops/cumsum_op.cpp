...
/*static*/ Maybe<void> CumsumOp::InferPhysicalTensorDesc(user_op::InferContext* ctx) {
...
/*static*/ Maybe<void> CumsumGradOp::InferLogicalTensorDesc(user_op::InferContext* ctx) {
  *ctx->OutputShape("dx", 0) = ctx->InputShape("dy", 0);
  return Maybe<void>::Ok();
}

/*static*/ Maybe<void> CumsumGradOp::InferPhysicalTensorDesc(user_op::InferContext* ctx) {
  return InferLogicalTensorDesc(ctx);
}

/*static*/ Maybe<void> CumsumGradOp::GetSbp(user_op::SbpContext* ctx) {
...
/*static*/ Maybe<void> CumsumGradOp::InferDataType(user_op::InferContext* ctx) {
