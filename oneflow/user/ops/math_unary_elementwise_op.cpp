...
#define REGISTER_MATH_UNARY_ELEMENTWISE_OP_AND_GRAD(                           \
    math_unary_elementwise_type, func_prefix)                                  \
  REGISTER_USER_OP(math_unary_elementwise_type)                                \
      ...
      .SetBatchAxisInferFn(                                                    \
          user_op::BatchAxisInferFnUtil::NaiveInferBatchAxis);                 \
                                                                               \
      ...
      .SetGenBackwardOpConfFn([](const user_op::UserOpWrapper &op,             \
        ...
        if (op.NeedGenGradTensor4OpInput("x", 0)) {                            \
          ...
          user_op::UserOpConfWrapper unary_grad_op =                           \
              builder                                                          \
                  .Op(std::string("") + math_unary_elementwise_type + "_grad") \
