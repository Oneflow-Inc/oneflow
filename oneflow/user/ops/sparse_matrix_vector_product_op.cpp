...
/* static */ auto SparseMatrixVectorProductOp::InferLogicalTensorDesc(user_op::InferContext* ctx) -> Maybe<void> {
    // obtain input shape
...
/* static */ auto SparseMatrixVectorProductOp::InferPhysicalTensorDesc(user_op::InferContext* ctx) -> Maybe<void> {
  return InferLogicalTensorDesc(ctx);
}

/* static */ auto SparseMatrixVectorProductOp::InferDataType(user_op::InferContext* ctx) -> Maybe<void> {
