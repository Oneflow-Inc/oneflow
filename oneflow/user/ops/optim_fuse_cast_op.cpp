...
/* static */ Maybe<void> OptimFuseCastOp::InferLogicalTensorDesc(user_op::InferContext* ctx) {
...
/*static*/ Maybe<void> OptimFuseCastOp::InferPhysicalTensorDesc(user_op::InferContext* ctx) {
  return InferLogicalTensorDesc(ctx);
}

/* static */ Maybe<void> OptimFuseCastOp::GetSbp(user_op::SbpContext* ctx) {
...
/* static */ Maybe<void> OptimFuseCastOp::InferDataType(user_op::InferContext* ctx) {
  user_op::TensorDesc* output_tensor_desc = ctx->OutputTensorDesc("out", 0);
