...
REGISTER_CPU_ONLY_USER_OP("tfrecord_raw_decoder")
    .Input("in")
    .Output("out")
...
REGISTER_CPU_ONLY_USER_OP("tfrecord_image_decoder")
    .Input("in")
    .Output("out")
    .Attr("name", UserOpAttrType::kAtString)
...
REGISTER_CPU_ONLY_USER_OP("tfrecord_image_decoder_random_crop")
    .Input("in")
    .Output("out")
    .Attr("name", UserOpAttrType::kAtString)
    .Attr<std::string>("color_space", UserOpAttrType::kAtString, "BGR")
