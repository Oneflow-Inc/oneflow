...
/* static */ Maybe<void> LeakyReluYZHOp::InferLogicalTensorDesc(user_op::InferContext* ctx) {
...
/*static*/ Maybe<void> LeakyReluYZHOp::InferPhysicalTensorDesc(user_op::InferContext* ctx) {
  return InferLogicalTensorDesc(ctx);
}

/* static */ Maybe<void> LeakyReluYZHOp::GetSbp(user_op::SbpContext* ctx) {
...
/* static */ Maybe<void> LeakyReluYZHOp::InferDataType(user_op::InferContext* ctx) {
  *ctx->OutputDType("y", 0) = ctx->InputDType("x", 0);
  return Maybe<void>::Ok();
}

/* static */ Maybe<void> LeakyReluYZHGradOp::InferLogicalTensorDesc(user_op::InferContext* ctx) {
  const Shape& x_shape = ctx->InputShape("x", 0);
...
/*static*/ Maybe<void> LeakyReluYZHGradOp::InferPhysicalTensorDesc(user_op::InferContext* ctx) {
  return InferLogicalTensorDesc(ctx);
}

/* static */ Maybe<void> LeakyReluYZHGradOp::GetSbp(user_op::SbpContext* ctx) {
  const user_op::TensorDesc& x_tensor = ctx->LogicalTensorDesc4InputArgNameAndIndex("x", 0);
  FOR_RANGE(int64_t, i, 0, x_tensor.shape().NumAxes()) {
    ctx->NewBuilder()
...
/* static */ Maybe<void> LeakyReluYZHGradOp::InferDataType(user_op::InferContext* ctx) {
