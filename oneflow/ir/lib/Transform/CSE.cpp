...
//
// Copy from LLVM Project mlir/lib/Transforms/CSE.cpp
//
//===----------------------------------------------------------------------===//
...
struct CSE {
  ...
  void run(Operation* op, DominanceInfo* domInfo);
...
void CSE::run(Operation* rootOp, DominanceInfo* domInfo) {
...
void mlir::oneflow::transform_dialect::eliminateCommonSubexpressions(Operation* op) {
