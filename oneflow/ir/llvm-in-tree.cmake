...
set(LLVM_ENABLE_RTTI
    ON
    CACHE BOOL "turn this on to make it compatible with protobuf")
set(LLVM_ENABLE_EH
    ON
    CACHE BOOL "turn this on to make it compatible with half (the library)")
...
install(
  TARGETS oneflow of_protoobj of_cfgobj of_functional_obj
  EXPORT oneflow
  DESTINATION lib)
...
set(LLVM_INCLUDE_DIRS
    ${LLVM_MAIN_SRC_DIR}/include;${llvm_monorepo_BINARY_DIR}/include)
