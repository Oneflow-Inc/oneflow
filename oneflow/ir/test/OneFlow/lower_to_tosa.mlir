...
// RUN: oneflow-opt -lower-oneflow-to-tosa -tosa-to-linalg-on-tensors -cse --linalg-fuse-elementwise-ops  -linalg-bufferize -tensor-bufferize -func-bufferize --tensor-constant-bufferize -buffer-results-to-out-params -canonicalize  -finalizing-bufferize %s | FileCheck %s
// CHECK: return
module  {
