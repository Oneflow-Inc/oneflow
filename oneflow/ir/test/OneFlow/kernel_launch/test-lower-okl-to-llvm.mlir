...
//   }
  func.func @okl_func(%arg0: !llvm.ptr<i8>) attributes {compiled = "true"} {
    ...
    %1 = "okl.build_run_ctx"(%0, %arg0) : (!llvm.ptr<i8>, !llvm.ptr<i8>) -> !llvm.ptr<i8>
    %2 = "okl.build_op_kernel"(%0) {op_type_name = "relu-0"} : (!llvm.ptr<i8>) -> !llvm.ptr<i8>
    "okl.launch"(%0, %1, %2) : (!llvm.ptr<i8>, !llvm.ptr<i8>, !llvm.ptr<i8>) -> ()
    "okl.destroy_reg_ctx"(%0) : (!llvm.ptr<i8>) -> ()
    "okl.destroy_run_ctx"(%1) : (!llvm.ptr<i8>) -> ()
    return
  }
}
