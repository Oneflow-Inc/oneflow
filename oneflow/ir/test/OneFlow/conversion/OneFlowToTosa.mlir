...
oneflow.job @test_variable() -> tensor<64x3x7x7xf32>
{
    %res = "oneflow.variable"() {
        ...
        device_tag = "cpu",
        hierarchy = [1],
        parallel_signature = #sbp.parallel_signature<[] -> [#sbp.b]>,
...
//CHECK: [[V0:%.+]] = "tosa.reshape"(%arg0) {new_shape = [4, 6, 1]} : (tensor<4x3x2x1xf32>) -> tensor<4x6x1xf32>
//CHECK: return [[V0]] : tensor<4x6x1xf32>
