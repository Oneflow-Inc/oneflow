...
//CHECK: [[V2:%.+]] = "tosa.max_pool2d"([[V1]]) {kernel = array<i64: 3, 3>, pad = array<i64: 1, 1, 1, 1>, stride = array<i64: 2, 2>} : (tensor<1x112x112x64xf32>) -> tensor<1x56x56x64xf32>
...
//CHECK: [[V2:%.+]] = "tosa.avg_pool2d"([[V1]]) {kernel = array<i64: 7, 7>, pad = array<i64: 0, 0, 0, 0>, stride = array<i64: 7, 7>} : (tensor<1x7x7x2048xf32>) -> tensor<1x1x1x2048xf32>
//CHECK: [[V3:%.+]] = "tosa.const"() {value = dense<[0, 3, 1, 2]> : tensor<4xi32>} : () -> tensor<4xi32>
...
//CHECK: [[V5:%.+]] = "tosa.conv2d"([[V2]], [[V4]], [[V0]]) {dilation = array<i64: 1, 1>, pad = array<i64: 0, 0, 0, 0>, stride = array<i64: 1, 1>} : (tensor<1x224x224x3xf32>, tensor<5x1x1x3xf32>, tensor<5xf32>) -> tensor<1x224x224x5xf32>
...
//CHECK: [[V0:%.+]] = "tosa.reshape"(%arg0) {new_shape = array<i64: 1, 1, 2048>} : (tensor<1x2048xf32>) -> tensor<1x1x2048xf32>
...
//CHECK: [[V3:%.+]] = "tosa.reshape"([[V2]]) {new_shape = array<i64: 1, 2048, 1000>} : (tensor<2048x1000xf32>) -> tensor<1x2048x1000xf32>
//CHECK: [[V4:%.+]] = "tosa.matmul"([[V0]], [[V3]]) : (tensor<1x1x2048xf32>, tensor<1x2048x1000xf32>) -> tensor<1x1x1000xf32>
//CHECK: [[V5:%.+]] = "tosa.reshape"([[V4]]) {new_shape = array<i64: 1, 1000>} : (tensor<1x1x1000xf32>) -> tensor<1x1000xf32>
