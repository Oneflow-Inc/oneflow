...
module  {
  func @IdempotentJob() {
    %data_output = "oneflow.system"() {device_name = ["0:0-0"], device_tag = "gpu", hierarchy = [1], input_bns = [], op_name = "Input_0", op_type_case = 137 : i32, operand_segment_sizes = dense<0> : vector<2xi32>, result_segment_sizes = dense<[1, 0]> : vector<2xi32>, scope_symbol_id = 4611686018427420670 : i64} : () -> tensor<96x96xf32>
    ...
    "oneflow.system"(%1) {device_name = ["0:0-0"], device_tag = "cpu", hierarchy = [1], input_bns = ["in"], op_name = "Return_10", op_type_case = 146 : i32, operand_segment_sizes = dense<[1, 0]> : vector<2xi32>, result_segment_sizes = dense<0> : vector<2xi32>, scope_symbol_id = 4611686018427432958 : i64} : (tensor<96x96xf32>) -> ()
    // CHECK: "oneflow.system"(%1)
    "oneflow.system"(%0) {device_name = ["0:0-0"], device_tag = "cpu", hierarchy = [1], input_bns = ["in"], op_name = "Return_11", op_type_case = 146 : i32, operand_segment_sizes = dense<[1, 0]> : vector<2xi32>, result_segment_sizes = dense<0> : vector<2xi32>, scope_symbol_id = 4611686018427432958 : i64} : (tensor<96x96xf32>) -> ()
