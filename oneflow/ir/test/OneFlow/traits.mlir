...
func @testTripleInvolution(%arg0: tensor<f32>) -> tensor<f32> {
  ...
  %0 = "oneflow.negative"(%arg0) {device = "gpu", input_lbn_segment_keys = ["in"], input_lbn_segment_sizes = [1 : i32], op_name = "Relu_1", op_type_name = "relu", output_lbn_segment_keys = ["out"], output_lbn_segment_sizes = [1 : i32], output_lbns = ["Relu_1/out_0"], placement = ["0:0-0"], scope_symbol_id = 4611686018427420670 : i64, trainable = false} : (tensor<f32>) -> tensor<f32>
  %1 = "oneflow.negative"(%0) {device = "gpu", input_lbn_segment_keys = ["in"], input_lbn_segment_sizes = [1 : i32], op_name = "Relu_2", op_type_name = "relu", output_lbn_segment_keys = ["out"], output_lbn_segment_sizes = [1 : i32], output_lbns = ["Relu_2/out_0"], placement = ["0:0-0"], scope_symbol_id = 4611686018427420670 : i64, trainable = false} : (tensor<f32>) -> tensor<f32>
  %2 = "oneflow.negative"(%1) {device = "gpu", input_lbn_segment_keys = ["in"], input_lbn_segment_sizes = [1 : i32], op_name = "Relu_3", op_type_name = "relu", output_lbn_segment_keys = ["out"], output_lbn_segment_sizes = [1 : i32], output_lbns = ["Relu_3/out_0"], placement = ["0:0-0"], scope_symbol_id = 4611686018427420670 : i64, trainable = false} : (tensor<f32>) -> tensor<f32>
...
func @testFailedInvolutionFoldDueToDifferentPlacement(%arg0: tensor<f32>) -> tensor<f32> {
  %0 = "oneflow.negative"(%arg0) {device = "gpu", input_lbn_segment_keys = ["in"], input_lbn_segment_sizes = [1 : i32], op_name = "Relu_1", op_type_name = "relu", output_lbn_segment_keys = ["out"], output_lbn_segment_sizes = [1 : i32], output_lbns = ["Relu_1/out_0"], placement = ["0:0-0"], scope_symbol_id = 4611686018427420670 : i64, trainable = false} : (tensor<f32>) -> tensor<f32>
  %1 = "oneflow.negative"(%0) {device = "gpu", input_lbn_segment_keys = ["in"], input_lbn_segment_sizes = [1 : i32], op_name = "Relu_2", op_type_name = "relu", output_lbn_segment_keys = ["out"], output_lbn_segment_sizes = [1 : i32], output_lbns = ["Relu_2/out_0"], placement = ["1:0-0"], scope_symbol_id = 4611686018427420670 : i64, trainable = false} : (tensor<f32>) -> tensor<f32>
...
func @testFailedInvolutionFoldDueToDifferentDevice(%arg0: tensor<f32>) -> tensor<f32> {
  %0 = "oneflow.negative"(%arg0) {device = "gpu", input_lbn_segment_keys = ["in"], input_lbn_segment_sizes = [1 : i32], op_name = "Relu_1", op_type_name = "relu", output_lbn_segment_keys = ["out"], output_lbn_segment_sizes = [1 : i32], output_lbns = ["Relu_1/out_0"], placement = ["0:0-0"], scope_symbol_id = 4611686018427420670 : i64, trainable = false} : (tensor<f32>) -> tensor<f32>
  %1 = "oneflow.negative"(%0) {device = "cpu", input_lbn_segment_keys = ["in"], input_lbn_segment_sizes = [1 : i32], op_name = "Relu_2", op_type_name = "relu", output_lbn_segment_keys = ["out"], output_lbn_segment_sizes = [1 : i32], output_lbns = ["Relu_2/out_0"], placement = ["0:0-0"], scope_symbol_id = 4611686018427420670 : i64, trainable = false} : (tensor<f32>) -> tensor<f32>
  // CHECK: [[INVOLUTION:%.+]] = "oneflow.negative"(%1)
  %2 = "oneflow.negative"(%1) {device = "gpu", input_lbn_segment_keys = ["in"], input_lbn_segment_sizes = [1 : i32], op_name = "Relu_3", op_type_name = "relu", output_lbn_segment_keys = ["out"], output_lbn_segment_sizes = [1 : i32], output_lbns = ["Relu_3/out_0"], placement = ["0:0-0"], scope_symbol_id = 4611686018427420670 : i64, trainable = false} : (tensor<f32>) -> tensor<f32>
  // CHECK: return [[INVOLUTION]]
  return %2: tensor<f32>
