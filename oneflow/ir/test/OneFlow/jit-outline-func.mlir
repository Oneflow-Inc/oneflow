...
builtin.module  {
  builtin.func @FuseCastScaleJob() {
    ...
    %0 = "oneflow.cast"(%data_output) {device_name = ["@0:0"], device_tag = "cpu", dtype = "DT_Float", hierarchy = [1], op_name = "Cast_1", scope_symbol_id = 4611686018427437054 : i64} : (tensor<96x96xi64>) -> tensor<96x96xf32>
