...
builtin.module  {
  builtin.func @FuseCastScaleJob() {
    ...
    %0 = "oneflow.cast"(%data_output) {device_name = ["@0:0"], device_tag = "cpu", dtype = "DT_Float", hierarchy = [1], input_lbn_segment_keys = ["in"], op_name = "Cast_1", scope_symbol_id = 4611686018427437054 : i64} : (tensor<96x96xi64>) -> tensor<96x96xf32>
    ...
    %1 = "oneflow.scalar_mul_by_tensor"(%0, %data_output_0) {device_name = ["@0:0"], device_tag = "cpu", hierarchy = [1], input_lbn_segment_keys = ["x", "scalar"], op_name = "ScalarMulByTensor_2", scope_symbol_id = 4611686018427437054 : i64} : (tensor<96x96xf32>, tensor<1xf32>) -> tensor<96x96xf32>
