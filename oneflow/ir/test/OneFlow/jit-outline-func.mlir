...
builtin.module  {
  builtin.func @FuseCastScaleJob() {
    ...
    %0 = "oneflow.cast"(%data_output) {device_name = ["@0:0"], device_tag = "cpu", dtype = "DT_Float", hierarchy = [1], input_lbn_segment_keys = ["in"], input_sizes = [1 : i32], op_name = "Cast_1", op_type_name = "cast", output_lbn_segment_sizes = [1 : i32], output_lbns = ["Cast_1/out_0"], scope_symbol_id = 4611686018427437054 : i64} : (tensor<96x96xi64>) -> tensor<96x96xf32>
    ...
    %1 = "oneflow.scalar_mul_by_tensor"(%0, %data_output_0) {device_name = ["@0:0"], device_tag = "cpu", hierarchy = [1], input_lbn_segment_keys = ["x", "scalar"], input_sizes = [1 : i32, 1 : i32], op_name = "ScalarMulByTensor_2", op_type_name = "scalar_mul_by_tensor", output_lbn_segment_sizes = [1 : i32], output_lbns = ["ScalarMulByTensor_2/y_0"], scope_symbol_id = 4611686018427437054 : i64} : (tensor<96x96xf32>, tensor<1xf32>) -> tensor<96x96xf32>
