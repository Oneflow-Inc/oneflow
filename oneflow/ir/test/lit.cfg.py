...
llvm_config.with_environment("LD_LIBRARY_PATH", os.path.join(config.oneflow_obj_root, "third_party_install/protobuf"), append_path=True)
llvm_config.with_environment("LD_LIBRARY_PATH", os.path.join(config.oneflow_obj_root, "_deps/glog-build"), append_path=True)
