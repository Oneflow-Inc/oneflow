...
if(NOT llvm_monorepo_POPULATED)
  ...
  execute_process(
    COMMAND
      ...
      -DLLVM_ENABLE_EH=ON # turn this on to make it compatible with half (the
                          # library)
      -DLLVM_BUILD_EXAMPLES=OFF -DLLVM_BUILD_TOOLS=OFF
      -DLLVM_INCLUDE_EXAMPLES=OFF -DLLVM_INCLUDE_TESTS=OFF
      -DLLVM_INCLUDE_BENCHMARKS=OFF -DLLVM_TARGETS_TO_BUILD=host\;NVPTX
      -DLLVM_ENABLE_ASSERTIONS=ON -DLLVM_ENABLE_PROJECTS=mlir
      -DLLVM_APPEND_VC_REV=OFF -DLLVM_ENABLE_ZLIB=OFF -DLLVM_INSTALL_UTILS=ON
      -DBUILD_SHARED_LIBS=${BUILD_SHARED_LIBS} -DLLVM_ENABLE_OCAMLDOC=OFF
      -DLLVM_ENABLE_BINDINGS=OFF
      -DMLIR_ENABLE_CUDA_RUNNER=${WITH_MLIR_CUDA_CODEGEN}
      -DCMAKE_CUDA_COMPILER=${CMAKE_CUDA_COMPILER} -DINJA_URL=${INJA_URL}
      -DINJA_URL_HASH=${INJA_URL_HASH} -DJSON_URL=${JSON_URL}
...
if(WITH_MLIR)
  ...
  set(LLVM_EXTERNAL_LIT
      "${llvm_monorepo_BINARY_DIR}/bin/llvm-lit"
      CACHE STRING "" FORCE)
endif()
