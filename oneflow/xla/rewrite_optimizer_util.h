#ifndef ONEFLOW_CORE_COMPILER_REWRITE_OPTIMIZER_UTIL_H_
#define ONEFLOW_CORE_COMPILER_REWRITE_OPTIMIZER_UTIL_H_
...
#endif  // ONEFLOW_CORE_COMPILER_REWRITE_OPTIMIZER_UTIL_H_
