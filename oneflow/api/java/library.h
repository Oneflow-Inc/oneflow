...
JNIEXPORT void      JNICALL Java_org_oneflow_InferenceSession_runPushJob(JNIEnv* env, jobject obj, jfloatArray javaArr);
...
JNIEXPORT void      JNICALL Java_org_oneflow_InferenceSession_runInferenceJob(JNIEnv* env, jobject obj);
JNIEXPORT void      JNICALL Java_org_oneflow_InferenceSession_runPullJob(JNIEnv* env, jobject obj);
