...
*/
#ifndef ONEFLOW_API_PYTHON_ENV_ENV_HELPER_H_
#define ONEFLOW_API_PYTHON_ENV_ENV_HELPER_H_
...
Maybe<void> EnableEagerEnvironment(bool enable_eager_execution) {
  CHECK_NOTNULL_OR_RETURN((Global<bool, EagerExecution>::Get()));
  *Global<bool, EagerExecution>::Get() = enable_eager_execution;
  return Maybe<void>::Ok();
}

Maybe<bool> IsEnvInited() { return Global<EnvGlobalObjectsScope>::Get() != nullptr; }
...
#endif  // ONEFLOW_API_PYTHON_ENV_ENV_HELPER_H_
