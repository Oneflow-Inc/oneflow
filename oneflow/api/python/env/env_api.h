...
inline void SetGraphLRVerbose(bool verbose) {
  return oneflow::SetGraphLRVerbose(verbose).GetOrThrow();
}

inline bool GetGraphLRVerbose() { return oneflow::GetGraphLRVerbose(); }
