...
namespace caffe {
  ...
  template <typename Dtype>
  void im2col_gpu(const cudaStream_t cuda_stream, const Dtype* data_im,
    ...
    im2col_gpu_kernel<Dtype> << <CAFFE_GET_BLOCKS(num_kernels),
      CAFFE_CUDA_NUM_THREADS, 0, cuda_stream>> >(
  ...
  template void im2col_gpu<float>(const cudaStream_t cuda_stream,
    const float* data_im, const int channels,
    const int height, const int width, const int kernel_h, const int kernel_w,
    const int pad_h, const int pad_w, const int stride_h, const int stride_w,
    float* data_col);
  template void im2col_gpu<double>(const cudaStream_t cuda_stream,
  ...
  template <typename Dtype>
  void col2im_gpu(const cudaStream_t cuda_stream, const Dtype* data_col,
  ...
  // Explicit instantiation
  template void col2im_gpu<float>(const cudaStream_t cuda_stream,
    const float* data_col, const int channels,
    const int height, const int width, const int patch_h, const int patch_w,
    const int pad_h, const int pad_w, const int stride_h,
    const int stride_w, float* data_im);
  template void col2im_gpu<double>(const cudaStream_t cuda_stream,
