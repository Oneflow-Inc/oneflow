...
static const char* grpcWorkerService_method_names[] = {
    "/oneflow.WorkerService/GetStatus",
    "/oneflow.WorkerService/RegisterGraph",
    "/oneflow.WorkerService/DeregisterGraph",
    "/oneflow.WorkerService/RunGraph",
    "/oneflow.WorkerService/CleanupGraph",
    "/oneflow.WorkerService/CleanupAll",
    "/oneflow.WorkerService/RecvTensor",
    "/oneflow.WorkerService/Logging",
    "/oneflow.WorkerService/Tracing",
};
...
WorkerService::AsyncService::AsyncService() {
  ...
  for (int i = 0; i < OF_ARRAYSIZE(grpcWorkerService_method_names); ++i) {
