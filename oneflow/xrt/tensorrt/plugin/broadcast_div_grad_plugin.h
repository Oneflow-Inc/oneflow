...
*/
#ifndef ONEFLOW_XRT_TENSORRT_PLUGIN_BROADCAST_DIV_GRAD_PLUGIN_H_
#define ONEFLOW_XRT_TENSORRT_PLUGIN_BROADCAST_DIV_GRAD_PLUGIN_H_
...
class BroadcastDivGradPlugin : public TrtPlugin {
 public:
  BroadcastDivGradPlugin(const std::string& name) : name_(name) {}

  const char* getPluginType() const TRT_NOEXCEPT override { return "BroadcastDivGrad"; }
...
#endif  // ONEFLOW_XRT_TENSORRT_PLUGIN_BROADCAST_DIV_GRAD_PLUGIN_H_
