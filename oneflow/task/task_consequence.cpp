...
//void CUDART_CB TaskConsequence::Callback(
...
void TaskConsequence::OnCompleteTaskItem(TaskItem* task_item) {
...
void TaskConsequence::OnNetworkTaskItem(TaskItem* task_item) {
