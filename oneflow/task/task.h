#ifndef ONEFLOW_TASK_TASK_H_
#define ONEFLOW_TASK_TASK_H_
...
class Task {
 ...
 private:
  ...
  std::shared_ptr<ExecGraph> exec_graph_;
  std::shared_ptr<TaskFSM> task_fsm_;
  std::shared_ptr<TaskConsequence> task_consequence_;
  std::shared_ptr<TaskOp> task_op_;
  std::shared_ptr<TaskContext> task_context_;

  Task(const Task& other) = delete;
  Task& operator=(const Task& other) = delete;
};
}  // namespace oneflow
#endif  // ONEFLOW_TASK_TASK_H_
