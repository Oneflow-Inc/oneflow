...
namespace oneflow {
#define REGISTER_MATH_UNARY_ELEMENTWISE_OP_AND_GRAD(math_unary_elementwise_type)             \
...
REGISTER_MATH_UNARY_ELEMENTWISE_OP_AND_GRAD("abs")
REGISTER_MATH_UNARY_ELEMENTWISE_OP_AND_GRAD("acos")
