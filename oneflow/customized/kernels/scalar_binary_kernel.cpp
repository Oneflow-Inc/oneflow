...
#define INSTANTIATE_ALL_CPU_SCALAR_BINARY_CAL(dtype, _) \
  INSTANTIATE_ALL_SCALAR_BINARY_CAL(CPU, dtype)
OF_PP_FOR_EACH_TUPLE(INSTANTIATE_ALL_CPU_SCALAR_BINARY_CAL, ARITHMETIC_DATA_TYPE_SEQ)
