...
OF_PP_SEQ_PRODUCT_FOR_EACH_TUPLE(INSTANTIATE_CLIP_VALUES_UTIL, (DeviceType::kCPU),
                                 ARITHMETIC_DATA_TYPE_SEQ)

OF_PP_SEQ_PRODUCT_FOR_EACH_TUPLE(REGISTER_CLIP_BY_VALUE_KERNEL, (DeviceType::kCPU),
                                 ARITHMETIC_DATA_TYPE_SEQ)
