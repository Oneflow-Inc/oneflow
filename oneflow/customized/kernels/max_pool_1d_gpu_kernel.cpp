...
#define REGISTER_MAX_POOL_1D_GPU_KERNEL(dtype)                                      \
...
REGISTER_MAX_POOL_1D_GPU_KERNEL(float)
REGISTER_MAX_POOL_1D_GPU_KERNEL(double)
...
#define REGISTER_MAX_POOL_1D_GRAD_GPU_KERNEL(dtype)                                   \
...
REGISTER_MAX_POOL_1D_GRAD_GPU_KERNEL(float)
REGISTER_MAX_POOL_1D_GRAD_GPU_KERNEL(double)
