...
template<typename T>
struct DropoutKernelUtil2<DeviceType::kGPU, T> final {
...
template<>
void DropoutKernelUtil2<DeviceType::kGPU, float16>::MaskAndScale(DeviceCtx* ctx, const int64_t n,
