#ifndef ONEFLOW_CUSTOMIZED_KERNELS_CROSS_ENTROPY_KERNEL_UTIL_H_
#define ONEFLOW_CUSTOMIZED_KERNELS_CROSS_ENTROPY_KERNEL_UTIL_H_
...
#endif  // ONEFLOW_CUSTOMIZED_KERNELS_CROSS_ENTROPY_KERNEL_UTIL_H_
