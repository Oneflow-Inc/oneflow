...
template<typename T>
struct DropoutKernelUtil2<DeviceType::kCPU, T> final {
...
template<>
void RandomMaskLikeKernelUtil2<DeviceType::kCPU>::GenMask(DeviceCtx* ctx, const int64_t n,
...
#define INITIATE_DROPOUT_KERNEL_UTIL_CPU(T, type_proto) \
  template struct DropoutKernelUtil2<DeviceType::kCPU, T>;
