...
#define REGISTER_AVG_POOL_3D_GPU_KERNEL(dtype)                                      \
...
REGISTER_AVG_POOL_3D_GPU_KERNEL(float)
REGISTER_AVG_POOL_3D_GPU_KERNEL(double)
...
#define REGISTER_AVG_POOL_3D_GRAD_GPU_KERNEL(dtype)                                   \
...
REGISTER_AVG_POOL_3D_GRAD_GPU_KERNEL(float)
REGISTER_AVG_POOL_3D_GRAD_GPU_KERNEL(double)
