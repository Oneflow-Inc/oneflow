...
class SoftmaxCrossEntropyKernel final : public user_op::OpKernel {
 ...
 private:
  void Compute(user_op::KernelComputeContext* ctx) const override {
    ...
    CrossEntropyKernelUtil<device_type, T, K>::ComputeEntropy(ctx->device_ctx(), num_instances,
...
#define REGISTER_SOFTMAX_CROSS_ENTROPY_KERNEL(device_type_v, dtype_pair, ltype_pair)        \
...
class SoftmaxCrossEntropyGradKernel final : public user_op::OpKernel {
 ...
 private:
  void Compute(user_op::KernelComputeContext* ctx) const override {
    ...
    CrossEntropyKernelUtil<device_type, T, K>::ComputeDiffWithSoftmax(
...
#define REGISTER_SOFTMAX_CROSS_ENTROPY_GRAD_KERNEL(device_type_v, dtype_pair, ltype_pair)       \
