/*!
 * Adapted from https://github.com/dmlc/mxnet
 * Copyright by MXNET Contributors
 * \file lazy_alloc_array.h
 * \brief An array that lazily allocate elements as
 *   First time the cell get visited.
 */
#ifndef _MEMORY_LAZY_ALLOC_ARRAY_H_
#define _MEMORY_LAZY_ALLOC_ARRAY_H_
...
class LazyAllocArray {
 ...
 private:
  ...
  static const std::size_t kInitSize = 16;
...
#endif  // _MEMORY_LAZY_ALLOC_ARRAY_H_
