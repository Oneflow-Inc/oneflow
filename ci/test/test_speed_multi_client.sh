...
python3 scripts/swin_dataloader_compare_speed_with_pytorch.py /dataset/extract/ 32 1 | check_relative_speed 0.95 | write_to_file_and_print
python3 scripts/swin_dataloader_compare_speed_with_pytorch.py /dataset/extract/ 32 4 | check_relative_speed 0.95 | write_to_file_and_print
python3 scripts/swin_dataloader_compare_speed_with_pytorch.py /dataset/extract/ 32 8 | check_relative_speed 0.95 | write_to_file_and_print
