...
## Install OneFlow
  ...
  - To install nightly release of OneFlow with CUDA support:
    ...
    ```
    python3 -m pip install --find-links https://staging.oneflow.info/nightly/cu102 oneflow+cu102 --user

  - To install other available builds for different CUDA versions:
    ```
    python3 -m pip install --find-links https://staging.oneflow.info/nightly/[PLATFORM] oneflow --user
    ```
