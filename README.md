...
- It's easy to write a model with PyTorch-like API and accelerate it with Graph Compiler in On.
- It's easy to scale a model to N-Dimensional-Parallel or Distributed exectuion.
