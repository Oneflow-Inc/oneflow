...
foreach(OP_GROUP_NAME IN LISTS ONEFLOW_OP_GROUPS)
  list(APPEND ONEFLOW_SCHEMA_TABLEGEN_FLAGS
       "-DGET_ONEFLOW_${OP_GROUP_NAME}_OP_DEFINITIONS")
endforeach()
list(APPEND ONEFLOW_SCHEMA_TABLEGEN_FLAGS
     "-DREMOVE_ONEFLOW_MLIR_ONLY_OP_DEFINITIONS")
...
if(LLVM_PROVIDER STREQUAL "in-tree")
  set(ONEFLOW_TABLE_GEN_TARGET oneflow_tblgen install-oneflow-tblgen
...
file(
  GLOB_RECURSE ODS_FILES
  LIST_DIRECTORIES false
  "${SOURCE_IR_INCLUDE_DIR}/*.td")
if(NOT ODS_FILES)
...
add_custom_command(
  ...
  COMMAND
    ${ONEFLOW_TABLE_GEN_EXE} ARGS --gen-op-schema-cpp ${ONEFLOW_ODS}
  ...
  VERBATIM)
set_source_files_properties(${GENERATED_OP_SCHEMA_H} ${GENERATED_OP_SCHEMA_CPP}
                            PROPERTIES GENERATED TRUE)

oneflow_add_library(of_op_schema OBJECT ${GENERATED_OP_SCHEMA_H}
                    ${GENERATED_OP_SCHEMA_CPP})
