...
execute_process(
  COMMAND "/usr/bin/git" show-ref 1d2c7b6c7376f396c8c7dd9b6afd2d4f83f3cb05
  WORKING_DIRECTORY "/home/xiaoshu/dl_sys/oneflow/cmake/protobuf/src/protobuf"
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 1d2c7b6c7376f396c8c7dd9b6afd2d4f83f3cb05
  WORKING_DIRECTORY "/home/xiaoshu/dl_sys/oneflow/cmake/protobuf/src/protobuf"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/xiaoshu/dl_sys/oneflow/cmake/protobuf/src/protobuf/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/xiaoshu/dl_sys/oneflow/cmake/protobuf/src/protobuf/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout 1d2c7b6c7376f396c8c7dd9b6afd2d4f83f3cb05
      WORKING_DIRECTORY "/home/xiaoshu/dl_sys/oneflow/cmake/protobuf/src/protobuf"
      RESULT_VARIABLE error_code
      )
    if(error_code)
