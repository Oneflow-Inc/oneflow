...
if (BUILD_CUDA)
  ...
  set(MINIMUM_CUDA_VERSION "9.0.0")
  if (CUDA_FOUND)
    if(${CUDA_VERSION} VERSION_LESS ${MINIMUM_CUDA_VERSION})
      message(FATAL_ERROR "CUDA ${CUDA_VERSION} is detected, ${MINIMUM_CUDNN_VERSION} or newer is required")
    endif()
  else()
