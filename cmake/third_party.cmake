...
if (BUILD_CUDA)
  ...
  set(OF_CUDA_LIBRARIES ${CUDA_LIBRARIES})
  if(OF_CUDA_LINK_DYNAMIC_LIBRARY)
    list(APPEND OF_CUDA_LIBRARIES ${CUDA_CUBLAS_LIBRARIES})
    list(APPEND OF_CUDA_LIBRARIES ${CUDA_curand_LIBRARY})
    ...
    foreach(extra_cuda_lib ${extra_cuda_libs})
      list(APPEND OF_CUDA_LIBRARIES ${cuda_lib_dir}/${extra_cuda_lib})
    endforeach()
    ...
    if(EXISTS ${cublas_lib_dir}/libcublas_static.a AND EXISTS ${cublas_lib_dir}/libcublasLt_static.a)
      list(APPEND OF_CUDA_LIBRARIES ${cublas_lib_dir}/libcublasLt_static.a)
      list(APPEND OF_CUDA_LIBRARIES ${cublas_lib_dir}/libcublas_static.a)
    elseif(EXISTS ${cublas_lib_dir}/libcublas_static.a)
      list(APPEND OF_CUDA_LIBRARIES ${cublas_lib_dir}/libcublas_static.a)
    elseif(EXISTS ${cuda_lib_dir}/libcublas_static.a)
      list(APPEND OF_CUDA_LIBRARIES ${cuda_lib_dir}/libcublas_static.a)
    else()
...
if (BUILD_CUDA)
  ...
  list(APPEND oneflow_third_party_libs ${OF_CUDA_LIBRARIES})
