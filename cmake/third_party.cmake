...
if(BUILD_CUDA)
  ...
  if(WITH_CUTLASS)
    ...
    if(WITH_OF_FLASH_ATTENTION)
      list(APPEND oneflow_third_party_dependencies of_flash_attention)
      list(APPEND oneflow_third_party_libs ${OF_FLASH_ATTENTION_LIBRARIES})
      list(APPEND ONEFLOW_THIRD_PARTY_INCLUDE_DIRS ${OF_FLASH_ATTENTION_INCLUDE_DIR})
    endif()
  endif()
