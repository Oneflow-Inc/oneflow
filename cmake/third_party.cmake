...
if (BUILD_CUDA)
  ...
  endforeach()
  # after 10.1, cublas libs locate in /usr/lib/x86_64-linux-gnu
  get_filename_component(cublas_lib_name ${CUDA_CUBLAS_LIBRARIES} NAME)
  list(APPEND CUDA_LIBRARIES ${cublas_lib_name}/libcublas_static.a)
