...
foreach (oneflow_third_party_lib IN LISTS oneflow_third_party_libs)
  ...
  string(FIND "${oneflow_third_party_lib}" "/" SLASH_FOUND)
  if (NOT ("${FLAG_FOUND}" EQUAL 0) AND NOT TARGET ${oneflow_third_party_lib} AND "${SLASH_FOUND}" EQUAL 0 AND NOT "${oneflow_third_party_lib}" MATCHES "^.+\.framework")
