...
if (BUILD_CUDA)
  ...
  endforeach()
  # after 10.1, cublas libs no longer locate in the dir of CUDA_LIBRARIES (in ubuntu, ß/usr/lib/x86_64-linux-gnu)
  foreach(cublas_lib_path ${CUDA_CUBLAS_LIBRARIES})
    get_filename_component(cublas_lib_name ${cublas_lib_path} NAME)
    if (${cublas_lib_name} STREQUAL libcublas_static.a)
