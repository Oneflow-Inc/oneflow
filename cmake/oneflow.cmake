...
if(BUILD_CUDA)
  ...
  if (BUILD_SHARED_LIBS)
    target_link_libraries(of_cudaobj ${CUDA_LIBRARIES} ${CUDNN_LIBRARIES})
  endif()
endif()
...
if (BUILD_SHARED_LIBS)
  ...
  target_link_libraries(of_ccobj of_protoobj of_cfgobj of_cudaobj "${GLOG_STATIC_LIBRARIES}")
...
if(APPLE)
  set(of_libs -Wl,-force_load of_ccobj of_protoobj of_cfgobj of_cudaobj)
elseif(UNIX)
  set(of_libs -Wl,--whole-archive of_ccobj of_protoobj of_cfgobj of_cudaobj -Wl,--no-whole-archive -ldl -lrt)
elseif(WIN32)
