...
target_link_libraries(of_ccobj of_graph)
if (BUILD_GIT_VERSION)
...
foreach(cc ${of_main_cc})
  ...
  target_link_libraries(${main_name} ${of_libs} ${oneflow_third_party_libs} ${GLOG_STATIC_LIBRARIES} ${GFLAGS_STATIC_LIBRARIES})
...
if(BUILD_TESTING)
  if(BUILD_CUDA)
    if (of_all_test_cc)
      ...
      target_link_libraries(oneflow_testexe ${of_libs} ${oneflow_third_party_libs} ${GLOG_STATIC_LIBRARIES} ${GFLAGS_STATIC_LIBRARIES})
...
foreach(cc ${of_transport_test_cc})
  ...
  target_link_libraries(${transport_test_exe_name} ${of_libs} ${oneflow_third_party_libs} ${GLOG_STATIC_LIBRARIES} ${GFLAGS_STATIC_LIBRARIES})
