...
if(BUILD_PYTHON)
  ...
  GENERATE_FUNCTIONAL_DISPATCH_OP_API_AND_PYBIND11_CPP(
      FUNCTIONAL_DISPATCH_GENERATED_SRCS FUNCTIONAL_DISPATCH_GENERATED_HRCS
      FUNCTIONAL_DISPATCH_PYBIND11_SRCS ${PROJECT_SOURCE_DIR})
  ...
  set(PYBIND11_SRCS
      ...
      ${FUNCTIONAL_DISPATCH_PYBIND11_SRCS})
...
target_link_libraries(oneflow-gen-ods -Wl,--whole-archive oneflow of_protoobj of_cfgobj of_functional_obj -Wl,--no-whole-archive -ldl -lrt ${oneflow_third_party_libs} ${oneflow_exe_third_party_libs})
if (BUILD_CUDA)
