...
oneflow_add_library(of_functional_api_obj ${FUNCTIONAL_GENERATED_SRCS} ${FUNCTIONAL_GENERATED_HRCS})
add_dependencies(of_functional_api_obj of_cfgobj)
...
add_dependencies(of_ccobj of_functional_api_obj)
if (BUILD_GIT_VERSION)
...
if (BUILD_SHARED_LIBS)
  ...
  target_link_libraries(of_ccobj of_protoobj of_cfgobj of_functional_api_obj "${GLOG_STATIC_LIBRARIES}")
...
if(APPLE)
  set(of_libs -Wl,-force_load of_ccobj of_protoobj of_cfgobj of_functional_api_obj)
elseif(UNIX)
  set(of_libs -Wl,--whole-archive of_ccobj of_protoobj of_cfgobj of_functional_api_obj -Wl,--no-whole-archive -ldl -lrt)
elseif(WIN32)
  set(of_libs of_ccobj of_protoobj of_cfgobj of_functional_api_obj)
...
add_dependencies(oneflow_internal of_cfgobj generate_py_cfg of_functional_api_obj)
