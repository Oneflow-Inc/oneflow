...
add_custom_target(generate_api ALL
  ...
  COMMAND export LD_PRELOAD=/lib/x86_64-linux-gnu/libasan.so.5:$ENV{LD_PRELOAD} && export PYTHONPATH=${of_pyscript_dir}:$ENV{PYTHONPATH} && ${Python_EXECUTABLE} ${PROJECT_SOURCE_DIR}/tools/generate_oneflow_api.py --root_path=${of_pyscript_dir}/oneflow)
