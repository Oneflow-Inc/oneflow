...
if(BUILD_TESTING)
  if(BUILD_CUDA)
    if (of_all_test_cc)
      ...
      target_link_libraries(oneflow_testexe ${oneflow_third_party_libs} ${oneflow_exe_third_party_libs} ${of_libs})
    ...
    if (of_separate_test_cc)
      foreach(cc ${of_separate_test_cc})
        ...
        string(CONCAT test_exe_name ${test_name} exe)
        oneflow_add_executable(${test_exe_name} ${cc})
        target_link_libraries(${test_exe_name} ${oneflow_third_party_libs} ${oneflow_exe_third_party_libs} ${of_libs})
      endforeach()
    endif()
  endif()
endif()
