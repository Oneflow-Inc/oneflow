...
if(BUILD_CUDA)
  oneflow_add_library(of_cuda_obj ${of_cuda_src})
  add_dependencies(of_cuda_obj of_protoobj of_cfgobj)
  if (BUILD_SHARED_LIBS)
    target_link_libraries(of_cuda_obj ${CUDA_LIBRARIES} ${CUDNN_LIBRARIES})
  endif()
endif()
...
if (BUILD_SHARED_LIBS)
  ...
  target_link_libraries(of_ccobj of_protoobj of_cfgobj of_cuda_obj "${GLOG_STATIC_LIBRARIES}")
...
add_dependencies(of_pyext_obj of_ccobj generate_py_cfg)

if(APPLE)
  set(of_libs -Wl,-force_load of_ccobj of_protoobj of_cfgobj of_cuda_obj)
elseif(UNIX)
  set(of_libs -Wl,--whole-archive of_ccobj of_protoobj of_cfgobj of_cuda_obj -Wl,--no-whole-archive -ldl -lrt)
elseif(WIN32)
