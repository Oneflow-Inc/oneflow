...
foreach(oneflow_single_file ${oneflow_all_src})
  ...
  if("${oneflow_single_file}" MATCHES "^${PROJECT_SOURCE_DIR}/oneflow/(core|user|xrt)/.*\\.cpp$")
    ...
    elseif((NOT RPC_CLIENT STREQUAL "GRPC") AND "${oneflow_single_file}" MATCHES "^${PROJECT_SOURCE_DIR}/oneflow/core/control/host.*")
    elseif((NOT RPC_CLIENT STREQUAL "GRPC") AND "${oneflow_single_file}" MATCHES "^${PROJECT_SOURCE_DIR}/oneflow/core/control/rank.*")
    elseif((NOT RPC_CLIENT STREQUAL "GRPC") AND "${oneflow_single_file}" MATCHES "^${PROJECT_SOURCE_DIR}/oneflow/core/control/ctrl.*")
    else()
      # not test file
