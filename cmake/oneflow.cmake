...
elseif(UNIX)
  ...
  target_link_libraries(oneflow of_protoobj of_cfgobj of_functional_obj glog_imported gflags_imported ${oneflow_third_party_libs} -Wl,--no-whole-archive -ldl -lrt "${CMAKE_CXX_FLAGS_OMP}")
  if(BUILD_CUDA)
