...
if(USE_SYSTEM_NCCL)
  ...
  find_library(
    NCCL_LIBRARY ${NCCL_LIBRARY_NAME}
    HINTS ${NCCL_ROOT_DIR} ${CUDAToolkit_LIBRARY_DIR}
  ...
  set(NCCL_URL
      https://github.com/NVIDIA/nccl/archive/30ca3fcacf8a73c48d7b8f7aaa54ae8bff89e884.zip
  )
  ...
  if(THIRD_PARTY)
    ...
    ExternalProject_Add(
      ...
      CONFIGURE_COMMAND ""
      BUILD_IN_SOURCE 1
      BUILD_COMMAND make -j${PROC_NUM} src.build
                    CUDA_HOME=${CUDATOOLKIT_BIN_ROOT}
