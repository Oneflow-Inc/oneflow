...
if(WIN32)
    ...
    set(PROTOBUF_LIBRARY_NAME libprotobufd.lib)
    set(PROTOC_LIBRARY_NAME libprotocd.lib)
...
elseif(APPLE AND ("${CMAKE_GENERATOR}" STREQUAL "Xcode"))
    ...
    set(PROTOBUF_LIBRARY_NAME libprotobuf.a)
    set(PROTOC_LIBRARY_NAME libprotoc.a)
...
set(PROTOBUF_STATIC_LIBRARIES ${PROTOBUF_LIBRARY_DIR}/${PROTOBUF_LIBRARY_NAME})
set(PROTOBUF_BUILD_STATIC_LIBRARIES ${PROTOBUF_BUILD_LIBRARY_DIR}/${PROTOBUF_LIBRARY_NAME})
set(PROTOC_STATIC_LIBRARIES ${PROTOBUF_LIBRARY_DIR}/${PROTOC_LIBRARY_NAME})
set(PROTOC_BUILD_STATIC_LIBRARIES ${PROTOBUF_BUILD_LIBRARY_DIR}/${PROTOC_LIBRARY_NAME})
...
add_custom_command(TARGET protobuf_copy_libs_to_destination PRE_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy_if_different ${PROTOBUF_BUILD_STATIC_LIBRARIES} ${PROTOBUF_LIBRARY_DIR})

add_custom_command(TARGET protobuf_copy_libs_to_destination PRE_BUILD
  COMMAND ${CMAKE_COMMAND} -E copy_if_different ${PROTOC_BUILD_STATIC_LIBRARIES} ${PROTOBUF_LIBRARY_DIR})
