...
set(TVM_URL /home/tvm_learn/v0.7.0/tvm/v0.7.0.tar.gz)
...
if (THIRD_PARTY)
  ...
  ExternalProject_Add(tvm
    ...
    CMAKE_CACHE_ARGS
        ...
        -DUSE_CUDA:BOOL=ON
        -DUSE_LLVM:STRING=/home/tvm_learn/clang+llvm-10.0.0-x86_64-linux-gnu-ubuntu-18.04/bin/llvm-config # FIXME:
