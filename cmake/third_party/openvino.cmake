...
if(WITH_OPENVINO)
  ...
  find_path(
    ...
    PATHS ${OPENVINO_ROOT}
          ...
          $ENV{OPENVINO_ROOT}
          $ENV{OPENVINO_ROOT}/ideployment_tools/inference_engine/include
  ...
  find_library(
    ...
    PATHS
      ${OPENVINO_ROOT}
      ${OPENVINO_ROOT}/deployment_tools/inference_engine/lib/intel64/
      $ENV{OPENVINO_ROOT}
      $ENV{OPENVINO_ROOT}/deployment_tools/inference_engine/lib/intel64/
  ...
  if(OPENVINO_INCLUDE_DIR AND OPENVINO_LIBRARIES)
    ...
    message(
      FATAL_ERROR
        "OpenVINO was not found. You can set OPENVINO_ROOT to specify the search path."
    )
  endif()
