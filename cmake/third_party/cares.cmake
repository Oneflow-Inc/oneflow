...
ExternalProject_Add(cares
  ...
  CMAKE_CACHE_ARGS
      ...
      -DCARES_BUILD_TOOLS:BOOL=OFF # to prevent linkage error
      -DCARES_STATIC_PIC:BOOL=ON
      -DCMAKE_BUILD_TYPE:STRING=${CMAKE_BUILD_TYPE}
      -DCMAKE_INSTALL_PREFIX:STRING=${CARES_INSTALL}
      -DCMAKE_CXX_FLAGS_DEBUG:STRING="${CMAKE_CXX_FLAGS_DEBUG} -lrt"
      -DCMAKE_CXX_FLAGS_RELEASE:STRING="${CMAKE_CXX_FLAGS_RELEASE} -lrt"
      -DCMAKE_CXX_FLAGS_RELWITHDEBINFO:STRING="${CMAKE_CXX_FLAGS_RELWITHDEBINFO} -lrt"
      -DCMAKE_CXX_FLAGS:STRING="${CMAKE_CXX_FLAGS} -lrt"
)
