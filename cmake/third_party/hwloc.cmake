...
if(BUILD_HWLOC)
  ...
  foreach(LIBRARY_NAME ${PCIACCESS_LIBRARY_NAMES})
    list(APPEND PCIACCESS_STATIC_LIBRARIES
         ${PCIACCESS_LIBRARY_DIR}/${LIBRARY_NAME})
  endforeach()
  ...
  foreach(LIBRARY_NAME ${HWLOC_LIBRARY_NAMES})
    list(APPEND ONEFLOW_HWLOC_STATIC_LIBRARIES
         ${HWLOC_LIBRARY_DIR}/${LIBRARY_NAME})
  endforeach()
  ...
  if(THIRD_PARTY)
    ...
    ExternalProject_Add(
      ...
      COMMAND ${XORG_MACROS_SOURCE_DIR}/src/xorg-macros/configure
              --prefix=${XORG_MACROS_INSTALL}
    ...
    ExternalProject_Add(
      ...
      COMMAND ${PCIACCESS_SOURCE_DIR}/src/pciaccess/configure
              --prefix=${PCIACCESS_INSTALL} --enable-shared=no
      BUILD_COMMAND make -j${PROC_NUM} CFLAGS=${PCIACCESS_CFLAGS}
      BUILD_BYPRODUCTS ${PCIACCESS_STATIC_LIBRARIES}
      INSTALL_COMMAND make install
      DEPENDS xorg-macros)
    set(HWLOC_TAR_URL
        https://github.com/open-mpi/hwloc/archive/refs/tags/hwloc-2.4.1.tar.gz)
    ...
    ExternalProject_Add(
      ...
      COMMAND
        ${HWLOC_SOURCE_DIR}/src/hwloc/configure --prefix=${HWLOC_INSTALL}
        PKG_CONFIG_PATH=${PCIACCESS_INSTALL}/lib/pkgconfig --disable-libxml2
