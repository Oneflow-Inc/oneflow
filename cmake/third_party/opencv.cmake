...
set(OPENCV_INSTALL_DIR
    ${CMAKE_CURRENT_BINARY_DIR}/opencv/src/opencv/build/install)
...
if(WIN32)
  ...
  set(OPENCV_BUILD_INCLUDE_DIR
      ${OPENCV_INSTALL_DIR}/${CMAKE_INSTALL_INCLUDEDIR})
  ...
  set(OPENCV_LIBRARY_NAMES libopencv_imgproc.a libopencv_imgcodecs.a
                           libopencv_core.a)
  set(OPENCV_3RDPARTY_LIBRARY_NAMES libIlmImf.a liblibjasper.a liblibpng.a
                                    liblibtiff.a liblibwebp.a)
endif()

foreach(LIBRARY_NAME ${OPENCV_LIBRARY_NAMES})
  list(APPEND OPENCV_STATIC_LIBRARIES ${OPENCV_LIBRARY_DIR}/${LIBRARY_NAME})
  list(APPEND OPENCV_BUILD_STATIC_LIBRARIES
       ${OPENCV_BUILD_LIBRARY_DIR}/${LIBRARY_NAME})
endforeach()

foreach(LIBRARY_NAME ${OPENCV_3RDPARTY_LIBRARY_NAMES})
  list(APPEND OPENCV_STATIC_LIBRARIES ${OPENCV_LIBRARY_DIR}/${LIBRARY_NAME})
  list(APPEND OPENCV_BUILD_STATIC_LIBRARIES
       ${OPENCV_BUILD_3RDPARTY_LIBRARY_DIR}/${LIBRARY_NAME})
endforeach()
...
if(THIRD_PARTY)
  ...
  ExternalProject_Add(
    ...
    UPDATE_COMMAND ""
    PATCH_COMMAND cmake -E make_directory
                  ${CMAKE_CURRENT_BINARY_DIR}/opencv/src/opencv/build
    BUILD_IN_SOURCE 0
