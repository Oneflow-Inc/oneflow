...
if(CUDNN_FOUND)
  ...
  set(MINIMUM_CUDNN_VERSION "7.1.0")
  if(${CUDNN_VERSION} VERSION_LESS ${MINIMUM_CUDNN_VERSION})
	  message(FATAL_ERROR "cuDNN ${CUDNN_VERSION} is detected, ${MINIMUM_CUDNN_VERSION} or newer is required")
  endif()
