# * Try to find cuDNN
#
# The following variables are optionally searched for defaults CUDNN_ROOT_DIR:
# Base directory where all cuDNN components are found
#
# The following are set after configuration is done: CUDNN_FOUND
# CUDNN_INCLUDE_DIRS CUDNN_LIBRARIES CUDNN_LIBRARY_DIRS
...
set(CUDNN_ROOT_DIR
    ""
    CACHE PATH "Folder contains NVIDIA cuDNN")

if(CUDA_VERSION VERSION_LESS "11.0")
  set(CUDA_VERSION_VERSION_LESS_11 TRUE)
endif()

cmake_dependent_option(CUDNN_STATIC "Look for static cuDNN" ON
                       "CUDA_VERSION_VERSION_LESS_11" OFF)
...
if(CUDNN_FOUND)
  ...
  if(NOT CUDNN_STATIC AND CUDNN_VERSION_MAJOR GREATER_EQUAL 8)
    ...
    set(CUDNN_DYNAMIC_NAMES libcudnn_cnn_infer.so libcudnn_cnn_train.so
    ...
    foreach(CUDNN_DYNAMIC_NAME ${CUDNN_DYNAMIC_NAMES})
      list(APPEND CUDNN_LIBRARIES
           ${CUDNN_LIBRARY_DIRECTORY}/${CUDNN_DYNAMIC_NAME})
    endforeach()
  else()
