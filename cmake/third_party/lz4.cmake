...
foreach(LIBRARY_NAME ${LZ4_LIBRARY_NAMES})
  ...
  list(APPEND LZ4_BUILD_STATIC_LIBRARIES
       ${LZ4_BUILD_LIBRARY_DIR}/${LIBRARY_NAME})
endforeach()

set(LZ4_HEADERS
    "${LZ4_BUILD_DIR}/lz4frame.h" "${LZ4_BUILD_DIR}/lz4frame_static.h"
    "${LZ4_BUILD_DIR}/lz4.h" "${LZ4_BUILD_DIR}/lz4hc.h"
...
if(THIRD_PARTY)
  ...
  foreach(header_file ${LZ4_HEADERS})
    add_custom_command(
      TARGET lz4_copy_headers_to_destination
      PRE_BUILD
  ...
  add_custom_target(
    ...
    COMMAND ${CMAKE_COMMAND} -E copy_if_different ${LZ4_BUILD_STATIC_LIBRARIES}
            ${LZ4_LIBRARY_DIR}
