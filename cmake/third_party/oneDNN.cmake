...
set(ONEDNN_URL
    https://github.com/oneapi-src/oneDNN/archive/refs/tags/v2.4.3.tar.gz)
...
if(WIN32)
  ...
  if(BUILD_SHARED_LIBS)
    ...
    elseif("${CMAKE_SHARED_LIBRARY_SUFFIX}" STREQUAL ".so")
      ...
      message(
        FATAL_ERROR "${CMAKE_SHARED_LIBRARY_SUFFIX} not support for onednn")
    endif()
  else()
...
set_property(TARGET onednn_imported PROPERTY IMPORTED_LOCATION
