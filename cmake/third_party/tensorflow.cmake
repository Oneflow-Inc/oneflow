  ...
  if(THIRD_PARTY)
    ExternalProject_Add(
      ...
      BUILD_COMMAND
        ...
        --output_user_root=${XRT_TF_BAZEL_OUTPUT_DIR} build
        ${TENSORFLOW_BUILD_CMD} -j HOST_CPUS
    ...
    add_custom_target(
      ...
      COMMAND
        ${CMAKE_COMMAND} -E copy_if_different ${TENSORFLOW_XLA_FRAMEWORK_LIB}
    ...
    foreach(src_dst_pair IN ZIP_LISTS TENSORFLOW_XLA_INCLUDE_DIR
      ...
      add_custom_command(
        TARGET tensorflow_symlink_headers COMMAND ${CMAKE_COMMAND} -E
