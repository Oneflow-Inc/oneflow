...
set(LIBJPEG_URL
    https://github.com/Oneflow-Inc/libjpeg-turbo/archive/3041cf67f.tar.gz)
use_mirror(VARIABLE LIBJPEG_URL URL ${LIBJPEG_URL})

if(WIN32)

elseif(APPLE AND ("${CMAKE_GENERATOR}" STREQUAL "Xcode"))
  set(LIBJPEG_BUILD_SRC_DIR
      ${CMAKE_CURRENT_BINARY_DIR}/libjpeg-turbo/src/libjpeg-turbo)
...
foreach(LIBRARY_NAME ${LIBJPEG_LIBRARY_NAMES})
  ...
  list(APPEND LIBJPEG_BUILD_STATIC_LIBRARIES
       ${LIBJPEG_BUILD_LIBRARY_DIR}/${LIBRARY_NAME})
endforeach()
...
if(THIRD_PARTY)
  ...
  foreach(header_file ${LIBJPEG_HEADERS})
    add_custom_command(
      TARGET libjpeg_copy_headers_to_destination
      PRE_BUILD
  ...
  add_custom_target(
    ...
    COMMAND ${CMAKE_COMMAND} -E copy_if_different
            ${LIBJPEG_BUILD_STATIC_LIBRARIES} ${LIBJPEG_LIBRARY_DIR}
