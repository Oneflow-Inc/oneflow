...
function(GENERATE_CFG_AND_PYBIND11_CPP SRCS HDRS PYBIND_SRCS ROOT_DIR)
  ...
  if(BUILD_PYTHON)
    ...
    foreach(FIL ${PYBIND11_FILE_CONVERT_PROTO})
      ...
      file(RELATIVE_PATH REL_DIR ${ROOT_DIR} ${FIL_DIR})
      set(CFG_PYBIND_FIL
          ${PROJECT_BINARY_DIR}/${REL_DIR}/${FIL_WE}.cfg.pybind.cpp)
    ...
    add_custom_command(
      ...
      COMMAND
        ${CODEGEN_PYTHON_EXECUTABLE} ${TEMPLATE_CONVERT_PYTHON_SCRIPT}
        ${CFG_ARGS} --of_cfg_proto_python_dir=${of_cfg_proto_python_dir}
        --project_build_dir=${PROJECT_BINARY_DIR} --generate_file_type=cfg.cpp
      COMMAND
        ${CODEGEN_PYTHON_EXECUTABLE} ${TEMPLATE_CONVERT_PYTHON_SCRIPT}
        ${PY_CFG_ARGS} --of_cfg_proto_python_dir=${of_cfg_proto_python_dir}
        --project_build_dir=${PROJECT_BINARY_DIR}
        --generate_file_type=cfg.pybind.cpp
      DEPENDS ${CODEGEN_PYTHON_EXECUTABLE} ${TEMPLATE_FILES}
              ${CFG_SOURCE_FILE_CONVERT_PROTO} ${PYBIND11_FILE_CONVERT_PROTO})
  else() # build_python
