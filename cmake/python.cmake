...
set_property(
  DIRECTORY
  APPEND
  PROPERTY CMAKE_CONFIGURE_DEPENDS ${requirements_txt})
...
function(install_py_dev_deps)
  execute_process(
    COMMAND ${ARGV0} -m pip install ${extra_index_arg} ${PIP_INDEX_MIRROR} -r
...
if(NOT Python_INCLUDE_DIRS)
  ...
  if((NOT (ret_code EQUAL "0"))
     OR (NOT IS_DIRECTORY ${Python_INCLUDE_DIRS})
...
if(NOT Python_NumPy_INCLUDE_DIRS)
  ...
  if((NOT ret_code EQUAL 0)
     OR (NOT IS_DIRECTORY ${Python_NumPy_INCLUDE_DIRS})
