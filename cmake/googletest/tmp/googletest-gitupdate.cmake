...
execute_process(
  COMMAND "/usr/bin/git" show-ref ec44c6c1675c25b9827aacd08c02433cccde7780
  WORKING_DIRECTORY "/home/xiaoshu/dl_sys/oneflow/cmake/googletest/src/googletest"
...
if("${show_ref_output}" MATCHES "refs/remotes/ec44c6c1675c25b9827aacd08c02433cccde7780")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "ec44c6c1675c25b9827aacd08c02433cccde7780")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "ec44c6c1675c25b9827aacd08c02433cccde7780")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 ec44c6c1675c25b9827aacd08c02433cccde7780
  WORKING_DIRECTORY "/home/xiaoshu/dl_sys/oneflow/cmake/googletest/src/googletest"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/xiaoshu/dl_sys/oneflow/cmake/googletest/src/googletest/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/xiaoshu/dl_sys/oneflow/cmake/googletest/src/googletest/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
    execute_process(
      COMMAND "/usr/bin/git" checkout ec44c6c1675c25b9827aacd08c02433cccde7780
      WORKING_DIRECTORY "/home/xiaoshu/dl_sys/oneflow/cmake/googletest/src/googletest"
      RESULT_VARIABLE error_code
      )
    if(error_code)
